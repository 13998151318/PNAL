    ...
    with open(data_path,"r",encoding="utf-8") as f:
        for line in f:
            ...
            if "/property/" in a:
                ...
                a = a.split(r'/')[-1]
            #<http://dbpedia.org/resource/Sapienza_University_of_Rome> <http://xmlns.com/foaf/0.1/name> "Studium Urbis"@la
            #下面是有问题的代码！！！
...
if __name__ == '__main__':
    ...
    #clean data.
    keep_data_1, remove_data_1 = remove_one_to_N_att_data_by_threshold(keep_data_1,remove_data_1,one2N_threshold=3000) #one2N_threshold=3
    keep_data_2, remove_data_2 = remove_one_to_N_att_data_by_threshold(keep_data_2,remove_data_2,one2N_threshold=3000)
