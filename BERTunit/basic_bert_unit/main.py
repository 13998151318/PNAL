...
from train_func import zero_train
import numpy as np
...
def main():
    ...
    ent2data, ent2data_with_desc, rel_triples_1, rel_triples_2, entid_1, entid_2 = read_data()
    print("---------------------------------------")
    ...
    #zero_train(Model,Criterion,Optimizer,Train_gene,train_ill,test_ill,ent2data, entid_1, entid_2)
    if ACTUALLY_DO_TRAINING:
        train(Model,Criterion,Optimizer,Train_gene,train_ill,test_ill, ent2data, ent2data_with_desc, entid_1, entid_2)
    else:
        zero_train(Model,Criterion,Optimizer,Train_gene,train_ill,test_ill,ent2data, entid_1, entid_2)
