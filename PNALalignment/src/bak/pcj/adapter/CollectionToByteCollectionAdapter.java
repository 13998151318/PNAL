...
public class CollectionToByteCollectionAdapter extends AbstractByteCollection {
    ...
    /**
     *  Creates a new adaption of a collection to a collection of byte
     *  values.
     *
     *  @param      collection
    ...
    { return collection.add(new Byte(v)); }

    public void clear()
    { collection.clear(); }

    public boolean contains(byte v)
    { return collection.contains(new Byte(v)); }

    public int hashCode()
    { return collection.hashCode(); }

    public ByteIterator iterator()
    { return new IteratorToByteIteratorAdapter(collection.iterator()); }

    public boolean remove(byte v)
    { return collection.remove(new Byte(v)); }
    ...
    { return Adapter.isByteAdaptable(collection); }
