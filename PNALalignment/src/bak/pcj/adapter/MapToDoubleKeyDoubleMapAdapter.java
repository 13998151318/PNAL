 ...
 *  in the client code:
 *  <pre>
 *      MapToDoubleKeyDoubleMapAdapter s;
 *      ...
...
public class MapToDoubleKeyDoubleMapAdapter extends AbstractDoubleKeyDoubleMap implements DoubleKeyDoubleMap {
     ...
     *              {@link Double Double}.
     */
    public MapToDoubleKeyDoubleMapAdapter(Map map, boolean validate) {
        if (map == null)
            Exceptions.nullArgument("map");
        this.map = map;
        lastValue = null;
    ...
    public boolean containsKey(double key) {
        lastValue = (Double)map.get(new Double(key));
    ...
    public double get(double key) {
        Double value = (Double)map.get(new Double(key));
    ...
    public double put(double key, double value) {
        Double oldValue = (Double)map.put(new Double(key), new Double(value));
        return oldValue == null ? MapDefaults.defaultDouble() : oldValue.doubleValue();
    }

    public double remove(double key) {
        Double value = (Double)map.remove(new Double(key));
        return value == null ? MapDefaults.defaultDouble() : value.doubleValue();
    }
    ...
    { return Adapter.isDoubleKeyDoubleAdaptable(map); }
