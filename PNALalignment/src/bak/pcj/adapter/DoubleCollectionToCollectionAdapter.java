 ...
 *  double values to Java Collections Framework collections. The adapter
 ...
 *  @since      1.0
 */
public class DoubleCollectionToCollectionAdapter extends AbstractCollection {
    ...
    public boolean add(Object o) {
        ...
        return collection.add(((Double)o).doubleValue());
    }
    ...
    public boolean contains(Object o) {
        try {
            return collection.contains(((Double)o).doubleValue());
    ...
    { return new DoubleIteratorToIteratorAdapter(collection.iterator()); }
    ...
    public boolean remove(Object o) {
        try {
            return collection.remove(((Double)o).doubleValue());
        } catch (ClassCastException cce) {
        } catch (NullPointerException npe) {
        }
        return false;
