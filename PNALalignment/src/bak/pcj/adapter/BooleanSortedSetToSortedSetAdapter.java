...
/**
 *  This class represents adapters of boolean sets to Java Collections
...
public class BooleanSortedSetToSortedSetAdapter extends BooleanSetToSetAdapter implements SortedSet {
    ...
    /**
     *  Creates a new adaption of a set of boolean
     ...
     */
    public BooleanSortedSetToSortedSetAdapter(BooleanSortedSet set) {
        super(set);
    }
     ...
     */
    public Object first() 
    { return new Boolean(((BooleanSortedSet)set).first()); }
     ...
     *              if <tt>to</tt> is not of class {@link Boolean Boolean}.
     *
     *  @throws     NullPointerException
     *              if <tt>to</tt> is <tt>null</tt>.
     */
    public SortedSet headSet(Object to) 
    { return new BooleanSortedSetToSortedSetAdapter(((BooleanSortedSet)set).headSet( ((Boolean)to).booleanValue() )); }
     ...
     */    
    public Object last() 
    { return new Boolean(((BooleanSortedSet)set).last()); }
     ...
     *
     *  @throws     ClassCastException
     *              if <tt>from</tt> is not of class {@link Boolean Boolean};
     *              if <tt>to</tt> is not of class {@link Boolean Boolean}.
     *
     *  @throws     NullPointerException
    ...
    public SortedSet subSet(Object from, Object to) {
        boolean tfrom = ((Boolean)from).booleanValue();
        boolean tto = ((Boolean)to).booleanValue();
        return new BooleanSortedSetToSortedSetAdapter(((BooleanSortedSet)set).subSet(tfrom, tto));
    }
    ...
    { return new BooleanSortedSetToSortedSetAdapter(((BooleanSortedSet)set).tailSet( ((Boolean)from).booleanValue() )); }
