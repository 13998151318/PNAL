 ...
 *  @since      1.0
 */
public class FloatKeyBooleanMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected FloatKeyBooleanMap map;
     ...
     */
    public FloatKeyBooleanMapToMapAdapter(FloatKeyBooleanMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultFloatHashFunction.INSTANCE.hash(key.floatValue()) ^ DefaultBooleanHashFunction.INSTANCE.hash(value.booleanValue()); }
