 ...
 *  @since      1.0
 */
public class CharKeyMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected CharKeyMap map;
     ...
     */
    public CharKeyMapToMapAdapter(CharKeyMap map) {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultCharHashFunction.INSTANCE.hash(key.charValue()) ^ value.hashCode(); }
