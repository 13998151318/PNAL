 ...
 *  @since      1.0
 */
public class LongKeyIntMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected LongKeyIntMap map;
     ...
     */
    public LongKeyIntMapToMapAdapter(LongKeyIntMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                LongKeyIntMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultLongHashFunction.INSTANCE.hash(key.longValue()) ^ DefaultIntHashFunction.INSTANCE.hash(value.intValue()); }
