 ...
 *  @since      1.0
 */
public class LongKeyFloatMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected LongKeyFloatMap map;
     ...
     */
    public LongKeyFloatMapToMapAdapter(LongKeyFloatMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                LongKeyFloatMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultLongHashFunction.INSTANCE.hash(key.longValue()) ^ DefaultFloatHashFunction.INSTANCE.hash(value.floatValue()); }
