 ...
 *  @since      1.1
 */
public class ObjectKeyShortMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected ObjectKeyShortMap map;
     ...
     */
    public ObjectKeyShortMapToMapAdapter(ObjectKeyShortMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    public Object put(Object key, Object value) throws NullPointerException, ClassCastException /* Exception marked to work around bug in Javadoc 1.3 */ {
        ...
        map.put(key, ((Short)value).shortValue());
        return result;
    }
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return (key == null ? 0 : key.hashCode()) ^ DefaultShortHashFunction.INSTANCE.hash(value.shortValue()); }
