 ...
 *  @since      1.0
 */
public class ShortKeyShortMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected ShortKeyShortMap map;
     ...
     */
    public ShortKeyShortMapToMapAdapter(ShortKeyShortMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultShortHashFunction.INSTANCE.hash(key.shortValue()) ^ DefaultShortHashFunction.INSTANCE.hash(value.shortValue()); }
