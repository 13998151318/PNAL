 ...
 *  byte values to Java Collections Framework collections. The adapter
 ...
 *  @since      1.0
 */
public class ByteCollectionToCollectionAdapter extends AbstractCollection {

    /** The underlying primitive collection. */
    protected ByteCollection collection;

    /**
     *  Creates a new adaption of a collection of byte
     ...
     *              if <tt>o</tt> is not of class {@link Byte Byte}.
     *
    ...
    public boolean add(Object o) {
        ...
        return collection.add(((Byte)o).byteValue());
    }
    ...
    public boolean contains(Object o) {
        try {
            return collection.contains(((Byte)o).byteValue());
    ...
    { return new ByteIteratorToIteratorAdapter(collection.iterator()); }
    ...
    public boolean remove(Object o) {
        try {
            return collection.remove(((Byte)o).byteValue());
        } catch (ClassCastException cce) {
        } catch (NullPointerException npe) {
        }
        return false;
