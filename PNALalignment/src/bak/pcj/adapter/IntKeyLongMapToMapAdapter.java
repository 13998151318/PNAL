 ...
 *  @since      1.0
 */
public class IntKeyLongMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected IntKeyLongMap map;
     ...
     */
    public IntKeyLongMapToMapAdapter(IntKeyLongMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                IntKeyLongMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultIntHashFunction.INSTANCE.hash(key.intValue()) ^ DefaultLongHashFunction.INSTANCE.hash(value.longValue()); }
