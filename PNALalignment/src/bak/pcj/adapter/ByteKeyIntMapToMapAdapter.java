 ...
 *  @since      1.0
 */
public class ByteKeyIntMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected ByteKeyIntMap map;
     ...
     */
    public ByteKeyIntMapToMapAdapter(ByteKeyIntMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                ByteKeyIntMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultByteHashFunction.INSTANCE.hash(key.byteValue()) ^ DefaultIntHashFunction.INSTANCE.hash(value.intValue()); }
