 ...
 *  @since      1.0
 */
public class ByteListToListAdapter extends AbstractList {
    ...
    public void add(int index, Object o) {
        ...
        list.add(index, ((Byte)o).byteValue() );
    }
    ...
    { return new ByteListIteratorToListIteratorAdapter(list.listIterator(index)); }
    ...
    { return new Byte(list.removeElementAt(index)); }
    ...
    public Object set(int index, Object o) {
        if (o == null)
            Exceptions.nullElementNotAllowed();
        return new Byte(list.set(index, ((Byte)o).byteValue()));
    }
