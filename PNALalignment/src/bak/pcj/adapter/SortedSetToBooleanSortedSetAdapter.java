...
public class SortedSetToBooleanSortedSetAdapter extends SetToBooleanSetAdapter implements BooleanSortedSet {
     ...
     */
    public SortedSetToBooleanSortedSetAdapter(SortedSet set, boolean validate) {
        super(set, validate);
    }

    public boolean first()
    { return ((Boolean)(((SortedSet)set).first())).booleanValue(); }

    public BooleanSortedSet headSet(boolean to) 
    { return new SortedSetToBooleanSortedSetAdapter(((SortedSet)set).headSet(new Boolean(to))); }

    public boolean last()
    { return ((Boolean)(((SortedSet)set).last())).booleanValue(); }

    public BooleanSortedSet subSet(boolean from, boolean to)
    { return new SortedSetToBooleanSortedSetAdapter(((SortedSet)set).subSet(new Boolean(from), new Boolean(to))); }

    public BooleanSortedSet tailSet(boolean from)
    { return new SortedSetToBooleanSortedSetAdapter(((SortedSet)set).tailSet(new Boolean(from))); }
