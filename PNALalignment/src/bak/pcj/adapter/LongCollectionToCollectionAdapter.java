 ...
 *  long values to Java Collections Framework collections. The adapter
...
public class LongCollectionToCollectionAdapter extends AbstractCollection {
    ...
    public boolean add(Object o) {
        ...
        return collection.add(((Long)o).longValue());
    }
    ...
    public boolean contains(Object o) {
        try {
            return collection.contains(((Long)o).longValue());
    ...
    { return new LongIteratorToIteratorAdapter(collection.iterator()); }
    ...
    public boolean remove(Object o) {
        try {
            return collection.remove(((Long)o).longValue());
        } catch (ClassCastException cce) {
        } catch (NullPointerException npe) {
        }
        return false;
