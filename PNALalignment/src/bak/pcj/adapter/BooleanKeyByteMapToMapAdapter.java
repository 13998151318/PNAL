 ...
 *  @since      1.0
 */
public class BooleanKeyByteMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected BooleanKeyByteMap map;
     ...
     */
    public BooleanKeyByteMapToMapAdapter(BooleanKeyByteMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                BooleanKeyByteMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultBooleanHashFunction.INSTANCE.hash(key.booleanValue()) ^ DefaultByteHashFunction.INSTANCE.hash(value.byteValue()); }
