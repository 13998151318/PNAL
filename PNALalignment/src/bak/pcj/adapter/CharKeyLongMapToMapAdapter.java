 ...
 *  @since      1.0
 */
public class CharKeyLongMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected CharKeyLongMap map;
     ...
     */
    public CharKeyLongMapToMapAdapter(CharKeyLongMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                CharKeyLongMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultCharHashFunction.INSTANCE.hash(key.charValue()) ^ DefaultLongHashFunction.INSTANCE.hash(value.longValue()); }
