 ...
 *  @since      1.0
 */
public class MapToShortKeyLongMapAdapter extends AbstractShortKeyLongMap implements ShortKeyLongMap {
    ...
    public boolean containsKey(short key) {
        lastValue = (Long)map.get(new Short(key));
    ...
    public long get(short key) {
        Long value = (Long)map.get(new Short(key));
    ...
    public long put(short key, long value) {
        Long oldValue = (Long)map.put(new Short(key), new Long(value));
        return oldValue == null ? MapDefaults.defaultLong() : oldValue.longValue();
    }

    public long remove(short key) {
        Long value = (Long)map.remove(new Short(key));
        return value == null ? MapDefaults.defaultLong() : value.longValue();
    }
    ...
    { return Adapter.isShortKeyLongAdaptable(map); }
