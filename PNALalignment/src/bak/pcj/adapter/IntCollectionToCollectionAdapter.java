 ...
 *  int values to Java Collections Framework collections. The adapter
 ...
 *  @since      1.0
 */
public class IntCollectionToCollectionAdapter extends AbstractCollection {

    /** The underlying primitive collection. */
    protected IntCollection collection;

    /**
     *  Creates a new adaption of a collection of int
     ...
     */
    public IntCollectionToCollectionAdapter(IntCollection collection) {
        super();
        if (collection == null)
     ...
     *              if <tt>o</tt> is not of class {@link Integer Integer}.
     *
    ...
    public boolean add(Object o) {
        ...
        return collection.add(((Integer)o).intValue());
    }
    ...
    public boolean contains(Object o) {
        try {
            return collection.contains(((Integer)o).intValue());
    ...
    { return new IntIteratorToIteratorAdapter(collection.iterator()); }
     ...
     *
     *  @param      o
     *              the Integer value to remove from this collection.
     *
     *  @return     <tt>true</tt> if this collection was modified
    ...
    public boolean remove(Object o) {
        try {
            return collection.remove(((Integer)o).intValue());
        } catch (ClassCastException cce) {
        } catch (NullPointerException npe) {
        }
        return false;
