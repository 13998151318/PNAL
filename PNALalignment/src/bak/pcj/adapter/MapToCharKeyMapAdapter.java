...
public class MapToCharKeyMapAdapter extends AbstractCharKeyMap implements CharKeyMap {
    ...
    public boolean containsKey(char key) {
        return map.get(new Character(key)) != null;
    }
    ...
    public Object get(char key) {
        return map.get(new Character(key));
    }
    ...
    public Object put(char key, Object value) {
        return map.put(new Character(key), value);
    }

    public Object remove(char key) {
        return map.remove(new Character(key));
    }
     ...
     *  can only contain {@link Character Character} keys and no <tt>null</tt>
     *  keys.
     *
    ...
    { return Adapter.isCharKeyAdaptable(map); }
