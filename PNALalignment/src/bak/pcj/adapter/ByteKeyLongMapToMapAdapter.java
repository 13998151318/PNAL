 ...
 *  @since      1.0
 */
public class ByteKeyLongMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected ByteKeyLongMap map;
     ...
     */
    public ByteKeyLongMapToMapAdapter(ByteKeyLongMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                ByteKeyLongMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultByteHashFunction.INSTANCE.hash(key.byteValue()) ^ DefaultLongHashFunction.INSTANCE.hash(value.longValue()); }
