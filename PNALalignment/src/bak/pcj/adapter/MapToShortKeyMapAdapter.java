 ...
 *  @since      1.0
 */
public class MapToShortKeyMapAdapter extends AbstractShortKeyMap implements ShortKeyMap {
    ...
    public boolean containsKey(short key) {
        return map.get(new Short(key)) != null;
    }
    ...
    public Object put(short key, Object value) {
        return map.put(new Short(key), value);
    }

    public Object remove(short key) {
        return map.remove(new Short(key));
    }
     ...
     *  can only contain {@link Short Short} keys and no <tt>null</tt>
     *  keys.
     *
    ...
    { return Adapter.isShortKeyAdaptable(map); }
