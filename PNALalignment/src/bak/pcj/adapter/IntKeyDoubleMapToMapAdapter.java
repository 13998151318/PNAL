 ...
 *  @since      1.0
 */
public class IntKeyDoubleMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected IntKeyDoubleMap map;
     ...
     */
    public IntKeyDoubleMapToMapAdapter(IntKeyDoubleMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultIntHashFunction.INSTANCE.hash(key.intValue()) ^ DefaultDoubleHashFunction.INSTANCE.hash(value.doubleValue()); }
