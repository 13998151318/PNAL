 ...
 *  @since      1.0
 */
public class ShortListToListAdapter extends AbstractList {
     ...
     */
    public ShortListToListAdapter(ShortList list) {
        if (list == null)
    ...
    public void add(int index, Object o) {
        ...
        list.add(index, ((Short)o).shortValue() );
    }
    ...
    { return new Short(list.get(index)); }
    ...
    { return new ShortListIteratorToListIteratorAdapter(list.listIterator(index)); }
    ...
    { return new Short(list.removeElementAt(index)); }
    ...
    public Object set(int index, Object o) {
        if (o == null)
            Exceptions.nullElementNotAllowed();
        return new Short(list.set(index, ((Short)o).shortValue()));
    }
