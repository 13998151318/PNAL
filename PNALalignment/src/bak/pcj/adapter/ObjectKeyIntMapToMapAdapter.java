 ...
 *  @since      1.1
 */
public class ObjectKeyIntMapToMapAdapter implements Map {
     ...
     */
    public ObjectKeyIntMapToMapAdapter(ObjectKeyIntMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return (key == null ? 0 : key.hashCode()) ^ DefaultIntHashFunction.INSTANCE.hash(value.intValue()); }
