 ...
 *  @since      1.0
 */
public class DoubleKeyMapToMapAdapter implements Map {
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                DoubleKeyMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultDoubleHashFunction.INSTANCE.hash(key.doubleValue()) ^ value.hashCode(); }
