 ...
 *  @since      1.1
 */
public class ObjectKeyByteMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected ObjectKeyByteMap map;
     ...
     */
    public ObjectKeyByteMapToMapAdapter(ObjectKeyByteMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    public Object put(Object key, Object value) throws NullPointerException, ClassCastException /* Exception marked to work around bug in Javadoc 1.3 */ {
        ...
        map.put(key, ((Byte)value).byteValue());
        return result;
    }
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return (key == null ? 0 : key.hashCode()) ^ DefaultByteHashFunction.INSTANCE.hash(value.byteValue()); }
