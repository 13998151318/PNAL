 ...
 *  @since      1.0
 */
public class IntKeyFloatMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected IntKeyFloatMap map;
     ...
     */
    public IntKeyFloatMapToMapAdapter(IntKeyFloatMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                IntKeyFloatMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultIntHashFunction.INSTANCE.hash(key.intValue()) ^ DefaultFloatHashFunction.INSTANCE.hash(value.floatValue()); }
