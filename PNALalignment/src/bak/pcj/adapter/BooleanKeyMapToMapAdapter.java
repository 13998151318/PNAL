 ...
 *  @version    1.1     20-08-2003 23:03
 *  @since      1.0
 */
public class BooleanKeyMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected BooleanKeyMap map;

    /**
     *  Creates a new adaption of a primitive map of boolean
     *  keys to a Java Collections Framework map.
     *
     *  @param      map
     *              the underlying primitive map.
     *
     ...
     */
    public BooleanKeyMapToMapAdapter(BooleanKeyMap map) {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                BooleanKeyMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultBooleanHashFunction.INSTANCE.hash(key.booleanValue()) ^ value.hashCode(); }
