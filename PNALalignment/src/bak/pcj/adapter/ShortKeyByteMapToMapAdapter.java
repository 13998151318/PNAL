 ...
 *  @since      1.0
 */
public class ShortKeyByteMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected ShortKeyByteMap map;
     ...
     */
    public ShortKeyByteMapToMapAdapter(ShortKeyByteMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultShortHashFunction.INSTANCE.hash(key.shortValue()) ^ DefaultByteHashFunction.INSTANCE.hash(value.byteValue()); }
