 ...
 *  @since      1.0
 */
public class FloatKeyShortMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected FloatKeyShortMap map;
     ...
     */
    public FloatKeyShortMapToMapAdapter(FloatKeyShortMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                FloatKeyShortMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultFloatHashFunction.INSTANCE.hash(key.floatValue()) ^ DefaultShortHashFunction.INSTANCE.hash(value.shortValue()); }
