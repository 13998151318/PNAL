 ...
 *  @since      1.0
 */
public class DoubleKeyBooleanMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected DoubleKeyBooleanMap map;
     ...
     */
    public DoubleKeyBooleanMapToMapAdapter(DoubleKeyBooleanMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultDoubleHashFunction.INSTANCE.hash(key.doubleValue()) ^ DefaultBooleanHashFunction.INSTANCE.hash(value.booleanValue()); }
