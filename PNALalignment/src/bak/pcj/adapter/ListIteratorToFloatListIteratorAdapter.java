...
public class ListIteratorToFloatListIteratorAdapter implements FloatListIterator {
     ...
     *  list iterator over float values.
     *
     *  @param      iterator
     ...
     */
    public ListIteratorToFloatListIteratorAdapter(ListIterator iterator) {
        if (iterator == null)
    ...
    { return ((Float)iterator.previous()).floatValue(); }
