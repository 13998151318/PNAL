 ...
 *  in the client code:
 *  <pre>
 *      MapToDoubleKeyLongMapAdapter s;
 *      ...
...
public class MapToDoubleKeyLongMapAdapter extends AbstractDoubleKeyLongMap implements DoubleKeyLongMap {
    ...
    public boolean containsKey(double key) {
        lastValue = (Long)map.get(new Double(key));
    ...
    public long get(double key) {
        Long value = (Long)map.get(new Double(key));
    ...
    public long put(double key, long value) {
        Long oldValue = (Long)map.put(new Double(key), new Long(value));
        return oldValue == null ? MapDefaults.defaultLong() : oldValue.longValue();
    }

    public long remove(double key) {
        Long value = (Long)map.remove(new Double(key));
        return value == null ? MapDefaults.defaultLong() : value.longValue();
    }
    ...
    { return Adapter.isDoubleKeyLongAdaptable(map); }
