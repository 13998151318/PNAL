 ...
 *  @since      1.0
 */
public class CharCollectionToCollectionAdapter extends AbstractCollection {

    /** The underlying primitive collection. */
    protected CharCollection collection;

    /**
     *  Creates a new adaption of a collection of char
     ...
     */
    public CharCollectionToCollectionAdapter(CharCollection collection) {
        super();
        if (collection == null)
     ...
     *              if <tt>o</tt> is not of class {@link Character Character}.
     *
    ...
    public boolean add(Object o) {
        ...
        return collection.add(((Character)o).charValue());
    }
    ...
    public boolean contains(Object o) {
        try {
            return collection.contains(((Character)o).charValue());
    ...
    { return new CharIteratorToIteratorAdapter(collection.iterator()); }
     ...
     *
     *  @param      o
     *              the Character value to remove from this collection.
     *
     *  @return     <tt>true</tt> if this collection was modified
    ...
    public boolean remove(Object o) {
        try {
            return collection.remove(((Character)o).charValue());
        } catch (ClassCastException cce) {
        } catch (NullPointerException npe) {
        }
        return false;
