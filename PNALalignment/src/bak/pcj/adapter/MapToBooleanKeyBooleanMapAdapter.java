 ...
 *  in the client code:
 *  <pre>
 *      MapToBooleanKeyBooleanMapAdapter s;
 *      ...
 ...
 *  @since      1.0
 */
public class MapToBooleanKeyBooleanMapAdapter extends AbstractBooleanKeyBooleanMap implements BooleanKeyBooleanMap {
    ...
    public boolean containsKey(boolean key) {
        lastValue = (Boolean)map.get(new Boolean(key));
    ...
    public boolean get(boolean key) {
        Boolean value = (Boolean)map.get(new Boolean(key));
    ...
    public boolean put(boolean key, boolean value) {
        Boolean oldValue = (Boolean)map.put(new Boolean(key), new Boolean(value));
        return oldValue == null ? MapDefaults.defaultBoolean() : oldValue.booleanValue();
    }

    public boolean remove(boolean key) {
        Boolean value = (Boolean)map.remove(new Boolean(key));
        return value == null ? MapDefaults.defaultBoolean() : value.booleanValue();
    }
    ...
    { return Adapter.isBooleanKeyBooleanAdaptable(map); }
