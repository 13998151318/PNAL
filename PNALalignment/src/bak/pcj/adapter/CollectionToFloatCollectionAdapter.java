...
public class CollectionToFloatCollectionAdapter extends AbstractFloatCollection {
    ...
    /**
     *  Creates a new adaption of a collection to a collection of float
     *  values.
     *
     *  @param      collection
    ...
    { return collection.add(new Float(v)); }

    public void clear()
    { collection.clear(); }

    public boolean contains(float v)
    { return collection.contains(new Float(v)); }

    public int hashCode()
    { return collection.hashCode(); }

    public FloatIterator iterator()
    { return new IteratorToFloatIteratorAdapter(collection.iterator()); }

    public boolean remove(float v)
    { return collection.remove(new Float(v)); }
    ...
    { return Adapter.isFloatAdaptable(collection); }
