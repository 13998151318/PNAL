...
public class CollectionToCharCollectionAdapter extends AbstractCharCollection {
    ...
    /**
     *  Creates a new adaption of a collection to a collection of char
     *  values.
     *
     *  @param      collection
    ...
    { return collection.add(new Character(v)); }

    public void clear()
    { collection.clear(); }

    public boolean contains(char v)
    { return collection.contains(new Character(v)); }

    public int hashCode()
    { return collection.hashCode(); }

    public CharIterator iterator()
    { return new IteratorToCharIteratorAdapter(collection.iterator()); }

    public boolean remove(char v)
    { return collection.remove(new Character(v)); }
    ...
    { return Adapter.isCharAdaptable(collection); }
