 ...
 *  @since      1.0
 */
public class CharListIteratorToListIteratorAdapter implements ListIterator {
     ...
     *  char values to a Java Collections Framework list iterator.
     *
     *  @param      iterator
    ...
    { iterator.add( ((Character)o).charValue() ); }
     ...
     */
    public Object next()
    { return new Character(iterator.next()); }
    ...
    { return new Character(iterator.previous()); }
    ...
    { iterator.set(((Character)o).charValue()); }
