 ...
 *  in the client code:
 *  <pre>
 *      MapToObjectKeyBooleanMapAdapter s;
 *      ...
 ...
 *  @since      1.1
 */
public class MapToObjectKeyBooleanMapAdapter extends AbstractObjectKeyBooleanMap implements ObjectKeyBooleanMap {
    ...
    public boolean put(Object key, boolean value) {
        Boolean oldValue = (Boolean)map.put(key, new Boolean(value));
        return oldValue == null ? MapDefaults.defaultBoolean() : oldValue.booleanValue();
    }

    public boolean remove(Object key) {
        Boolean value = (Boolean)map.remove(key);
        return value == null ? MapDefaults.defaultBoolean() : value.booleanValue();
    }
     ...
     *  values and only {@link Boolean Boolean} values.
     *
     *  @return     <tt>true</tt> if the underlying map is
     *              valid; returns <tt>false</tt> otherwise.
     */
    public boolean validate()
    { return Adapter.isObjectKeyBooleanAdaptable(map); }
