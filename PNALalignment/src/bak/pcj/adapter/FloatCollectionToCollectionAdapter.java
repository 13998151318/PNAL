 ...
 *  float values to Java Collections Framework collections. The adapter
 ...
 *  @since      1.0
 */
public class FloatCollectionToCollectionAdapter extends AbstractCollection {

    /** The underlying primitive collection. */
    protected FloatCollection collection;

    /**
     *  Creates a new adaption of a collection of float
     ...
     *              if <tt>o</tt> is not of class {@link Float Float}.
     *
    ...
    public boolean add(Object o) {
        ...
        return collection.add(((Float)o).floatValue());
    }
    ...
    public boolean contains(Object o) {
        try {
            return collection.contains(((Float)o).floatValue());
    ...
    { return new FloatIteratorToIteratorAdapter(collection.iterator()); }
    ...
    public boolean remove(Object o) {
        try {
            return collection.remove(((Float)o).floatValue());
        } catch (ClassCastException cce) {
        } catch (NullPointerException npe) {
        }
        return false;
