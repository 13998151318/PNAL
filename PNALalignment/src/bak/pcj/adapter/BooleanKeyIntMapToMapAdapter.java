 ...
 *  @since      1.0
 */
public class BooleanKeyIntMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected BooleanKeyIntMap map;

    /**
     *  Creates a new adaption of a primitive map of boolean
     *  keys and int values to a Java Collections Framework map.
     *
     *  @param      map
     *              the underlying primitive map.
     *
     ...
     */
    public BooleanKeyIntMapToMapAdapter(BooleanKeyIntMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
     ...
     *  values or values of other classes than {@link Integer Integer}.
    ...
    public boolean containsValue(Object value) {
        if (value == null)
            return false;
        return map.containsValue(((Integer)value).intValue());
    }
     ...
     *  The returned value will always be of class {@link Integer Integer}.
     *
     *  @param      key
     ...
     *  @throws     ClassCastException
     *              if <tt>key</tt> is not of class {@link Boolean Boolean};
     *              if <tt>value</tt> is not of class {@link Integer Integer}.
     */
    public Object put(Object key, Object value) throws NullPointerException, ClassCastException /* Exception marked to work around bug in Javadoc 1.3 */ {
        ...
        boolean k = ((Boolean)key).booleanValue();
        map.put(k, ((Integer)value).intValue());
        return result;
    }
     ...
     *              if a value in <tt>value</tt> is not of class {@link Integer Integer}.
     */
     ...
     *  in the returned set is of class {@link Integer Integer}.
     *
     *  @return     a collection view of the values in this map.
     */
    public Collection values() {
        return new IntCollectionToCollectionAdapter(map.values());
    }
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultBooleanHashFunction.INSTANCE.hash(key.booleanValue()) ^ DefaultIntHashFunction.INSTANCE.hash(value.intValue()); }
