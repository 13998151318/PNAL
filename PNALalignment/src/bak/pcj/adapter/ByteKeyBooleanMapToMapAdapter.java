 ...
 *  @since      1.0
 */
public class ByteKeyBooleanMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected ByteKeyBooleanMap map;

    /**
     *  Creates a new adaption of a primitive map of byte
     ...
     */
    public ByteKeyBooleanMapToMapAdapter(ByteKeyBooleanMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
     ...
     *              if <tt>key</tt> is not of class {@link Byte Byte}.
     */
    ...
    { return map.containsKey(((Byte)key).byteValue()); }
     ...
     *  if the returned set is of class {@link Byte Byte}.
     *
     *  @return     a set view of the keys of this map.
     */
    public Set keySet() {
        return new ByteSetToSetAdapter(map.keySet());
    }
     ...
     *
     *  @throws     ClassCastException
     *              if a key in <tt>map</tt> is not of class {@link Byte Byte};
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                ByteKeyBooleanMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultByteHashFunction.INSTANCE.hash(key.byteValue()) ^ DefaultBooleanHashFunction.INSTANCE.hash(value.booleanValue()); }
