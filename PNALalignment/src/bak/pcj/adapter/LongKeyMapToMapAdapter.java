 ...
 *  @since      1.0
 */
public class LongKeyMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected LongKeyMap map;
     ...
     */
    public LongKeyMapToMapAdapter(LongKeyMap map) {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultLongHashFunction.INSTANCE.hash(key.longValue()) ^ value.hashCode(); }
