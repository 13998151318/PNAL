...
import bak.pcj.map.ObjectKeyFloatMapIterator;
 ...
 *  object values to <S> values to Java Collections
 ...
 *  map and vice versa.
 *
 *  @see        ObjectKeyFloatMap
 *  @see        java.util.Map
 *
 *  @author     S&oslash;ren Bak
 *  @version    1.1     20-08-2003 23:09
 *  @since      1.1
 */
public class ObjectKeyFloatMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected ObjectKeyFloatMap map;

    /**
     *  Creates a new adaption of a primitive map of object
     ...
     */
    public ObjectKeyFloatMapToMapAdapter(ObjectKeyFloatMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
     ...
     *  The returned value will always be of class {@link <JS> <JS>}.
     *
     *  @param      key
    ...
    public Object put(Object key, Object value) throws NullPointerException, ClassCastException /* Exception marked to work around bug in Javadoc 1.3 */ {
        ...
        map.put(key, ((Float)value).floatValue());
        return result;
    }
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return (key == null ? 0 : key.hashCode()) ^ DefaultFloatHashFunction.INSTANCE.hash(value.floatValue()); }

        public boolean equals(Object obj) {
            if (!(obj instanceof Map.Entry))
                return false;
            Map.Entry e = (Map.Entry)obj;
            return (key==null?e.getKey()==null:key.equals(e.getKey())) && value.equals(e.getValue());
        }
    }
