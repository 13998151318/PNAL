 ...
 *  @since      1.0
 */
public class ShortKeyFloatMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected ShortKeyFloatMap map;
     ...
     */
    public ShortKeyFloatMapToMapAdapter(ShortKeyFloatMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultShortHashFunction.INSTANCE.hash(key.shortValue()) ^ DefaultFloatHashFunction.INSTANCE.hash(value.floatValue()); }
