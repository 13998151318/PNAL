 ...
 *  @since      1.0
 */
public class DoubleSetToSetAdapter extends AbstractSet {

    /** The underlying primitive set. */
    protected DoubleSet set;
     ...
     */
    public DoubleSetToSetAdapter(DoubleSet set) {
        if (set == null)
     ...
     *              if <tt>o</tt> is not of class {@link Double Double}.
     *
    ...
    public boolean add(Object o) {
        ...
        return set.add(((Double)o).doubleValue());
    }
    ...
    public boolean contains(Object o) {
        try {
            return set.contains( ((Double)o).doubleValue() );
    ...
    { return new DoubleIteratorToIteratorAdapter(set.iterator()); }
     ...
     *
     *  @param      o
     *              the Double value to remove from this set.
     *
     *  @return     <tt>true</tt> if this set was modified
    ...
    public boolean remove(Object o) {
        try {
            return set.remove( ((Double)o).doubleValue() );
        } catch (ClassCastException cce) {
        } catch (NullPointerException npe) {
        }
        return false;
