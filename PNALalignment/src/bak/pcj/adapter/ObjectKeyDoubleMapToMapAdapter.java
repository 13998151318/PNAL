 ...
 *  @since      1.1
 */
public class ObjectKeyDoubleMapToMapAdapter implements Map {
     ...
     */
    public ObjectKeyDoubleMapToMapAdapter(ObjectKeyDoubleMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    public Object put(Object key, Object value) throws NullPointerException, ClassCastException /* Exception marked to work around bug in Javadoc 1.3 */ {
        ...
        map.put(key, ((Double)value).doubleValue());
        return result;
    }
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return (key == null ? 0 : key.hashCode()) ^ DefaultDoubleHashFunction.INSTANCE.hash(value.doubleValue()); }
