...
/**
 *  This class represents adapters of double sets to Java Collections
 ...
 *  @since      1.2
 */
public class DoubleSortedSetToSortedSetAdapter extends DoubleSetToSetAdapter implements SortedSet {

    /**
     *  Creates a new adaption of a set of double
     ...
     */
    public DoubleSortedSetToSortedSetAdapter(DoubleSortedSet set) {
        super(set);
    }
     ...
     */
    public Object first() 
    { return new Double(((DoubleSortedSet)set).first()); }
     ...
     *              if <tt>to</tt> is not of class {@link Double Double}.
     *
     *  @throws     NullPointerException
     *              if <tt>to</tt> is <tt>null</tt>.
     */
    public SortedSet headSet(Object to) 
    { return new DoubleSortedSetToSortedSetAdapter(((DoubleSortedSet)set).headSet( ((Double)to).doubleValue() )); }
     ...
     */    
    public Object last() 
    { return new Double(((DoubleSortedSet)set).last()); }
     ...
     *
     *  @throws     ClassCastException
     *              if <tt>from</tt> is not of class {@link Double Double};
     *              if <tt>to</tt> is not of class {@link Double Double}.
     *
     *  @throws     NullPointerException
    ...
    public SortedSet subSet(Object from, Object to) {
        double tfrom = ((Double)from).doubleValue();
        double tto = ((Double)to).doubleValue();
        return new DoubleSortedSetToSortedSetAdapter(((DoubleSortedSet)set).subSet(tfrom, tto));
    }
    ...
    { return new DoubleSortedSetToSortedSetAdapter(((DoubleSortedSet)set).tailSet( ((Double)from).doubleValue() )); }
