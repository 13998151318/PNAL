 ...
 *  in the client code:
 *  <pre>
 *      MapToDoubleKeyBooleanMapAdapter s;
 *      ...
...
public class MapToDoubleKeyBooleanMapAdapter extends AbstractDoubleKeyBooleanMap implements DoubleKeyBooleanMap {
    ...
    public boolean containsKey(double key) {
        lastValue = (Boolean)map.get(new Double(key));
    ...
    public boolean get(double key) {
        Boolean value = (Boolean)map.get(new Double(key));
    ...
    public boolean put(double key, boolean value) {
        Boolean oldValue = (Boolean)map.put(new Double(key), new Boolean(value));
        return oldValue == null ? MapDefaults.defaultBoolean() : oldValue.booleanValue();
    }

    public boolean remove(double key) {
        Boolean value = (Boolean)map.remove(new Double(key));
        return value == null ? MapDefaults.defaultBoolean() : value.booleanValue();
    }
    ...
    { return Adapter.isDoubleKeyBooleanAdaptable(map); }
