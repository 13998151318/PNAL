 ...
 *  @since      1.0
 */
public class LongKeyLongMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected LongKeyLongMap map;
     ...
     */
    public LongKeyLongMapToMapAdapter(LongKeyLongMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                LongKeyLongMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultLongHashFunction.INSTANCE.hash(key.longValue()) ^ DefaultLongHashFunction.INSTANCE.hash(value.longValue()); }
