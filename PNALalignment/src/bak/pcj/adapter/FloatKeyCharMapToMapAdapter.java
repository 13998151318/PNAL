 ...
 *  @since      1.0
 */
public class FloatKeyCharMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected FloatKeyCharMap map;
     ...
     */
    public FloatKeyCharMapToMapAdapter(FloatKeyCharMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultFloatHashFunction.INSTANCE.hash(key.floatValue()) ^ DefaultCharHashFunction.INSTANCE.hash(value.charValue()); }
