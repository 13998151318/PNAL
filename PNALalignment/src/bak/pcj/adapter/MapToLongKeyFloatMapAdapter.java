 ...
 *  @since      1.0
 */
public class MapToLongKeyFloatMapAdapter extends AbstractLongKeyFloatMap implements LongKeyFloatMap {
    ...
    public boolean containsKey(long key) {
        lastValue = (Float)map.get(new Long(key));
    ...
    public float get(long key) {
        Float value = (Float)map.get(new Long(key));
    ...
    public float put(long key, float value) {
        Float oldValue = (Float)map.put(new Long(key), new Float(value));
        return oldValue == null ? MapDefaults.defaultFloat() : oldValue.floatValue();
    }

    public float remove(long key) {
        Float value = (Float)map.remove(new Long(key));
        return value == null ? MapDefaults.defaultFloat() : value.floatValue();
    }
    ...
    { return Adapter.isLongKeyFloatAdaptable(map); }
