 ...
 *  @since      1.0
 */
public class IntListToListAdapter extends AbstractList {
    ...
    public void add(int index, Object o) {
        ...
        list.add(index, ((Integer)o).intValue() );
    }
    ...
    { return new IntListIteratorToListIteratorAdapter(list.listIterator(index)); }
    ...
    { return new Integer(list.removeElementAt(index)); }
    ...
    public Object set(int index, Object o) {
        if (o == null)
            Exceptions.nullElementNotAllowed();
        return new Integer(list.set(index, ((Integer)o).intValue()));
    }
