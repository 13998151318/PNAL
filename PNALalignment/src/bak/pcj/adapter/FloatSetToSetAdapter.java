 ...
 *  @since      1.0
 */
public class FloatSetToSetAdapter extends AbstractSet {
    ...
    public boolean add(Object o) {
        ...
        return set.add(((Float)o).floatValue());
    }
    ...
    public boolean contains(Object o) {
        try {
            return set.contains( ((Float)o).floatValue() );
    ...
    { return new FloatIteratorToIteratorAdapter(set.iterator()); }
     ...
     *
     *  @param      o
     *              the Float value to remove from this set.
     *
     *  @return     <tt>true</tt> if this set was modified
    ...
    public boolean remove(Object o) {
        try {
            return set.remove( ((Float)o).floatValue() );
        } catch (ClassCastException cce) {
        } catch (NullPointerException npe) {
        }
        return false;
