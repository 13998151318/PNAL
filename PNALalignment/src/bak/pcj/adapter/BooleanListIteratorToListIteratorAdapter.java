 ...
 *  @since      1.0
 */
public class BooleanListIteratorToListIteratorAdapter implements ListIterator {

    /** The underlying primitive iterator. */
    protected BooleanListIterator iterator;

    /**
     *  Creates a new adaption of a primitive list iterator over
     *  boolean values to a Java Collections Framework list iterator.
     *
     *  @param      iterator
     ...
     */
    public BooleanListIteratorToListIteratorAdapter(BooleanListIterator iterator) {
        if (iterator == null)
    ...
    { iterator.add( ((Boolean)o).booleanValue() ); }
     ...
     */
    public Object next()
    { return new Boolean(iterator.next()); }
    ...
    { return new Boolean(iterator.previous()); }
    ...
    { iterator.set(((Boolean)o).booleanValue()); }
