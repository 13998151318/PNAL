 ...
 *  @since      1.0
 */
public class FloatKeyIntMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected FloatKeyIntMap map;
     ...
     */
    public FloatKeyIntMapToMapAdapter(FloatKeyIntMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultFloatHashFunction.INSTANCE.hash(key.floatValue()) ^ DefaultIntHashFunction.INSTANCE.hash(value.intValue()); }
