 ...
 *  @since      1.0
 */
public class DoubleKeyShortMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected DoubleKeyShortMap map;
     ...
     */
    public DoubleKeyShortMapToMapAdapter(DoubleKeyShortMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultDoubleHashFunction.INSTANCE.hash(key.doubleValue()) ^ DefaultShortHashFunction.INSTANCE.hash(value.shortValue()); }
