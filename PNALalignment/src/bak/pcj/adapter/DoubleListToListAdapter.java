 ...
 *  @since      1.0
 */
public class DoubleListToListAdapter extends AbstractList {

    /** The underlying primitive list. */
    protected DoubleList list;

    /**
     *  Creates a new adaption of a collection of double
     ...
     */
    public DoubleListToListAdapter(DoubleList list) {
        if (list == null)
    ...
    public void add(int index, Object o) {
        ...
        list.add(index, ((Double)o).doubleValue() );
    }
    ...
    { return new Double(list.get(index)); }
    ...
    { return new DoubleListIteratorToListIteratorAdapter(list.listIterator(index)); }
    ...
    { return new Double(list.removeElementAt(index)); }
    ...
    public Object set(int index, Object o) {
        if (o == null)
            Exceptions.nullElementNotAllowed();
        return new Double(list.set(index, ((Double)o).doubleValue()));
    }
