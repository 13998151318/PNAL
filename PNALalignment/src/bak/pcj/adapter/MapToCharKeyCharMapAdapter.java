 ...
 *  @since      1.0
 */
public class MapToCharKeyCharMapAdapter extends AbstractCharKeyCharMap implements CharKeyCharMap {
    ...
    public boolean containsKey(char key) {
        lastValue = (Character)map.get(new Character(key));
    ...
    public char get(char key) {
        Character value = (Character)map.get(new Character(key));
    ...
    public char put(char key, char value) {
        Character oldValue = (Character)map.put(new Character(key), new Character(value));
        return oldValue == null ? MapDefaults.defaultChar() : oldValue.charValue();
    }

    public char remove(char key) {
        Character value = (Character)map.remove(new Character(key));
        return value == null ? MapDefaults.defaultChar() : value.charValue();
    }
    ...
    { return Adapter.isCharKeyCharAdaptable(map); }
