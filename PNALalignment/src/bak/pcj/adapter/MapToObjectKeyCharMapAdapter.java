 ...
 *  in the client code:
 *  <pre>
 *      MapToObjectKeyCharMapAdapter s;
 *      ...
 ...
 *  @since      1.1
 */
public class MapToObjectKeyCharMapAdapter extends AbstractObjectKeyCharMap implements ObjectKeyCharMap {
    ...
    public boolean containsKey(Object key) {
        lastValue = (Character)map.get(key);
    ...
    public char put(Object key, char value) {
        Character oldValue = (Character)map.put(key, new Character(value));
        return oldValue == null ? MapDefaults.defaultChar() : oldValue.charValue();
    }

    public char remove(Object key) {
        Character value = (Character)map.remove(key);
        return value == null ? MapDefaults.defaultChar() : value.charValue();
    }
     ...
     *  values and only {@link Character Character} values.
     *
     *  @return     <tt>true</tt> if the underlying map is
     *              valid; returns <tt>false</tt> otherwise.
     */
    public boolean validate()
    { return Adapter.isObjectKeyCharAdaptable(map); }
