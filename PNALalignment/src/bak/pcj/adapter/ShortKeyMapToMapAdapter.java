 ...
 *  @since      1.0
 */
public class ShortKeyMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected ShortKeyMap map;
     ...
     */
    public ShortKeyMapToMapAdapter(ShortKeyMap map) {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultShortHashFunction.INSTANCE.hash(key.shortValue()) ^ value.hashCode(); }
