 ...
 *  @since      1.0
 */
public class ShortKeyBooleanMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected ShortKeyBooleanMap map;
     ...
     */
    public ShortKeyBooleanMapToMapAdapter(ShortKeyBooleanMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultShortHashFunction.INSTANCE.hash(key.shortValue()) ^ DefaultBooleanHashFunction.INSTANCE.hash(value.booleanValue()); }
