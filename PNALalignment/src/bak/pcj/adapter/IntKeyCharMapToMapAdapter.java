 ...
 *  @since      1.0
 */
public class IntKeyCharMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected IntKeyCharMap map;
     ...
     */
    public IntKeyCharMapToMapAdapter(IntKeyCharMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                IntKeyCharMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultIntHashFunction.INSTANCE.hash(key.intValue()) ^ DefaultCharHashFunction.INSTANCE.hash(value.charValue()); }
