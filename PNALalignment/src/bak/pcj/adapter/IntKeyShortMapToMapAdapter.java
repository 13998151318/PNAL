 ...
 *  @since      1.0
 */
public class IntKeyShortMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected IntKeyShortMap map;
     ...
     */
    public IntKeyShortMapToMapAdapter(IntKeyShortMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                IntKeyShortMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultIntHashFunction.INSTANCE.hash(key.intValue()) ^ DefaultShortHashFunction.INSTANCE.hash(value.shortValue()); }
