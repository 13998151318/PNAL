 ...
 *  @since      1.0
 */
public class FloatKeyFloatMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected FloatKeyFloatMap map;
     ...
     */
    public FloatKeyFloatMapToMapAdapter(FloatKeyFloatMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultFloatHashFunction.INSTANCE.hash(key.floatValue()) ^ DefaultFloatHashFunction.INSTANCE.hash(value.floatValue()); }
