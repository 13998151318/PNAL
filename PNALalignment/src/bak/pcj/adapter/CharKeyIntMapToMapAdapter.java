 ...
 *  @since      1.0
 */
public class CharKeyIntMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected CharKeyIntMap map;
     ...
     */
    public CharKeyIntMapToMapAdapter(CharKeyIntMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultCharHashFunction.INSTANCE.hash(key.charValue()) ^ DefaultIntHashFunction.INSTANCE.hash(value.intValue()); }
