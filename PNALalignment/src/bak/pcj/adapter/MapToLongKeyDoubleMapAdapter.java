...
import bak.pcj.map.AbstractLongKeyDoubleMap;
 ...
 *  in the client code:
 *  <pre>
 *      MapToLongKeyDoubleMapAdapter s;
 *      ...
 ...
 *  @since      1.0
 */
public class MapToLongKeyDoubleMapAdapter extends AbstractLongKeyDoubleMap implements LongKeyDoubleMap {
     ...
     */
    public MapToLongKeyDoubleMapAdapter(Map map) {
        if (map == null)
     ...
     *              {@link Double Double}.
     */
    public MapToLongKeyDoubleMapAdapter(Map map, boolean validate) {
        if (map == null)
            Exceptions.nullArgument("map");
        this.map = map;
        lastValue = null;
    ...
    public boolean containsKey(long key) {
        lastValue = (Double)map.get(new Long(key));
    ...
    public double get(long key) {
        Double value = (Double)map.get(new Long(key));
    ...
    public double put(long key, double value) {
        Double oldValue = (Double)map.put(new Long(key), new Double(value));
        return oldValue == null ? MapDefaults.defaultDouble() : oldValue.doubleValue();
    }

    public double remove(long key) {
        Double value = (Double)map.remove(new Long(key));
        return value == null ? MapDefaults.defaultDouble() : value.doubleValue();
    }
    ...
    { return Adapter.isLongKeyDoubleAdaptable(map); }
