 ...
 *  @since      1.0
 */
public class LongListIteratorToListIteratorAdapter implements ListIterator {

    /** The underlying primitive iterator. */
    protected LongListIterator iterator;

    /**
     *  Creates a new adaption of a primitive list iterator over
     *  long values to a Java Collections Framework list iterator.
     *
     *  @param      iterator
     ...
     */
    public LongListIteratorToListIteratorAdapter(LongListIterator iterator) {
        if (iterator == null)
    ...
    { return new Long(iterator.previous()); }
