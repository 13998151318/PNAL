...
public class BooleanSetToSetAdapter extends AbstractSet {
     ...
     */
    public BooleanSetToSetAdapter(BooleanSet set) {
        if (set == null)
    ...
    public boolean add(Object o) {
        ...
        return set.add(((Boolean)o).booleanValue());
    }
    ...
    public boolean contains(Object o) {
        try {
            return set.contains( ((Boolean)o).booleanValue() );
    ...
    { return new BooleanIteratorToIteratorAdapter(set.iterator()); }
     ...
     *
     *  @param      o
     *              the Boolean value to remove from this set.
     *
     *  @return     <tt>true</tt> if this set was modified
    ...
    public boolean remove(Object o) {
        try {
            return set.remove( ((Boolean)o).booleanValue() );
        } catch (ClassCastException cce) {
        } catch (NullPointerException npe) {
        }
        return false;
