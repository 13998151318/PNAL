 ...
 *  @since      1.0
 */
public class MapToShortKeyByteMapAdapter extends AbstractShortKeyByteMap implements ShortKeyByteMap {
    ...
    public boolean containsKey(short key) {
        lastValue = (Byte)map.get(new Short(key));
    ...
    public byte get(short key) {
        Byte value = (Byte)map.get(new Short(key));
    ...
    public byte put(short key, byte value) {
        Byte oldValue = (Byte)map.put(new Short(key), new Byte(value));
        return oldValue == null ? MapDefaults.defaultByte() : oldValue.byteValue();
    }

    public byte remove(short key) {
        Byte value = (Byte)map.remove(new Short(key));
        return value == null ? MapDefaults.defaultByte() : value.byteValue();
    }
    ...
    { return Adapter.isShortKeyByteAdaptable(map); }
