 ...
 *  @since      1.0
 */
public class MapToIntKeyIntMapAdapter extends AbstractIntKeyIntMap implements IntKeyIntMap {
    ...
    public boolean containsKey(int key) {
        lastValue = (Integer)map.get(new Integer(key));
    ...
    public int put(int key, int value) {
        Integer oldValue = (Integer)map.put(new Integer(key), new Integer(value));
        return oldValue == null ? MapDefaults.defaultInt() : oldValue.intValue();
    }

    public int remove(int key) {
        Integer value = (Integer)map.remove(new Integer(key));
        return value == null ? MapDefaults.defaultInt() : value.intValue();
    }
    ...
    { return Adapter.isIntKeyIntAdaptable(map); }
