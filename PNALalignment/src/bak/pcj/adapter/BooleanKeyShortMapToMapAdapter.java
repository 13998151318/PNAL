 ...
 *  @since      1.0
 */
public class BooleanKeyShortMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected BooleanKeyShortMap map;

    /**
     *  Creates a new adaption of a primitive map of boolean
     *  keys and short values to a Java Collections Framework map.
     *
     *  @param      map
     *              the underlying primitive map.
     *
     ...
     */
    public BooleanKeyShortMapToMapAdapter(BooleanKeyShortMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    public boolean containsValue(Object value) {
        if (value == null)
            return false;
        return map.containsValue(((Short)value).shortValue());
    }
     ...
     *  The returned value will always be of class {@link Short Short}.
     *
     *  @param      key
     ...
     *  @throws     ClassCastException
     *              if <tt>key</tt> is not of class {@link Boolean Boolean};
     *              if <tt>value</tt> is not of class {@link Short Short}.
     */
    public Object put(Object key, Object value) throws NullPointerException, ClassCastException /* Exception marked to work around bug in Javadoc 1.3 */ {
        ...
        boolean k = ((Boolean)key).booleanValue();
        map.put(k, ((Short)value).shortValue());
        return result;
    }
     ...
     *              if a value in <tt>value</tt> is not of class {@link Short Short}.
     */
     ...
     *  in the returned set is of class {@link Short Short}.
     *
     *  @return     a collection view of the values in this map.
     */
    public Collection values() {
        return new ShortCollectionToCollectionAdapter(map.values());
    }
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                BooleanKeyShortMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultBooleanHashFunction.INSTANCE.hash(key.booleanValue()) ^ DefaultShortHashFunction.INSTANCE.hash(value.shortValue()); }
