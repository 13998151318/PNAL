 ...
 *  @since      1.0
 */
public class BooleanKeyLongMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected BooleanKeyLongMap map;

    /**
     *  Creates a new adaption of a primitive map of boolean
     *  keys and long values to a Java Collections Framework map.
     *
     *  @param      map
     *              the underlying primitive map.
     *
     ...
     */
    public BooleanKeyLongMapToMapAdapter(BooleanKeyLongMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
     ...
     *  values or values of other classes than {@link Long Long}.
    ...
    public boolean containsValue(Object value) {
        if (value == null)
            return false;
        return map.containsValue(((Long)value).longValue());
    }
     ...
     *  @throws     ClassCastException
     *              if <tt>key</tt> is not of class {@link Boolean Boolean};
     *              if <tt>value</tt> is not of class {@link Long Long}.
     */
    public Object put(Object key, Object value) throws NullPointerException, ClassCastException /* Exception marked to work around bug in Javadoc 1.3 */ {
        ...
        boolean k = ((Boolean)key).booleanValue();
        map.put(k, ((Long)value).longValue());
        return result;
    }
     ...
     *              if a value in <tt>value</tt> is not of class {@link Long Long}.
     */
     ...
     *  in the returned set is of class {@link Long Long}.
     *
     *  @return     a collection view of the values in this map.
     */
    public Collection values() {
        return new LongCollectionToCollectionAdapter(map.values());
    }
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                BooleanKeyLongMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultBooleanHashFunction.INSTANCE.hash(key.booleanValue()) ^ DefaultLongHashFunction.INSTANCE.hash(value.longValue()); }
