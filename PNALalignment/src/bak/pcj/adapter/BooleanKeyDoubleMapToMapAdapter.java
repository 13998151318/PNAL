 ...
 *  @since      1.0
 */
public class BooleanKeyDoubleMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected BooleanKeyDoubleMap map;
     ...
     */
    public BooleanKeyDoubleMapToMapAdapter(BooleanKeyDoubleMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        Entry(boolean key, double value) {
        ...
        public int hashCode()
        { return DefaultBooleanHashFunction.INSTANCE.hash(key.booleanValue()) ^ DefaultDoubleHashFunction.INSTANCE.hash(value.doubleValue()); }
