 ...
 *  @since      1.0
 */
public class FloatKeyLongMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected FloatKeyLongMap map;
     ...
     */
    public FloatKeyLongMapToMapAdapter(FloatKeyLongMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultFloatHashFunction.INSTANCE.hash(key.floatValue()) ^ DefaultLongHashFunction.INSTANCE.hash(value.longValue()); }
