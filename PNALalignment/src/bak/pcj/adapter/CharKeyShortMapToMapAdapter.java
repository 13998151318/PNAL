 ...
 *  @since      1.0
 */
public class CharKeyShortMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected CharKeyShortMap map;
     ...
     */
    public CharKeyShortMapToMapAdapter(CharKeyShortMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultCharHashFunction.INSTANCE.hash(key.charValue()) ^ DefaultShortHashFunction.INSTANCE.hash(value.shortValue()); }
