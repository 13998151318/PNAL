 ...
 *  @since      1.0
 */
public class DoubleKeyIntMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected DoubleKeyIntMap map;
     ...
     */
    public DoubleKeyIntMapToMapAdapter(DoubleKeyIntMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultDoubleHashFunction.INSTANCE.hash(key.doubleValue()) ^ DefaultIntHashFunction.INSTANCE.hash(value.intValue()); }
