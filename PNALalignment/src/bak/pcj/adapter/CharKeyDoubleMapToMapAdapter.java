 ...
 *  @since      1.0
 */
public class CharKeyDoubleMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected CharKeyDoubleMap map;
     ...
     */
    public CharKeyDoubleMapToMapAdapter(CharKeyDoubleMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                CharKeyDoubleMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultCharHashFunction.INSTANCE.hash(key.charValue()) ^ DefaultDoubleHashFunction.INSTANCE.hash(value.doubleValue()); }
