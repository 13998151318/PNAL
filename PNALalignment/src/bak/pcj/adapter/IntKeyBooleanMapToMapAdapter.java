 ...
 *  @since      1.0
 */
public class IntKeyBooleanMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected IntKeyBooleanMap map;

    /**
     *  Creates a new adaption of a primitive map of int
     ...
     */
    public IntKeyBooleanMapToMapAdapter(IntKeyBooleanMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
     ...
     *              if <tt>key</tt> is not of class {@link Integer Integer}.
     */
    ...
    { return map.containsKey(((Integer)key).intValue()); }
     ...
     *  if the returned set is of class {@link Integer Integer}.
     *
     *  @return     a set view of the keys of this map.
     */
    public Set keySet() {
        return new IntSetToSetAdapter(map.keySet());
    }
     ...
     *
     *  @throws     ClassCastException
     *              if a key in <tt>map</tt> is not of class {@link Integer Integer};
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                IntKeyBooleanMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultIntHashFunction.INSTANCE.hash(key.intValue()) ^ DefaultBooleanHashFunction.INSTANCE.hash(value.booleanValue()); }
