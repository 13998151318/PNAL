 ...
 *  @since      1.1
 */
public class ObjectKeyBooleanMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected ObjectKeyBooleanMap map;
     ...
     */
    public ObjectKeyBooleanMapToMapAdapter(ObjectKeyBooleanMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return (key == null ? 0 : key.hashCode()) ^ DefaultBooleanHashFunction.INSTANCE.hash(value.booleanValue()); }
