 ...
 *  @since      1.0
 */
public class IntKeyByteMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected IntKeyByteMap map;
     ...
     */
    public IntKeyByteMapToMapAdapter(IntKeyByteMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                IntKeyByteMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultIntHashFunction.INSTANCE.hash(key.intValue()) ^ DefaultByteHashFunction.INSTANCE.hash(value.byteValue()); }
