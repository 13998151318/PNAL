 ...
 *  @since      1.0
 */
public class DoubleKeyCharMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected DoubleKeyCharMap map;

    /**
     *  Creates a new adaption of a primitive map of double
     ...
     */
    public DoubleKeyCharMapToMapAdapter(DoubleKeyCharMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
     ...
     *              if <tt>key</tt> is not of class {@link Double Double}.
     */
    ...
    { return map.containsKey(((Double)key).doubleValue()); }
     ...
     *  if the returned set is of class {@link Double Double}.
     *
     *  @return     a set view of the keys of this map.
     */
    public Set keySet() {
        return new DoubleSetToSetAdapter(map.keySet());
    }
     ...
     *
     *  @throws     ClassCastException
     *              if a key in <tt>map</tt> is not of class {@link Double Double};
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultDoubleHashFunction.INSTANCE.hash(key.doubleValue()) ^ DefaultCharHashFunction.INSTANCE.hash(value.charValue()); }
