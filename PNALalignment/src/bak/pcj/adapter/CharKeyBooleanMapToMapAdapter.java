 ...
 *  @since      1.0
 */
public class CharKeyBooleanMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected CharKeyBooleanMap map;
     ...
     */
    public CharKeyBooleanMapToMapAdapter(CharKeyBooleanMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                CharKeyBooleanMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultCharHashFunction.INSTANCE.hash(key.charValue()) ^ DefaultBooleanHashFunction.INSTANCE.hash(value.booleanValue()); }
