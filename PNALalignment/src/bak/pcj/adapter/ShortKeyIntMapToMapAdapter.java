 ...
 *  @since      1.0
 */
public class ShortKeyIntMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected ShortKeyIntMap map;
     ...
     */
    public ShortKeyIntMapToMapAdapter(ShortKeyIntMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                ShortKeyIntMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultShortHashFunction.INSTANCE.hash(key.shortValue()) ^ DefaultIntHashFunction.INSTANCE.hash(value.intValue()); }
