 ...
 *  @since      1.0
 */
public class MapToLongKeyCharMapAdapter extends AbstractLongKeyCharMap implements LongKeyCharMap {
    ...
    public boolean containsKey(long key) {
        lastValue = (Character)map.get(new Long(key));
    ...
    public char get(long key) {
        Character value = (Character)map.get(new Long(key));
    ...
    public char put(long key, char value) {
        Character oldValue = (Character)map.put(new Long(key), new Character(value));
        return oldValue == null ? MapDefaults.defaultChar() : oldValue.charValue();
    }

    public char remove(long key) {
        Character value = (Character)map.remove(new Long(key));
        return value == null ? MapDefaults.defaultChar() : value.charValue();
    }
    ...
    { return Adapter.isLongKeyCharAdaptable(map); }
