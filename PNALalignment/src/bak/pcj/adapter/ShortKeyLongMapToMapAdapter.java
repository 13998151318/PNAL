 ...
 *  @since      1.0
 */
public class ShortKeyLongMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected ShortKeyLongMap map;
     ...
     */
    public ShortKeyLongMapToMapAdapter(ShortKeyLongMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultShortHashFunction.INSTANCE.hash(key.shortValue()) ^ DefaultLongHashFunction.INSTANCE.hash(value.longValue()); }
