 ...
 *  @since      1.0
 */
public class MapToIntKeyMapAdapter extends AbstractIntKeyMap implements IntKeyMap {
     ...
     */
    public MapToIntKeyMapAdapter(Map map) {
        this(map, false);
    }
     ...
     */
    public MapToIntKeyMapAdapter(Map map, boolean validate) {
        if (map == null)
    ...
    public boolean containsKey(int key) {
        return map.get(new Integer(key)) != null;
    }
    ...
    public Object put(int key, Object value) {
        return map.put(new Integer(key), value);
    }

    public Object remove(int key) {
        return map.remove(new Integer(key));
    }
     ...
     *  can only contain {@link Integer Integer} keys and no <tt>null</tt>
     *  keys.
     *
    ...
    { return Adapter.isIntKeyAdaptable(map); }
