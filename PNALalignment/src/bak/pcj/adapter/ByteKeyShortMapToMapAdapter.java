 ...
 *  @since      1.0
 */
public class ByteKeyShortMapToMapAdapter implements Map {
     ...
     */
    public ByteKeyShortMapToMapAdapter(ByteKeyShortMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultByteHashFunction.INSTANCE.hash(key.byteValue()) ^ DefaultShortHashFunction.INSTANCE.hash(value.shortValue()); }
