 ...
 *  @since      1.0
 */
public class FloatKeyByteMapToMapAdapter implements Map {
     ...
     */
    public FloatKeyByteMapToMapAdapter(FloatKeyByteMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultFloatHashFunction.INSTANCE.hash(key.floatValue()) ^ DefaultByteHashFunction.INSTANCE.hash(value.byteValue()); }
