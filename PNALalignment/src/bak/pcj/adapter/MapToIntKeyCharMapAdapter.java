...
public class MapToIntKeyCharMapAdapter extends AbstractIntKeyCharMap implements IntKeyCharMap {
     ...
     */
    public MapToIntKeyCharMapAdapter(Map map, boolean validate) {
        if (map == null)
            Exceptions.nullArgument("map");
        this.map = map;
        lastValue = null;
    ...
    public boolean containsKey(int key) {
        lastValue = (Character)map.get(new Integer(key));
    ...
    public char get(int key) {
        Character value = (Character)map.get(new Integer(key));
    ...
    public char put(int key, char value) {
        Character oldValue = (Character)map.put(new Integer(key), new Character(value));
        return oldValue == null ? MapDefaults.defaultChar() : oldValue.charValue();
    }

    public char remove(int key) {
        Character value = (Character)map.remove(new Integer(key));
        return value == null ? MapDefaults.defaultChar() : value.charValue();
    }
    ...
    { return Adapter.isIntKeyCharAdaptable(map); }
