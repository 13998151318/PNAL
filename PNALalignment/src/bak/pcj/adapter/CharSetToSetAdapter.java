 ...
 *  @since      1.0
 */
public class CharSetToSetAdapter extends AbstractSet {
    ...
    public boolean add(Object o) {
        ...
        return set.add(((Character)o).charValue());
    }
    ...
    public boolean contains(Object o) {
        try {
            return set.contains( ((Character)o).charValue() );
    ...
    { return new CharIteratorToIteratorAdapter(set.iterator()); }
     ...
     *
     *  @param      o
     *              the Character value to remove from this set.
     *
     *  @return     <tt>true</tt> if this set was modified
    ...
    public boolean remove(Object o) {
        try {
            return set.remove( ((Character)o).charValue() );
        } catch (ClassCastException cce) {
        } catch (NullPointerException npe) {
        }
        return false;
