 ...
 *  @since      1.0
 */
public class LongKeyShortMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected LongKeyShortMap map;
     ...
     */
    public LongKeyShortMapToMapAdapter(LongKeyShortMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultLongHashFunction.INSTANCE.hash(key.longValue()) ^ DefaultShortHashFunction.INSTANCE.hash(value.shortValue()); }
