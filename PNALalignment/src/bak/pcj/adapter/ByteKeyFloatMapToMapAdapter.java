...
import bak.pcj.map.ByteKeyFloatMapIterator;
 ...
 *  @since      1.0
 */
public class ByteKeyFloatMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected ByteKeyFloatMap map;
     ...
     */
    public ByteKeyFloatMapToMapAdapter(ByteKeyFloatMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                ByteKeyFloatMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultByteHashFunction.INSTANCE.hash(key.byteValue()) ^ DefaultFloatHashFunction.INSTANCE.hash(value.floatValue()); }
