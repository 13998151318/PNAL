 ...
 *  @since      1.0
 */
public class CharKeyFloatMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected CharKeyFloatMap map;
     ...
     */
    public CharKeyFloatMapToMapAdapter(CharKeyFloatMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                CharKeyFloatMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultCharHashFunction.INSTANCE.hash(key.charValue()) ^ DefaultFloatHashFunction.INSTANCE.hash(value.floatValue()); }
