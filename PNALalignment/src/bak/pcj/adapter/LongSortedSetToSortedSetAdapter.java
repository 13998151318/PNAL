...
/**
 *  This class represents adapters of long sets to Java Collections
...
public class LongSortedSetToSortedSetAdapter extends LongSetToSetAdapter implements SortedSet {
    ...
    /**
     *  Creates a new adaption of a set of long
     ...
     */
    public LongSortedSetToSortedSetAdapter(LongSortedSet set) {
        super(set);
    }
     ...
     */
    public Object first() 
    { return new Long(((LongSortedSet)set).first()); }
     ...
     *              if <tt>to</tt> is not of class {@link Long Long}.
     *
     *  @throws     NullPointerException
     *              if <tt>to</tt> is <tt>null</tt>.
     */
    public SortedSet headSet(Object to) 
    { return new LongSortedSetToSortedSetAdapter(((LongSortedSet)set).headSet( ((Long)to).longValue() )); }
     ...
     */    
    public Object last() 
    { return new Long(((LongSortedSet)set).last()); }
     ...
     *
     *  @throws     ClassCastException
     *              if <tt>from</tt> is not of class {@link Long Long};
     *              if <tt>to</tt> is not of class {@link Long Long}.
     *
     *  @throws     NullPointerException
    ...
    public SortedSet subSet(Object from, Object to) {
        long tfrom = ((Long)from).longValue();
        long tto = ((Long)to).longValue();
        return new LongSortedSetToSortedSetAdapter(((LongSortedSet)set).subSet(tfrom, tto));
    }
    ...
    { return new LongSortedSetToSortedSetAdapter(((LongSortedSet)set).tailSet( ((Long)from).longValue() )); }
