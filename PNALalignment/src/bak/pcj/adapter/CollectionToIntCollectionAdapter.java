 ...
 *  @since      1.0
 */
public class CollectionToIntCollectionAdapter extends AbstractIntCollection {

    /** The underlying collection. */
    protected Collection collection;

    /**
     *  Creates a new adaption of a collection to a collection of int
     *  values.
     *
     *  @param      collection
    ...
    { return collection.add(new Integer(v)); }

    public void clear()
    { collection.clear(); }

    public boolean contains(int v)
    { return collection.contains(new Integer(v)); }

    public int hashCode()
    { return collection.hashCode(); }

    public IntIterator iterator()
    { return new IteratorToIntIteratorAdapter(collection.iterator()); }

    public boolean remove(int v)
    { return collection.remove(new Integer(v)); }
    ...
    { return Adapter.isIntAdaptable(collection); }
