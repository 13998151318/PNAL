 ...
 *  @since      1.0
 */
public class MapToCharKeyIntMapAdapter extends AbstractCharKeyIntMap implements CharKeyIntMap {
    ...
    public boolean containsKey(char key) {
        lastValue = (Integer)map.get(new Character(key));
    ...
    public int get(char key) {
        Integer value = (Integer)map.get(new Character(key));
    ...
    public int put(char key, int value) {
        Integer oldValue = (Integer)map.put(new Character(key), new Integer(value));
        return oldValue == null ? MapDefaults.defaultInt() : oldValue.intValue();
    }

    public int remove(char key) {
        Integer value = (Integer)map.remove(new Character(key));
        return value == null ? MapDefaults.defaultInt() : value.intValue();
    }
    ...
    { return Adapter.isCharKeyIntAdaptable(map); }
