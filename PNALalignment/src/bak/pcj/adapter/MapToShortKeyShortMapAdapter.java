 ...
 *  in the client code:
 *  <pre>
 *      MapToShortKeyShortMapAdapter s;
 *      ...
 ...
 *  @since      1.0
 */
public class MapToShortKeyShortMapAdapter extends AbstractShortKeyShortMap implements ShortKeyShortMap {
    ...
    public boolean containsKey(short key) {
        lastValue = (Short)map.get(new Short(key));
    ...
    public short get(short key) {
        Short value = (Short)map.get(new Short(key));
    ...
    public short put(short key, short value) {
        Short oldValue = (Short)map.put(new Short(key), new Short(value));
        return oldValue == null ? MapDefaults.defaultShort() : oldValue.shortValue();
    }

    public short remove(short key) {
        Short value = (Short)map.remove(new Short(key));
        return value == null ? MapDefaults.defaultShort() : value.shortValue();
    }
    ...
    { return Adapter.isShortKeyShortAdaptable(map); }
