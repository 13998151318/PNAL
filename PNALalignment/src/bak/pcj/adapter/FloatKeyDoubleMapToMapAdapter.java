 ...
 *  @since      1.0
 */
public class FloatKeyDoubleMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected FloatKeyDoubleMap map;

    /**
     *  Creates a new adaption of a primitive map of float
     *  keys and double values to a Java Collections Framework map.
     *
     *  @param      map
     *              the underlying primitive map.
     *
     ...
     */
    public FloatKeyDoubleMapToMapAdapter(FloatKeyDoubleMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
     ...
     *              if <tt>key</tt> is not of class {@link Float Float}.
     */
    ...
    { return map.containsKey(((Float)key).floatValue()); }
     ...
     *  values or values of other classes than {@link Double Double}.
    ...
    public boolean containsValue(Object value) {
        if (value == null)
            return false;
        return map.containsValue(((Double)value).doubleValue());
    }
     ...
     *  The returned value will always be of class {@link Double Double}.
     *
     *  @param      key
    ...
    public Object get(Object key) throws NullPointerException, ClassCastException /* Exceptions marked to work around bug in Javadoc 1.3 */ {
        ...
        double v = map.get(k);
        if (v == MapDefaults.defaultDouble())
     ...
     *  if the returned set is of class {@link Float Float}.
     *
     *  @return     a set view of the keys of this map.
     */
    public Set keySet() {
        return new FloatSetToSetAdapter(map.keySet());
    }
     ...
     *  @throws     ClassCastException
     *              if <tt>key</tt> is not of class {@link Float Float};
     *              if <tt>value</tt> is not of class {@link Double Double}.
     */
    public Object put(Object key, Object value) throws NullPointerException, ClassCastException /* Exception marked to work around bug in Javadoc 1.3 */ {
        ...
        float k = ((Float)key).floatValue();
        map.put(k, ((Double)value).doubleValue());
        return result;
    }
     ...
     *
     *  @throws     ClassCastException
     *              if a key in <tt>map</tt> is not of class {@link Float Float};
     *              if a value in <tt>value</tt> is not of class {@link Double Double}.
     */
     ...
     *  in the returned set is of class {@link Double Double}.
     *
     *  @return     a collection view of the values in this map.
     */
    public Collection values() {
        return new DoubleCollectionToCollectionAdapter(map.values());
    }
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                FloatKeyDoubleMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultFloatHashFunction.INSTANCE.hash(key.floatValue()) ^ DefaultDoubleHashFunction.INSTANCE.hash(value.doubleValue()); }
