 ...
 *  @since      1.0
 */
public class DoubleKeyFloatMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected DoubleKeyFloatMap map;
     ...
     */
    public DoubleKeyFloatMapToMapAdapter(DoubleKeyFloatMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultDoubleHashFunction.INSTANCE.hash(key.doubleValue()) ^ DefaultFloatHashFunction.INSTANCE.hash(value.floatValue()); }
