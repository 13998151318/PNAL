 ...
 *  @since      1.0
 */
public class DoubleKeyDoubleMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected DoubleKeyDoubleMap map;
     ...
     */
    public DoubleKeyDoubleMapToMapAdapter(DoubleKeyDoubleMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultDoubleHashFunction.INSTANCE.hash(key.doubleValue()) ^ DefaultDoubleHashFunction.INSTANCE.hash(value.doubleValue()); }
