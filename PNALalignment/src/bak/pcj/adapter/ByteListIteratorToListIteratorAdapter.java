 ...
 *  @since      1.0
 */
public class ByteListIteratorToListIteratorAdapter implements ListIterator {

    /** The underlying primitive iterator. */
    protected ByteListIterator iterator;

    /**
     *  Creates a new adaption of a primitive list iterator over
     *  byte values to a Java Collections Framework list iterator.
     *
     *  @param      iterator
     ...
     */
    public ByteListIteratorToListIteratorAdapter(ByteListIterator iterator) {
        if (iterator == null)
    ...
    { return new Byte(iterator.previous()); }
