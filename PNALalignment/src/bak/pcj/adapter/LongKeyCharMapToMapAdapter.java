 ...
 *  @since      1.0
 */
public class LongKeyCharMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected LongKeyCharMap map;
     ...
     */
    public LongKeyCharMapToMapAdapter(LongKeyCharMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultLongHashFunction.INSTANCE.hash(key.longValue()) ^ DefaultCharHashFunction.INSTANCE.hash(value.charValue()); }
