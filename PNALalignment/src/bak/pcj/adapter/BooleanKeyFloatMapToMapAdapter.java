 ...
 *  @since      1.0
 */
public class BooleanKeyFloatMapToMapAdapter implements Map {
     ...
     *  keys and float values to a Java Collections Framework map.
     *
     *  @param      map
     *              the underlying primitive map.
     *
     ...
     */
    public BooleanKeyFloatMapToMapAdapter(BooleanKeyFloatMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
     ...
     *  values or values of other classes than {@link Float Float}.
    ...
    public boolean containsValue(Object value) {
        if (value == null)
            return false;
        return map.containsValue(((Float)value).floatValue());
    }
     ...
     *  The returned value will always be of class {@link Float Float}.
     *
     *  @param      key
     ...
     *  @throws     ClassCastException
     *              if <tt>key</tt> is not of class {@link Boolean Boolean};
     *              if <tt>value</tt> is not of class {@link Float Float}.
     */
    public Object put(Object key, Object value) throws NullPointerException, ClassCastException /* Exception marked to work around bug in Javadoc 1.3 */ {
        ...
        boolean k = ((Boolean)key).booleanValue();
        map.put(k, ((Float)value).floatValue());
        return result;
    }
     ...
     *              if a value in <tt>value</tt> is not of class {@link Float Float}.
     */
     ...
     *  in the returned set is of class {@link Float Float}.
     *
     *  @return     a collection view of the values in this map.
     */
    public Collection values() {
        return new FloatCollectionToCollectionAdapter(map.values());
    }
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                BooleanKeyFloatMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultBooleanHashFunction.INSTANCE.hash(key.booleanValue()) ^ DefaultFloatHashFunction.INSTANCE.hash(value.floatValue()); }
