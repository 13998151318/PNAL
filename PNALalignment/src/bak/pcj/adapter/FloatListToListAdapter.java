 ...
 *  @since      1.0
 */
public class FloatListToListAdapter extends AbstractList {
    ...
    public void add(int index, Object o) {
        ...
        list.add(index, ((Float)o).floatValue() );
    }
    ...
    { return new FloatListIteratorToListIteratorAdapter(list.listIterator(index)); }
    ...
    { return new Float(list.removeElementAt(index)); }
    ...
    public Object set(int index, Object o) {
        if (o == null)
            Exceptions.nullElementNotAllowed();
        return new Float(list.set(index, ((Float)o).floatValue()));
    }
