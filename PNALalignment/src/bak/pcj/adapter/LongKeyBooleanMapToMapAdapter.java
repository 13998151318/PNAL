 ...
 *  @since      1.0
 */
public class LongKeyBooleanMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected LongKeyBooleanMap map;

    /**
     *  Creates a new adaption of a primitive map of long
     ...
     */
    public LongKeyBooleanMapToMapAdapter(LongKeyBooleanMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
     ...
     *              if <tt>key</tt> is not of class {@link Long Long}.
     */
    ...
    { return map.containsKey(((Long)key).longValue()); }
     ...
     *  if the returned set is of class {@link Long Long}.
     *
     *  @return     a set view of the keys of this map.
     */
    public Set keySet() {
        return new LongSetToSetAdapter(map.keySet());
    }
     ...
     *
     *  @throws     ClassCastException
     *              if a key in <tt>map</tt> is not of class {@link Long Long};
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultLongHashFunction.INSTANCE.hash(key.longValue()) ^ DefaultBooleanHashFunction.INSTANCE.hash(value.booleanValue()); }
