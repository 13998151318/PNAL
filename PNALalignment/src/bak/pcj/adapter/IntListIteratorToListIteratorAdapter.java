 ...
 *  @since      1.0
 */
public class IntListIteratorToListIteratorAdapter implements ListIterator {
     ...
     *  int values to a Java Collections Framework list iterator.
     *
     *  @param      iterator
    ...
    { iterator.add( ((Integer)o).intValue() ); }
    ...
    { return new Integer(iterator.previous()); }
    ...
    { iterator.set(((Integer)o).intValue()); }
