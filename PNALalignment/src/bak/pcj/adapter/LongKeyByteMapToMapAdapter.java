 ...
 *  @since      1.0
 */
public class LongKeyByteMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected LongKeyByteMap map;
     ...
     */
    public LongKeyByteMapToMapAdapter(LongKeyByteMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultLongHashFunction.INSTANCE.hash(key.longValue()) ^ DefaultByteHashFunction.INSTANCE.hash(value.byteValue()); }
