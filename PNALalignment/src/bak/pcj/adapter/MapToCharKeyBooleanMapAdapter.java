 ...
 *  in the client code:
 *  <pre>
 *      MapToCharKeyBooleanMapAdapter s;
 *      ...
 ...
 *  @since      1.0
 */
public class MapToCharKeyBooleanMapAdapter extends AbstractCharKeyBooleanMap implements CharKeyBooleanMap {
    ...
    public boolean containsKey(char key) {
        lastValue = (Boolean)map.get(new Character(key));
    ...
    public boolean get(char key) {
        Boolean value = (Boolean)map.get(new Character(key));
    ...
    public boolean put(char key, boolean value) {
        Boolean oldValue = (Boolean)map.put(new Character(key), new Boolean(value));
        return oldValue == null ? MapDefaults.defaultBoolean() : oldValue.booleanValue();
    }

    public boolean remove(char key) {
        Boolean value = (Boolean)map.remove(new Character(key));
        return value == null ? MapDefaults.defaultBoolean() : value.booleanValue();
    }
    ...
    { return Adapter.isCharKeyBooleanAdaptable(map); }
