 ...
 *  @since      1.0
 */
public class FloatListIteratorToListIteratorAdapter implements ListIterator {

    /** The underlying primitive iterator. */
    protected FloatListIterator iterator;

    /**
     *  Creates a new adaption of a primitive list iterator over
     *  float values to a Java Collections Framework list iterator.
     *
     *  @param      iterator
     ...
     */
    public FloatListIteratorToListIteratorAdapter(FloatListIterator iterator) {
        if (iterator == null)
    ...
    { iterator.add( ((Float)o).floatValue() ); }
     ...
     */
    public Object next()
    { return new Float(iterator.next()); }
    ...
    { return new Float(iterator.previous()); }
    ...
    { iterator.set(((Float)o).floatValue()); }
