...
/**
 *  This class represents adapters of char sets to Java Collections
...
public class CharSortedSetToSortedSetAdapter extends CharSetToSetAdapter implements SortedSet {
    ...
    /**
     *  Creates a new adaption of a set of char
     ...
     */
    public CharSortedSetToSortedSetAdapter(CharSortedSet set) {
        super(set);
    }
     ...
     */
    public Object first() 
    { return new Character(((CharSortedSet)set).first()); }
     ...
     *              if <tt>to</tt> is not of class {@link Character Character}.
     *
     *  @throws     NullPointerException
     *              if <tt>to</tt> is <tt>null</tt>.
     */
    public SortedSet headSet(Object to) 
    { return new CharSortedSetToSortedSetAdapter(((CharSortedSet)set).headSet( ((Character)to).charValue() )); }
     ...
     */    
    public Object last() 
    { return new Character(((CharSortedSet)set).last()); }
     ...
     *
     *  @throws     ClassCastException
     *              if <tt>from</tt> is not of class {@link Character Character};
     *              if <tt>to</tt> is not of class {@link Character Character}.
     *
     *  @throws     NullPointerException
    ...
    public SortedSet subSet(Object from, Object to) {
        char tfrom = ((Character)from).charValue();
        char tto = ((Character)to).charValue();
        return new CharSortedSetToSortedSetAdapter(((CharSortedSet)set).subSet(tfrom, tto));
    }
    ...
    { return new CharSortedSetToSortedSetAdapter(((CharSortedSet)set).tailSet( ((Character)from).charValue() )); }
