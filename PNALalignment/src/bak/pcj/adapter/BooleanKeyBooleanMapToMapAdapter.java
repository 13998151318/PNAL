 ...
 *  @since      1.0
 */
public class BooleanKeyBooleanMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected BooleanKeyBooleanMap map;

    /**
     *  Creates a new adaption of a primitive map of boolean
     *  keys and boolean values to a Java Collections Framework map.
     *
     *  @param      map
     *              the underlying primitive map.
     *
     ...
     */
    public BooleanKeyBooleanMapToMapAdapter(BooleanKeyBooleanMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
     ...
     *              if <tt>key</tt> is not of class {@link Boolean Boolean}.
     */
    ...
    { return map.containsKey(((Boolean)key).booleanValue()); }
     ...
     *  values or values of other classes than {@link Boolean Boolean}.
    ...
    public boolean containsValue(Object value) {
        if (value == null)
            return false;
        return map.containsValue(((Boolean)value).booleanValue());
    }
     ...
     *  The returned value will always be of class {@link Boolean Boolean}.
     *
     *  @param      key
    ...
    public Object get(Object key) throws NullPointerException, ClassCastException /* Exceptions marked to work around bug in Javadoc 1.3 */ {
        ...
        boolean v = map.get(k);
        if (v == MapDefaults.defaultBoolean())
     ...
     *  if the returned set is of class {@link Boolean Boolean}.
     *
     *  @return     a set view of the keys of this map.
     */
    public Set keySet() {
        return new BooleanSetToSetAdapter(map.keySet());
    }
     ...
     *  @throws     ClassCastException
     *              if <tt>key</tt> is not of class {@link Boolean Boolean};
     *              if <tt>value</tt> is not of class {@link Boolean Boolean}.
     */
    public Object put(Object key, Object value) throws NullPointerException, ClassCastException /* Exception marked to work around bug in Javadoc 1.3 */ {
        ...
        boolean k = ((Boolean)key).booleanValue();
        map.put(k, ((Boolean)value).booleanValue());
        return result;
    }
     ...
     *
     *  @throws     ClassCastException
     *              if a key in <tt>map</tt> is not of class {@link Boolean Boolean};
     *              if a value in <tt>value</tt> is not of class {@link Boolean Boolean}.
     */
     ...
     *  in the returned set is of class {@link Boolean Boolean}.
     *
     *  @return     a collection view of the values in this map.
     */
    public Collection values() {
        return new BooleanCollectionToCollectionAdapter(map.values());
    }
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                BooleanKeyBooleanMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        Entry(boolean key, boolean value) {
        ...
        public int hashCode()
        { return DefaultBooleanHashFunction.INSTANCE.hash(key.booleanValue()) ^ DefaultBooleanHashFunction.INSTANCE.hash(value.booleanValue()); }
