 ...
 *  @since      1.0
 */
public class IntSetToSetAdapter extends AbstractSet {
    ...
    public boolean add(Object o) {
        ...
        return set.add(((Integer)o).intValue());
    }
    ...
    public boolean contains(Object o) {
        try {
            return set.contains( ((Integer)o).intValue() );
    ...
    { return new IntIteratorToIteratorAdapter(set.iterator()); }
    ...
    public boolean remove(Object o) {
        try {
            return set.remove( ((Integer)o).intValue() );
        } catch (ClassCastException cce) {
        } catch (NullPointerException npe) {
        }
        return false;
