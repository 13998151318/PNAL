...
public class CollectionToDoubleCollectionAdapter extends AbstractDoubleCollection {
    ...
    /**
     *  Creates a new adaption of a collection to a collection of double
     *  values.
     *
     *  @param      collection
    ...
    { return collection.add(new Double(v)); }

    public void clear()
    { collection.clear(); }

    public boolean contains(double v)
    { return collection.contains(new Double(v)); }

    public int hashCode()
    { return collection.hashCode(); }

    public DoubleIterator iterator()
    { return new IteratorToDoubleIteratorAdapter(collection.iterator()); }

    public boolean remove(double v)
    { return collection.remove(new Double(v)); }
    ...
    { return Adapter.isDoubleAdaptable(collection); }
