 ...
 *  @since      1.0
 */
public class ByteKeyMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected ByteKeyMap map;
     ...
     */
    public ByteKeyMapToMapAdapter(ByteKeyMap map) {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultByteHashFunction.INSTANCE.hash(key.byteValue()) ^ value.hashCode(); }
