 ...
 *  @since      1.1
 */
public class ObjectKeyLongMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected ObjectKeyLongMap map;
     ...
     */
    public ObjectKeyLongMapToMapAdapter(ObjectKeyLongMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    public Object put(Object key, Object value) throws NullPointerException, ClassCastException /* Exception marked to work around bug in Javadoc 1.3 */ {
        ...
        map.put(key, ((Long)value).longValue());
        return result;
    }
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return (key == null ? 0 : key.hashCode()) ^ DefaultLongHashFunction.INSTANCE.hash(value.longValue()); }
