 ...
 *  @since      1.0
 */
public class LongKeyDoubleMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected LongKeyDoubleMap map;
     ...
     */
    public LongKeyDoubleMapToMapAdapter(LongKeyDoubleMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultLongHashFunction.INSTANCE.hash(key.longValue()) ^ DefaultDoubleHashFunction.INSTANCE.hash(value.doubleValue()); }
