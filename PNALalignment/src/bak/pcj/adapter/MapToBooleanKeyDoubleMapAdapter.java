 ...
 *  in the client code:
 *  <pre>
 *      MapToBooleanKeyDoubleMapAdapter s;
 *      ...
 ...
 *  @since      1.0
 */
public class MapToBooleanKeyDoubleMapAdapter extends AbstractBooleanKeyDoubleMap implements BooleanKeyDoubleMap {
    ...
    public boolean containsKey(boolean key) {
        lastValue = (Double)map.get(new Boolean(key));
    ...
    public double get(boolean key) {
        Double value = (Double)map.get(new Boolean(key));
    ...
    public double put(boolean key, double value) {
        Double oldValue = (Double)map.put(new Boolean(key), new Double(value));
        return oldValue == null ? MapDefaults.defaultDouble() : oldValue.doubleValue();
    }

    public double remove(boolean key) {
        Double value = (Double)map.remove(new Boolean(key));
        return value == null ? MapDefaults.defaultDouble() : value.doubleValue();
    }
    ...
    { return Adapter.isBooleanKeyDoubleAdaptable(map); }
