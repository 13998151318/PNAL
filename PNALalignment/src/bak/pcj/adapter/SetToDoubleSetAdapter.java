...
public class SetToDoubleSetAdapter extends AbstractDoubleSet implements DoubleSet {
    ...
    { return set.add(new Double(v)); }

    public void clear()
    { set.clear(); }

    public boolean contains(double v)
    { return set.contains(new Double(v)); }

    public int hashCode()
    { return set.hashCode(); }

    public DoubleIterator iterator()
    { return new IteratorToDoubleIteratorAdapter(set.iterator()); }

    public boolean remove(double v)
    { return set.remove(new Double(v)); }
    ...
    { return Adapter.isDoubleAdaptable(set); }
