 ...
 *  @since      1.0
 */
public class ShortKeyCharMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected ShortKeyCharMap map;

    /**
     *  Creates a new adaption of a primitive map of short
     ...
     */
    public ShortKeyCharMapToMapAdapter(ShortKeyCharMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
     ...
     *              if <tt>key</tt> is not of class {@link Short Short}.
     */
    ...
    { return map.containsKey(((Short)key).shortValue()); }
     ...
     *  if the returned set is of class {@link Short Short}.
     *
     *  @return     a set view of the keys of this map.
     */
    public Set keySet() {
        return new ShortSetToSetAdapter(map.keySet());
    }
     ...
     *
     *  @throws     ClassCastException
     *              if a key in <tt>map</tt> is not of class {@link Short Short};
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                ShortKeyCharMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultShortHashFunction.INSTANCE.hash(key.shortValue()) ^ DefaultCharHashFunction.INSTANCE.hash(value.charValue()); }
