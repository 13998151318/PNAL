 ...
 *  @since      1.0
 */
public class ShortListIteratorToListIteratorAdapter implements ListIterator {

    /** The underlying primitive iterator. */
    protected ShortListIterator iterator;

    /**
     *  Creates a new adaption of a primitive list iterator over
     *  short values to a Java Collections Framework list iterator.
     *
     *  @param      iterator
     ...
     */
    public ShortListIteratorToListIteratorAdapter(ShortListIterator iterator) {
        if (iterator == null)
    ...
    { iterator.add( ((Short)o).shortValue() ); }
    ...
    { return new Short(iterator.previous()); }
    ...
    { iterator.set(((Short)o).shortValue()); }
