 ...
 *  @since      1.0
 */
public class ByteKeyDoubleMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected ByteKeyDoubleMap map;
     ...
     */
    public ByteKeyDoubleMapToMapAdapter(ByteKeyDoubleMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                ByteKeyDoubleMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultByteHashFunction.INSTANCE.hash(key.byteValue()) ^ DefaultDoubleHashFunction.INSTANCE.hash(value.doubleValue()); }
