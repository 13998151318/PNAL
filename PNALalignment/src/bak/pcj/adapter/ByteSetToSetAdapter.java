 ...
 *  @since      1.0
 */
public class ByteSetToSetAdapter extends AbstractSet {
    ...
    public boolean add(Object o) {
        ...
        return set.add(((Byte)o).byteValue());
    }
    ...
    public boolean contains(Object o) {
        try {
            return set.contains( ((Byte)o).byteValue() );
    ...
    { return new ByteIteratorToIteratorAdapter(set.iterator()); }
     ...
     *
     *  @param      o
     *              the Byte value to remove from this set.
     *
     *  @return     <tt>true</tt> if this set was modified
    ...
    public boolean remove(Object o) {
        try {
            return set.remove( ((Byte)o).byteValue() );
        } catch (ClassCastException cce) {
        } catch (NullPointerException npe) {
        }
        return false;
