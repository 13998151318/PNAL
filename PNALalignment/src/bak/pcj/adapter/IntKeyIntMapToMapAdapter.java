 ...
 *  @since      1.0
 */
public class IntKeyIntMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected IntKeyIntMap map;
     ...
     */
    public IntKeyIntMapToMapAdapter(IntKeyIntMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultIntHashFunction.INSTANCE.hash(key.intValue()) ^ DefaultIntHashFunction.INSTANCE.hash(value.intValue()); }
