 ...
 *  @since      1.0
 */
public class ShortKeyDoubleMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected ShortKeyDoubleMap map;
     ...
     */
    public ShortKeyDoubleMapToMapAdapter(ShortKeyDoubleMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultShortHashFunction.INSTANCE.hash(key.shortValue()) ^ DefaultDoubleHashFunction.INSTANCE.hash(value.doubleValue()); }
