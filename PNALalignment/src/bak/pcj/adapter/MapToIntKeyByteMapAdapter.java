 ...
 *  @since      1.0
 */
public class MapToIntKeyByteMapAdapter extends AbstractIntKeyByteMap implements IntKeyByteMap {
    ...
    public boolean containsKey(int key) {
        lastValue = (Byte)map.get(new Integer(key));
    ...
    public byte get(int key) {
        Byte value = (Byte)map.get(new Integer(key));
    ...
    public byte put(int key, byte value) {
        Byte oldValue = (Byte)map.put(new Integer(key), new Byte(value));
        return oldValue == null ? MapDefaults.defaultByte() : oldValue.byteValue();
    }

    public byte remove(int key) {
        Byte value = (Byte)map.remove(new Integer(key));
        return value == null ? MapDefaults.defaultByte() : value.byteValue();
    }
    ...
    { return Adapter.isIntKeyByteAdaptable(map); }
