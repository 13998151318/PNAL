...
public class BooleanListToListAdapter extends AbstractList {
    ...
    public void add(int index, Object o) {
        ...
        list.add(index, ((Boolean)o).booleanValue() );
    }
    ...
    { return new BooleanListIteratorToListIteratorAdapter(list.listIterator(index)); }
    ...
    { return new Boolean(list.removeElementAt(index)); }
    ...
    public Object set(int index, Object o) {
        if (o == null)
            Exceptions.nullElementNotAllowed();
        return new Boolean(list.set(index, ((Boolean)o).booleanValue()));
    }
