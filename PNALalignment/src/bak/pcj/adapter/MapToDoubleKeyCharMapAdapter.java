 ...
 *  @since      1.0
 */
public class MapToDoubleKeyCharMapAdapter extends AbstractDoubleKeyCharMap implements DoubleKeyCharMap {
    ...
    public boolean containsKey(double key) {
        lastValue = (Character)map.get(new Double(key));
    ...
    public char get(double key) {
        Character value = (Character)map.get(new Double(key));
    ...
    public char put(double key, char value) {
        Character oldValue = (Character)map.put(new Double(key), new Character(value));
        return oldValue == null ? MapDefaults.defaultChar() : oldValue.charValue();
    }

    public char remove(double key) {
        Character value = (Character)map.remove(new Double(key));
        return value == null ? MapDefaults.defaultChar() : value.charValue();
    }
    ...
    { return Adapter.isDoubleKeyCharAdaptable(map); }
