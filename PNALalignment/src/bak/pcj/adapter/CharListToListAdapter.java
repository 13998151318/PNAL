 ...
 *  @since      1.0
 */
public class CharListToListAdapter extends AbstractList {
     ...
     */
    public CharListToListAdapter(CharList list) {
        if (list == null)
    ...
    public void add(int index, Object o) {
        ...
        list.add(index, ((Character)o).charValue() );
    }
    ...
    { return new Character(list.get(index)); }
    ...
    { return new CharListIteratorToListIteratorAdapter(list.listIterator(index)); }
    ...
    { return new Character(list.removeElementAt(index)); }
    ...
    public Object set(int index, Object o) {
        if (o == null)
            Exceptions.nullElementNotAllowed();
        return new Character(list.set(index, ((Character)o).charValue()));
    }
