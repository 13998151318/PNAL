 ...
 *  @since      1.0
 */
public class CharKeyCharMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected CharKeyCharMap map;
     ...
     */
    public CharKeyCharMapToMapAdapter(CharKeyCharMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                CharKeyCharMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultCharHashFunction.INSTANCE.hash(key.charValue()) ^ DefaultCharHashFunction.INSTANCE.hash(value.charValue()); }
