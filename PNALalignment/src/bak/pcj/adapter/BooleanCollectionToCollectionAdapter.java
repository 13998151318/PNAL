 ...
 *  boolean values to Java Collections Framework collections. The adapter
 ...
 *  @since      1.0
 */
public class BooleanCollectionToCollectionAdapter extends AbstractCollection {

    /** The underlying primitive collection. */
    protected BooleanCollection collection;

    /**
     *  Creates a new adaption of a collection of boolean
     ...
     */
    public BooleanCollectionToCollectionAdapter(BooleanCollection collection) {
        super();
        if (collection == null)
     ...
     *              if <tt>o</tt> is not of class {@link Boolean Boolean}.
     *
    ...
    public boolean add(Object o) {
        ...
        return collection.add(((Boolean)o).booleanValue());
    }
    ...
    public boolean contains(Object o) {
        try {
            return collection.contains(((Boolean)o).booleanValue());
    ...
    { return new BooleanIteratorToIteratorAdapter(collection.iterator()); }
    ...
    public boolean remove(Object o) {
        try {
            return collection.remove(((Boolean)o).booleanValue());
        } catch (ClassCastException cce) {
        } catch (NullPointerException npe) {
        }
        return false;
