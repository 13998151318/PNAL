 ...
 *  @since      1.0
 */
public class DoubleKeyByteMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected DoubleKeyByteMap map;
     ...
     */
    public DoubleKeyByteMapToMapAdapter(DoubleKeyByteMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultDoubleHashFunction.INSTANCE.hash(key.doubleValue()) ^ DefaultByteHashFunction.INSTANCE.hash(value.byteValue()); }
