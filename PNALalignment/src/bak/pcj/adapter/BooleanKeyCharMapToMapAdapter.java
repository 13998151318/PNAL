 ...
 *  @since      1.0
 */
public class BooleanKeyCharMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected BooleanKeyCharMap map;

    /**
     *  Creates a new adaption of a primitive map of boolean
     *  keys and char values to a Java Collections Framework map.
     *
     *  @param      map
     *              the underlying primitive map.
     *
     ...
     */
    public BooleanKeyCharMapToMapAdapter(BooleanKeyCharMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
     ...
     *  values or values of other classes than {@link Character Character}.
    ...
    public boolean containsValue(Object value) {
        if (value == null)
            return false;
        return map.containsValue(((Character)value).charValue());
    }
     ...
     *  The returned value will always be of class {@link Character Character}.
     *
     *  @param      key
     ...
     *  @throws     ClassCastException
     *              if <tt>key</tt> is not of class {@link Boolean Boolean};
     *              if <tt>value</tt> is not of class {@link Character Character}.
     */
    public Object put(Object key, Object value) throws NullPointerException, ClassCastException /* Exception marked to work around bug in Javadoc 1.3 */ {
        ...
        boolean k = ((Boolean)key).booleanValue();
        map.put(k, ((Character)value).charValue());
        return result;
    }
     ...
     *              if a value in <tt>value</tt> is not of class {@link Character Character}.
     */
     ...
     *  in the returned set is of class {@link Character Character}.
     *
     *  @return     a collection view of the values in this map.
     */
    public Collection values() {
        return new CharCollectionToCollectionAdapter(map.values());
    }
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                BooleanKeyCharMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultBooleanHashFunction.INSTANCE.hash(key.booleanValue()) ^ DefaultCharHashFunction.INSTANCE.hash(value.charValue()); }
