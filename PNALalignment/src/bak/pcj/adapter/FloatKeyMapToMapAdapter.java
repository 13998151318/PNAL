 ...
 *  @since      1.0
 */
public class FloatKeyMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected FloatKeyMap map;
     ...
     */
    public FloatKeyMapToMapAdapter(FloatKeyMap map) {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultFloatHashFunction.INSTANCE.hash(key.floatValue()) ^ value.hashCode(); }
