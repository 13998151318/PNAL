 ...
 *  @since      1.0
 */
public class DoubleKeyLongMapToMapAdapter implements Map {
     ...
     */
    public DoubleKeyLongMapToMapAdapter(DoubleKeyLongMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultDoubleHashFunction.INSTANCE.hash(key.doubleValue()) ^ DefaultLongHashFunction.INSTANCE.hash(value.longValue()); }
