...
public class CollectionToBooleanCollectionAdapter extends AbstractBooleanCollection {
    ...
    /**
     *  Creates a new adaption of a collection to a collection of boolean
     *  values.
     *
     *  @param      collection
    ...
    { return collection.add(new Boolean(v)); }

    public void clear()
    { collection.clear(); }

    public boolean contains(boolean v)
    { return collection.contains(new Boolean(v)); }

    public int hashCode()
    { return collection.hashCode(); }

    public BooleanIterator iterator()
    { return new IteratorToBooleanIteratorAdapter(collection.iterator()); }

    public boolean remove(boolean v)
    { return collection.remove(new Boolean(v)); }
    ...
    { return Adapter.isBooleanAdaptable(collection); }
