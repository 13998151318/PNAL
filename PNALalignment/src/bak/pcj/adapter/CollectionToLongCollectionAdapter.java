...
public class CollectionToLongCollectionAdapter extends AbstractLongCollection {
    ...
    /**
     *  Creates a new adaption of a collection to a collection of long
     *  values.
     *
     *  @param      collection
    ...
    { return collection.add(new Long(v)); }

    public void clear()
    { collection.clear(); }

    public boolean contains(long v)
    { return collection.contains(new Long(v)); }

    public int hashCode()
    { return collection.hashCode(); }

    public LongIterator iterator()
    { return new IteratorToLongIteratorAdapter(collection.iterator()); }

    public boolean remove(long v)
    { return collection.remove(new Long(v)); }
    ...
    { return Adapter.isLongAdaptable(collection); }
