 ...
 *  @since      1.0
 */
public class ByteKeyByteMapToMapAdapter implements Map {

    /** The underlying primitive map. */
    protected ByteKeyByteMap map;
     ...
     */
    public ByteKeyByteMapToMapAdapter(ByteKeyByteMap map) throws NullPointerException /* Exception marked to work around bug in Javadoc 1.3 */ {
        if (map == null)
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new Iterator() {
                ByteKeyByteMapIterator i = map.entries();
    ...
    class Entry implements Map.Entry {
        ...
        public int hashCode()
        { return DefaultByteHashFunction.INSTANCE.hash(key.byteValue()) ^ DefaultByteHashFunction.INSTANCE.hash(value.byteValue()); }
