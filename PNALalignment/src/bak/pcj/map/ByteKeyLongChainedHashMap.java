 ...
 *  byte values to long values.
 *
 *  @see        ByteKeyLongOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ByteKeyLongChainedHashMap extends AbstractByteKeyLongMap implements ByteKeyLongMap, Cloneable, Serializable {
    ...
    private ByteKeyLongChainedHashMap(ByteHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ByteKeyLongChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ByteKeyLongChainedHashMap() {
     ...
     */
    public ByteKeyLongChainedHashMap(ByteKeyLongMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ByteKeyLongChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public ByteKeyLongChainedHashMap(double loadFactor) {
     ...
     */
    public ByteKeyLongChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public ByteKeyLongChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ByteKeyLongChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ByteKeyLongChainedHashMap(ByteHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyLongChainedHashMap(ByteHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyLongChainedHashMap(ByteHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyLongChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyLongChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyLongChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ByteKeyLongChainedHashMap c = (ByteKeyLongChainedHashMap)super.clone();
        ...
        return new ByteKeyLongMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 ByteKeyLongChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractByteSet {
        ...
        public void clear()
        { ByteKeyLongChainedHashMap.this.clear(); }
        ...
        public boolean remove(byte v) {
            ...
            if (result)
                ByteKeyLongChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        ByteKeyLongMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
