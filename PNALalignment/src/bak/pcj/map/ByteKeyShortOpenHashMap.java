 ...
 *
 *  @see        ByteKeyShortChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ByteKeyShortOpenHashMap extends AbstractByteKeyShortMap implements ByteKeyShortMap, Cloneable, Serializable {
    ...
    private ByteKeyShortOpenHashMap(ByteHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ByteKeyShortOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ByteKeyShortOpenHashMap() {
     ...
     */
    public ByteKeyShortOpenHashMap(ByteKeyShortMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ByteKeyShortOpenHashMap(int capacity) {
     ...
     */
    public ByteKeyShortOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public ByteKeyShortOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public ByteKeyShortOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ByteKeyShortOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ByteKeyShortOpenHashMap(ByteHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyShortOpenHashMap(ByteHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyShortOpenHashMap(ByteHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyShortOpenHashMap(ByteHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyShortOpenHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyShortOpenHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ByteKeyShortOpenHashMap c = (ByteKeyShortOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractByteSet {
        ...
        public void clear()
        { ByteKeyShortOpenHashMap.this.clear(); }
        ...
        public boolean remove(byte v) {
            ...
            if (result)
                ByteKeyShortOpenHashMap.this.remove(v);
            return result;
        }
