 ...
 *
 *  @see        DoubleKeyLongChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class DoubleKeyLongOpenHashMap extends AbstractDoubleKeyLongMap implements DoubleKeyLongMap, Cloneable, Serializable {
    ...
    private transient LongCollection cvalues;
    ...
    private DoubleKeyLongOpenHashMap(DoubleHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private DoubleKeyLongOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public DoubleKeyLongOpenHashMap() {
     ...
     */
    public DoubleKeyLongOpenHashMap(DoubleKeyLongMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public DoubleKeyLongOpenHashMap(int capacity) {
     ...
     */
    public DoubleKeyLongOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public DoubleKeyLongOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public DoubleKeyLongOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public DoubleKeyLongOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public DoubleKeyLongOpenHashMap(DoubleHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyLongOpenHashMap(DoubleHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyLongOpenHashMap(DoubleHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyLongOpenHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyLongOpenHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyLongOpenHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            DoubleKeyLongOpenHashMap c = (DoubleKeyLongOpenHashMap)super.clone();
            c.keys = new double[keys.length];
            System.arraycopy(keys, 0, c.keys, 0, keys.length);
            c.values = new long[values.length];
    ...
    private class KeySet extends AbstractDoubleSet {
        ...
        public void clear()
        { DoubleKeyLongOpenHashMap.this.clear(); }
        ...
        public boolean remove(double v) {
            ...
            if (result)
                DoubleKeyLongOpenHashMap.this.remove(v);
            return result;
        }
