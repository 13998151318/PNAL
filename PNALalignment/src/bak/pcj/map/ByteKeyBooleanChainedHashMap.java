 ...
 *  byte values to boolean values.
 *
 *  @see        ByteKeyBooleanOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ByteKeyBooleanChainedHashMap extends AbstractByteKeyBooleanMap implements ByteKeyBooleanMap, Cloneable, Serializable {
    ...
    private ByteKeyBooleanChainedHashMap(ByteHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ByteKeyBooleanChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ByteKeyBooleanChainedHashMap() {
     ...
     */
    public ByteKeyBooleanChainedHashMap(ByteKeyBooleanMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ByteKeyBooleanChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public ByteKeyBooleanChainedHashMap(double loadFactor) {
     ...
     */
    public ByteKeyBooleanChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public ByteKeyBooleanChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ByteKeyBooleanChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ByteKeyBooleanChainedHashMap(ByteHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyBooleanChainedHashMap(ByteHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyBooleanChainedHashMap(ByteHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyBooleanChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyBooleanChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyBooleanChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ByteKeyBooleanChainedHashMap c = (ByteKeyBooleanChainedHashMap)super.clone();
        ...
        return new ByteKeyBooleanMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 ByteKeyBooleanChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractByteSet {
        ...
        public void clear()
        { ByteKeyBooleanChainedHashMap.this.clear(); }
        ...
        public boolean remove(byte v) {
            ...
            if (result)
                ByteKeyBooleanChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        ByteKeyBooleanMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
