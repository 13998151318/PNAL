 ...
 *  double values to objects.
 *
 *  @see        DoubleKeyOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class DoubleKeyChainedHashMap extends AbstractDoubleKeyMap implements DoubleKeyMap, Cloneable, Serializable {
    ...
    private DoubleKeyChainedHashMap(DoubleHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private DoubleKeyChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public DoubleKeyChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public DoubleKeyChainedHashMap(double loadFactor) {
     ...
     */
    public DoubleKeyChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public DoubleKeyChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public DoubleKeyChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public DoubleKeyChainedHashMap(DoubleHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyChainedHashMap(DoubleHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyChainedHashMap(DoubleHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyChainedHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyChainedHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyChainedHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            DoubleKeyChainedHashMap c = (DoubleKeyChainedHashMap)super.clone();
        ...
        return new DoubleKeyMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 DoubleKeyChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractDoubleSet {
        ...
        public void clear()
        { DoubleKeyChainedHashMap.this.clear(); }
        ...
        public boolean remove(double v) {
            ...
            if (result)
                DoubleKeyChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        DoubleKeyMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
