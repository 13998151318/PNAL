 ...
 *  @since      1.0
 */
public class ByteKeyOpenHashMap extends AbstractByteKeyMap implements ByteKeyMap, Cloneable, Serializable {
    ...
    private ByteKeyOpenHashMap(ByteHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ByteKeyOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ByteKeyOpenHashMap(ByteKeyMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ByteKeyOpenHashMap(int capacity) {
     ...
     */
    public ByteKeyOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public ByteKeyOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public ByteKeyOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ByteKeyOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ByteKeyOpenHashMap(ByteHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyOpenHashMap(ByteHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyOpenHashMap(ByteHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyOpenHashMap(ByteHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyOpenHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyOpenHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ByteKeyOpenHashMap c = (ByteKeyOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractByteSet {
        ...
        public boolean remove(byte v) {
            ...
            if (result)
                ByteKeyOpenHashMap.this.remove(v);
            return result;
        }
