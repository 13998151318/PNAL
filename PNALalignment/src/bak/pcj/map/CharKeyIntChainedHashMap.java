 ...
 *  @since      1.0
 */
public class CharKeyIntChainedHashMap extends AbstractCharKeyIntMap implements CharKeyIntMap, Cloneable, Serializable {
    ...
    private CharKeyIntChainedHashMap(CharHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private CharKeyIntChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public CharKeyIntChainedHashMap() {
     ...
     */
    public CharKeyIntChainedHashMap(CharKeyIntMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public CharKeyIntChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public CharKeyIntChainedHashMap(double loadFactor) {
     ...
     */
    public CharKeyIntChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public CharKeyIntChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public CharKeyIntChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public CharKeyIntChainedHashMap(CharHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyIntChainedHashMap(CharHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyIntChainedHashMap(CharHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyIntChainedHashMap(CharHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyIntChainedHashMap(CharHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyIntChainedHashMap(CharHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
        ...
        return new CharKeyIntMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 CharKeyIntChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractCharSet {
        ...
        public void clear()
        { CharKeyIntChainedHashMap.this.clear(); }
        ...
        public boolean remove(char v) {
            ...
            if (result)
                CharKeyIntChainedHashMap.this.remove(v);
            return result;
        }
