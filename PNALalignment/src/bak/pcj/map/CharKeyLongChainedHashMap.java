 ...
 *  char values to long values.
 *
 *  @see        CharKeyLongOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class CharKeyLongChainedHashMap extends AbstractCharKeyLongMap implements CharKeyLongMap, Cloneable, Serializable {
    ...
    private CharKeyLongChainedHashMap(CharHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private CharKeyLongChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public CharKeyLongChainedHashMap() {
     ...
     */
    public CharKeyLongChainedHashMap(CharKeyLongMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public CharKeyLongChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public CharKeyLongChainedHashMap(double loadFactor) {
     ...
     */
    public CharKeyLongChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public CharKeyLongChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public CharKeyLongChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public CharKeyLongChainedHashMap(CharHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyLongChainedHashMap(CharHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyLongChainedHashMap(CharHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyLongChainedHashMap(CharHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyLongChainedHashMap(CharHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyLongChainedHashMap(CharHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            CharKeyLongChainedHashMap c = (CharKeyLongChainedHashMap)super.clone();
        ...
        return new CharKeyLongMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 CharKeyLongChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractCharSet {
        ...
        public void clear()
        { CharKeyLongChainedHashMap.this.clear(); }
        ...
        public boolean remove(char v) {
            ...
            if (result)
                CharKeyLongChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        CharKeyLongMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
