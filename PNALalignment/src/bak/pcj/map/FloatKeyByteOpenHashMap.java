 ...
 *
 *  @see        FloatKeyByteChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class FloatKeyByteOpenHashMap extends AbstractFloatKeyByteMap implements FloatKeyByteMap, Cloneable, Serializable {
    ...
    private FloatKeyByteOpenHashMap(FloatHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private FloatKeyByteOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public FloatKeyByteOpenHashMap() {
     ...
     */
    public FloatKeyByteOpenHashMap(FloatKeyByteMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public FloatKeyByteOpenHashMap(int capacity) {
     ...
     */
    public FloatKeyByteOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public FloatKeyByteOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public FloatKeyByteOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public FloatKeyByteOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public FloatKeyByteOpenHashMap(FloatHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyByteOpenHashMap(FloatHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyByteOpenHashMap(FloatHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyByteOpenHashMap(FloatHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyByteOpenHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyByteOpenHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            FloatKeyByteOpenHashMap c = (FloatKeyByteOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractFloatSet {
        ...
        public void clear()
        { FloatKeyByteOpenHashMap.this.clear(); }
        ...
        public boolean remove(float v) {
            ...
            if (result)
                FloatKeyByteOpenHashMap.this.remove(v);
            return result;
        }
