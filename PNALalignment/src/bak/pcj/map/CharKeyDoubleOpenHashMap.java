 ...
 *
 *  @see        CharKeyDoubleChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class CharKeyDoubleOpenHashMap extends AbstractCharKeyDoubleMap implements CharKeyDoubleMap, Cloneable, Serializable {
    ...
    private CharKeyDoubleOpenHashMap(CharHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private CharKeyDoubleOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public CharKeyDoubleOpenHashMap() {
     ...
     */
    public CharKeyDoubleOpenHashMap(CharKeyDoubleMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public CharKeyDoubleOpenHashMap(int capacity) {
     ...
     */
    public CharKeyDoubleOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public CharKeyDoubleOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public CharKeyDoubleOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public CharKeyDoubleOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public CharKeyDoubleOpenHashMap(CharHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyDoubleOpenHashMap(CharHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyDoubleOpenHashMap(CharHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyDoubleOpenHashMap(CharHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyDoubleOpenHashMap(CharHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyDoubleOpenHashMap(CharHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            CharKeyDoubleOpenHashMap c = (CharKeyDoubleOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractCharSet {
        ...
        public void clear()
        { CharKeyDoubleOpenHashMap.this.clear(); }
        ...
        public boolean remove(char v) {
            ...
            if (result)
                CharKeyDoubleOpenHashMap.this.remove(v);
            return result;
        }
