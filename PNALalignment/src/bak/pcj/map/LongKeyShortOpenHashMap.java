 ...
 *
 *  @see        LongKeyShortChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class LongKeyShortOpenHashMap extends AbstractLongKeyShortMap implements LongKeyShortMap, Cloneable, Serializable {
    ...
    private LongKeyShortOpenHashMap(LongHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private LongKeyShortOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public LongKeyShortOpenHashMap() {
     ...
     */
    public LongKeyShortOpenHashMap(LongKeyShortMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public LongKeyShortOpenHashMap(int capacity) {
     ...
     */
    public LongKeyShortOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public LongKeyShortOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public LongKeyShortOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public LongKeyShortOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public LongKeyShortOpenHashMap(LongHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyShortOpenHashMap(LongHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyShortOpenHashMap(LongHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyShortOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyShortOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyShortOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            LongKeyShortOpenHashMap c = (LongKeyShortOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractLongSet {
        ...
        public void clear()
        { LongKeyShortOpenHashMap.this.clear(); }
        ...
        public boolean remove(long v) {
            ...
            if (result)
                LongKeyShortOpenHashMap.this.remove(v);
            return result;
        }
