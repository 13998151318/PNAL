 ...
 *  @since      1.0
 */
public class LongKeyByteOpenHashMap extends AbstractLongKeyByteMap implements LongKeyByteMap, Cloneable, Serializable {
    ...
    private LongKeyByteOpenHashMap(LongHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private LongKeyByteOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public LongKeyByteOpenHashMap(LongKeyByteMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public LongKeyByteOpenHashMap(int capacity) {
     ...
     */
    public LongKeyByteOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public LongKeyByteOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public LongKeyByteOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public LongKeyByteOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public LongKeyByteOpenHashMap(LongHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyByteOpenHashMap(LongHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyByteOpenHashMap(LongHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyByteOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyByteOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyByteOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            LongKeyByteOpenHashMap c = (LongKeyByteOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractLongSet {
        ...
        public void clear()
        { LongKeyByteOpenHashMap.this.clear(); }
        ...
        public boolean remove(long v) {
            ...
            if (result)
                LongKeyByteOpenHashMap.this.remove(v);
            return result;
        }
