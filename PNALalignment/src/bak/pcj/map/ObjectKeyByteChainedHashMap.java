 ...
 *  object values to byte values.
 *
 *  @see        ObjectKeyByteOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.1
 */
public class ObjectKeyByteChainedHashMap extends AbstractObjectKeyByteMap implements ObjectKeyByteMap, Cloneable, Serializable {
    ...
    private ObjectKeyByteChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (capacity < 0)
     ...
     */
    public ObjectKeyByteChainedHashMap() {
     ...
     */
    public ObjectKeyByteChainedHashMap(ObjectKeyByteMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ObjectKeyByteChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public ObjectKeyByteChainedHashMap(double loadFactor) {
     ...
     */
    public ObjectKeyByteChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public ObjectKeyByteChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ObjectKeyByteChainedHashMap(int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ObjectKeyByteChainedHashMap c = (ObjectKeyByteChainedHashMap)super.clone();
        ...
        return new ObjectKeyByteMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 ObjectKeyByteChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractSet {
        ...
        public void clear()
        { ObjectKeyByteChainedHashMap.this.clear(); }
        ...
        public boolean remove(Object v) {
            ...
            if (result)
                ObjectKeyByteChainedHashMap.this.remove(v);
            return result;
        }
