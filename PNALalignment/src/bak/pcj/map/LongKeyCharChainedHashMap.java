 ...
 *  @since      1.0
 */
public class LongKeyCharChainedHashMap extends AbstractLongKeyCharMap implements LongKeyCharMap, Cloneable, Serializable {
    ...
    private LongKeyCharChainedHashMap(LongHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private LongKeyCharChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public LongKeyCharChainedHashMap() {
     ...
     */
    public LongKeyCharChainedHashMap(LongKeyCharMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public LongKeyCharChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public LongKeyCharChainedHashMap(double loadFactor) {
     ...
     */
    public LongKeyCharChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public LongKeyCharChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public LongKeyCharChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public LongKeyCharChainedHashMap(LongHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyCharChainedHashMap(LongHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyCharChainedHashMap(LongHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyCharChainedHashMap(LongHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyCharChainedHashMap(LongHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyCharChainedHashMap(LongHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            LongKeyCharChainedHashMap c = (LongKeyCharChainedHashMap)super.clone();
        ...
        return new LongKeyCharMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 LongKeyCharChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractLongSet {
        ...
        public void clear()
        { LongKeyCharChainedHashMap.this.clear(); }
        ...
        public boolean remove(long v) {
            ...
            if (result)
                LongKeyCharChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        LongKeyCharMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
