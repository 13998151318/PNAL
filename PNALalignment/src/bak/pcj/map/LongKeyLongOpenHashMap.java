 ...
 *  @since      1.0
 */
public class LongKeyLongOpenHashMap extends AbstractLongKeyLongMap implements LongKeyLongMap, Cloneable, Serializable {
    ...
    private LongKeyLongOpenHashMap(LongHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private LongKeyLongOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public LongKeyLongOpenHashMap(LongKeyLongMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public LongKeyLongOpenHashMap(int capacity) {
     ...
     */
    public LongKeyLongOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public LongKeyLongOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public LongKeyLongOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public LongKeyLongOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public LongKeyLongOpenHashMap(LongHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyLongOpenHashMap(LongHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyLongOpenHashMap(LongHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyLongOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyLongOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyLongOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            LongKeyLongOpenHashMap c = (LongKeyLongOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractLongSet {
        ...
        public void clear()
        { LongKeyLongOpenHashMap.this.clear(); }
        ...
        public boolean remove(long v) {
            ...
            if (result)
                LongKeyLongOpenHashMap.this.remove(v);
            return result;
        }
