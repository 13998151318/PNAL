 ...
 *  @since      1.0
 */
public class IntKeyByteChainedHashMap extends AbstractIntKeyByteMap implements IntKeyByteMap, Cloneable, Serializable {
    ...
    private IntKeyByteChainedHashMap(IntHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private IntKeyByteChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public IntKeyByteChainedHashMap() {
     ...
     */
    public IntKeyByteChainedHashMap(IntKeyByteMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public IntKeyByteChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public IntKeyByteChainedHashMap(double loadFactor) {
     ...
     */
    public IntKeyByteChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public IntKeyByteChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public IntKeyByteChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public IntKeyByteChainedHashMap(IntHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyByteChainedHashMap(IntHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyByteChainedHashMap(IntHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyByteChainedHashMap(IntHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyByteChainedHashMap(IntHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyByteChainedHashMap(IntHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            IntKeyByteChainedHashMap c = (IntKeyByteChainedHashMap)super.clone();
        ...
        return new IntKeyByteMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 IntKeyByteChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractIntSet {
        ...
        public void clear()
        { IntKeyByteChainedHashMap.this.clear(); }
        ...
        public boolean remove(int v) {
            ...
            if (result)
                IntKeyByteChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        IntKeyByteMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
            s.writeInt(i.getKey());
