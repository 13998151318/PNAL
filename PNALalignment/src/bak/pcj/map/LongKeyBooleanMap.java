 ...
 *
 *  @see        bak.pcj.map.LongKeyBooleanMapIterator
 *  @see        java.util.Map
 *
...
public interface LongKeyBooleanMap {
     ...
     *  from {@link #containsKey(long) containsKey(long)}. This is useful
     ...
     *              last invokation of 
     *              {@link #containsKey(long) containsKey(long)}.
     *
     *  @throws     IllegalStateException
     *              if {@link #containsKey(long) containsKey(long)} has
     ...
     *  @see        MapDefaults
     */
    boolean put(long key, boolean value);
     ...
     *              if the operation is not supported by this map.
     */
    void putAll(LongKeyBooleanMap map);
