 ...
 *  @since      1.0
 */
public class DoubleKeyIntChainedHashMap extends AbstractDoubleKeyIntMap implements DoubleKeyIntMap, Cloneable, Serializable {
    ...
    private DoubleKeyIntChainedHashMap(DoubleHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private DoubleKeyIntChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public DoubleKeyIntChainedHashMap(double loadFactor) {
     ...
     */
    public DoubleKeyIntChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public DoubleKeyIntChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public DoubleKeyIntChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyIntChainedHashMap(DoubleHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyIntChainedHashMap(DoubleHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyIntChainedHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyIntChainedHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyIntChainedHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            DoubleKeyIntChainedHashMap c = (DoubleKeyIntChainedHashMap)super.clone();
        ...
        return new DoubleKeyIntMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 DoubleKeyIntChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractDoubleSet {
        ...
        public void clear()
        { DoubleKeyIntChainedHashMap.this.clear(); }
        ...
        public boolean remove(double v) {
            ...
            if (result)
                DoubleKeyIntChainedHashMap.this.remove(v);
            return result;
        }
