 ...
 *  double values to double values.
 *
 *  @see        DoubleKeyDoubleOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class DoubleKeyDoubleChainedHashMap extends AbstractDoubleKeyDoubleMap implements DoubleKeyDoubleMap, Cloneable, Serializable {
    ...
    private DoubleKeyDoubleChainedHashMap(DoubleHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private DoubleKeyDoubleChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public DoubleKeyDoubleChainedHashMap() {
     ...
     */
    public DoubleKeyDoubleChainedHashMap(DoubleKeyDoubleMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public DoubleKeyDoubleChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public DoubleKeyDoubleChainedHashMap(double loadFactor) {
     ...
     */
    public DoubleKeyDoubleChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public DoubleKeyDoubleChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public DoubleKeyDoubleChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public DoubleKeyDoubleChainedHashMap(DoubleHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyDoubleChainedHashMap(DoubleHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyDoubleChainedHashMap(DoubleHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyDoubleChainedHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyDoubleChainedHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyDoubleChainedHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public double put(double key, double value) {
        ...
        if (e == null) {
            result = MapDefaults.defaultDouble();
    ...
    public Object clone() {
        try {
            DoubleKeyDoubleChainedHashMap c = (DoubleKeyDoubleChainedHashMap)super.clone();
    ...
    public DoubleKeyDoubleMapIterator entries() {
        return new DoubleKeyDoubleMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 DoubleKeyDoubleChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractDoubleSet {
        ...
        public void clear()
        { DoubleKeyDoubleChainedHashMap.this.clear(); }
        ...
        public boolean remove(double v) {
            ...
            if (result)
                DoubleKeyDoubleChainedHashMap.this.remove(v);
            return result;
        }
    ...
    public double get(double key) {
        int index = Math.abs(keyhash.hash(key)) % data.length;
        Entry e = searchList(data[index], key);
        return e != null ? e.value : MapDefaults.defaultDouble();
    }
    ...
    public double remove(double key) {
        ...
        if (e != null) {
            ...
            value = MapDefaults.defaultDouble();
        return value;
    }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        DoubleKeyDoubleMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
