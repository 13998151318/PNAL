 ...
 *  maps from double values to double values. All operations that can be implemented
 *  using iterators
 ...
 *  @since      1.0
 */
public abstract class AbstractDoubleKeyDoubleMap implements DoubleKeyDoubleMap {
