 ...
 *
 *  @see        LongKeyDoubleChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class LongKeyDoubleOpenHashMap extends AbstractLongKeyDoubleMap implements LongKeyDoubleMap, Cloneable, Serializable {
    ...
    private LongKeyDoubleOpenHashMap(LongHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private LongKeyDoubleOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public LongKeyDoubleOpenHashMap() {
     ...
     */
    public LongKeyDoubleOpenHashMap(LongKeyDoubleMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public LongKeyDoubleOpenHashMap(int capacity) {
     ...
     */
    public LongKeyDoubleOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public LongKeyDoubleOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public LongKeyDoubleOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public LongKeyDoubleOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public LongKeyDoubleOpenHashMap(LongHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyDoubleOpenHashMap(LongHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyDoubleOpenHashMap(LongHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyDoubleOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyDoubleOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyDoubleOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            LongKeyDoubleOpenHashMap c = (LongKeyDoubleOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractLongSet {
        ...
        public void clear()
        { LongKeyDoubleOpenHashMap.this.clear(); }
        ...
        public boolean remove(long v) {
            ...
            if (result)
                LongKeyDoubleOpenHashMap.this.remove(v);
            return result;
        }
