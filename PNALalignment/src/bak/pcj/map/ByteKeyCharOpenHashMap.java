 ...
 *  @since      1.0
 */
public class ByteKeyCharOpenHashMap extends AbstractByteKeyCharMap implements ByteKeyCharMap, Cloneable, Serializable {
    ...
    private ByteKeyCharOpenHashMap(ByteHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ByteKeyCharOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ByteKeyCharOpenHashMap(ByteKeyCharMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ByteKeyCharOpenHashMap(int capacity) {
     ...
     */
    public ByteKeyCharOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public ByteKeyCharOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public ByteKeyCharOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ByteKeyCharOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ByteKeyCharOpenHashMap(ByteHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyCharOpenHashMap(ByteHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyCharOpenHashMap(ByteHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyCharOpenHashMap(ByteHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyCharOpenHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyCharOpenHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ByteKeyCharOpenHashMap c = (ByteKeyCharOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractByteSet {
        ...
        public void clear()
        { ByteKeyCharOpenHashMap.this.clear(); }
        ...
        public boolean remove(byte v) {
            ...
            if (result)
                ByteKeyCharOpenHashMap.this.remove(v);
            return result;
        }
