 ...
 *  @since      1.0
 */
public class LongKeyCharOpenHashMap extends AbstractLongKeyCharMap implements LongKeyCharMap, Cloneable, Serializable {
    ...
    private LongKeyCharOpenHashMap(LongHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private LongKeyCharOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public LongKeyCharOpenHashMap(LongKeyCharMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public LongKeyCharOpenHashMap(int capacity) {
     ...
     */
    public LongKeyCharOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public LongKeyCharOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public LongKeyCharOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public LongKeyCharOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public LongKeyCharOpenHashMap(LongHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyCharOpenHashMap(LongHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyCharOpenHashMap(LongHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyCharOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyCharOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyCharOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            LongKeyCharOpenHashMap c = (LongKeyCharOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractLongSet {
        ...
        public void clear()
        { LongKeyCharOpenHashMap.this.clear(); }
        ...
        public boolean remove(long v) {
            ...
            if (result)
                LongKeyCharOpenHashMap.this.remove(v);
            return result;
        }
