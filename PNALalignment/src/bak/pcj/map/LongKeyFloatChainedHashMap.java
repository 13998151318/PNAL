 ...
 *  @since      1.0
 */
public class LongKeyFloatChainedHashMap extends AbstractLongKeyFloatMap implements LongKeyFloatMap, Cloneable, Serializable {
        ...
        return new LongKeyFloatMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 LongKeyFloatChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
