 ...
 *  float values to short values.
 *
 *  @see        FloatKeyShortOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class FloatKeyShortChainedHashMap extends AbstractFloatKeyShortMap implements FloatKeyShortMap, Cloneable, Serializable {
    ...
    private FloatKeyShortChainedHashMap(FloatHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private FloatKeyShortChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public FloatKeyShortChainedHashMap() {
     ...
     */
    public FloatKeyShortChainedHashMap(FloatKeyShortMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public FloatKeyShortChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public FloatKeyShortChainedHashMap(double loadFactor) {
     ...
     */
    public FloatKeyShortChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public FloatKeyShortChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public FloatKeyShortChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public FloatKeyShortChainedHashMap(FloatHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyShortChainedHashMap(FloatHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyShortChainedHashMap(FloatHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyShortChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyShortChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyShortChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            FloatKeyShortChainedHashMap c = (FloatKeyShortChainedHashMap)super.clone();
        ...
        return new FloatKeyShortMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 FloatKeyShortChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractFloatSet {
        ...
        public void clear()
        { FloatKeyShortChainedHashMap.this.clear(); }
        ...
        public boolean remove(float v) {
            ...
            if (result)
                FloatKeyShortChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        FloatKeyShortMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
