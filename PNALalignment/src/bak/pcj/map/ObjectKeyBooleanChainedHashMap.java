 ...
 *  object values to boolean values.
 *
 *  @see        ObjectKeyBooleanOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.1
 */
public class ObjectKeyBooleanChainedHashMap extends AbstractObjectKeyBooleanMap implements ObjectKeyBooleanMap, Cloneable, Serializable {
    ...
    private ObjectKeyBooleanChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (capacity < 0)
     ...
     */
    public ObjectKeyBooleanChainedHashMap() {
     ...
     */
    public ObjectKeyBooleanChainedHashMap(ObjectKeyBooleanMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ObjectKeyBooleanChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public ObjectKeyBooleanChainedHashMap(double loadFactor) {
     ...
     */
    public ObjectKeyBooleanChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public ObjectKeyBooleanChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ObjectKeyBooleanChainedHashMap(int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ObjectKeyBooleanChainedHashMap c = (ObjectKeyBooleanChainedHashMap)super.clone();
    ...
    private static class Entry {
        ...
        Entry(Object key, boolean value) {
            this.key = key;
            this.value = value;
        }
        ...
        return new ObjectKeyBooleanMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 ObjectKeyBooleanChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractSet {
        ...
        public void clear()
        { ObjectKeyBooleanChainedHashMap.this.clear(); }
        ...
        public boolean remove(Object v) {
            ...
            if (result)
                ObjectKeyBooleanChainedHashMap.this.remove(v);
            return result;
        }
