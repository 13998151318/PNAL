 ...
 *  @since      1.0
 */
public class CharKeyIntOpenHashMap extends AbstractCharKeyIntMap implements CharKeyIntMap, Cloneable, Serializable {
    ...
    private CharKeyIntOpenHashMap(CharHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private CharKeyIntOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public CharKeyIntOpenHashMap(int capacity) {
     ...
     */
    public CharKeyIntOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public CharKeyIntOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public CharKeyIntOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public CharKeyIntOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public CharKeyIntOpenHashMap(CharHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyIntOpenHashMap(CharHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyIntOpenHashMap(CharHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyIntOpenHashMap(CharHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyIntOpenHashMap(CharHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyIntOpenHashMap(CharHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            CharKeyIntOpenHashMap c = (CharKeyIntOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractCharSet {
        ...
        public void clear()
        { CharKeyIntOpenHashMap.this.clear(); }
        ...
        public boolean remove(char v) {
            ...
            if (result)
                CharKeyIntOpenHashMap.this.remove(v);
            return result;
        }
