 ...
 *  maps from boolean values to long values. All operations that can be implemented
 *  using iterators
...
public abstract class AbstractBooleanKeyLongMap implements BooleanKeyLongMap {
    ...
    protected AbstractBooleanKeyLongMap() { }

    public void clear() {
        BooleanKeyLongMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
            i.remove();
        }
    ...
    public void putAll(BooleanKeyLongMap map) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BooleanKeyLongMap))
            return false;
        BooleanKeyLongMap map = (BooleanKeyLongMap)obj;
        if (size() != map.size())
            return false;
        BooleanKeyLongMapIterator i = entries();
        while (i.hasNext()) {
    ...
    public int hashCode() {
        ...
        while (i.hasNext()) {
            i.next();
            h += (DefaultBooleanHashFunction.INSTANCE.hash(i.getKey()) ^ DefaultLongHashFunction.INSTANCE.hash(i.getValue()));
        }
        return h;
    }
