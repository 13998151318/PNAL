 ...
 *  @since      1.0
 */
public class IntKeyShortChainedHashMap extends AbstractIntKeyShortMap implements IntKeyShortMap, Cloneable, Serializable {
    ...
    private IntKeyShortChainedHashMap(IntHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private IntKeyShortChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public IntKeyShortChainedHashMap() {
     ...
     */
    public IntKeyShortChainedHashMap(IntKeyShortMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public IntKeyShortChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public IntKeyShortChainedHashMap(double loadFactor) {
     ...
     */
    public IntKeyShortChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public IntKeyShortChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public IntKeyShortChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public IntKeyShortChainedHashMap(IntHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyShortChainedHashMap(IntHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyShortChainedHashMap(IntHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyShortChainedHashMap(IntHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyShortChainedHashMap(IntHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyShortChainedHashMap(IntHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            IntKeyShortChainedHashMap c = (IntKeyShortChainedHashMap)super.clone();
        ...
        return new IntKeyShortMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 IntKeyShortChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractIntSet {
        ...
        public void clear()
        { IntKeyShortChainedHashMap.this.clear(); }
        ...
        public boolean remove(int v) {
            ...
            if (result)
                IntKeyShortChainedHashMap.this.remove(v);
            return result;
        }
