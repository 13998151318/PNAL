 ...
 *  short values to char values.
 *
 *  @see        ShortKeyCharOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ShortKeyCharChainedHashMap extends AbstractShortKeyCharMap implements ShortKeyCharMap, Cloneable, Serializable {
    ...
    private ShortKeyCharChainedHashMap(ShortHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ShortKeyCharChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ShortKeyCharChainedHashMap() {
     ...
     */
    public ShortKeyCharChainedHashMap(ShortKeyCharMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ShortKeyCharChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public ShortKeyCharChainedHashMap(double loadFactor) {
     ...
     */
    public ShortKeyCharChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public ShortKeyCharChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ShortKeyCharChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ShortKeyCharChainedHashMap(ShortHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyCharChainedHashMap(ShortHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyCharChainedHashMap(ShortHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyCharChainedHashMap(ShortHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyCharChainedHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyCharChainedHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ShortKeyCharChainedHashMap c = (ShortKeyCharChainedHashMap)super.clone();
        ...
        return new ShortKeyCharMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 ShortKeyCharChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractShortSet {
        ...
        public void clear()
        { ShortKeyCharChainedHashMap.this.clear(); }
        ...
        public boolean remove(short v) {
            ...
            if (result)
                ShortKeyCharChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        ShortKeyCharMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
