 ...
 *  short values to int values.
 *
 *  @see        ShortKeyIntOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ShortKeyIntChainedHashMap extends AbstractShortKeyIntMap implements ShortKeyIntMap, Cloneable, Serializable {
    ...
    private ShortKeyIntChainedHashMap(ShortHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ShortKeyIntChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ShortKeyIntChainedHashMap() {
     ...
     */
    public ShortKeyIntChainedHashMap(ShortKeyIntMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ShortKeyIntChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public ShortKeyIntChainedHashMap(double loadFactor) {
     ...
     */
    public ShortKeyIntChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public ShortKeyIntChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ShortKeyIntChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ShortKeyIntChainedHashMap(ShortHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyIntChainedHashMap(ShortHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyIntChainedHashMap(ShortHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyIntChainedHashMap(ShortHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyIntChainedHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyIntChainedHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ShortKeyIntChainedHashMap c = (ShortKeyIntChainedHashMap)super.clone();
        ...
        return new ShortKeyIntMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 ShortKeyIntChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractShortSet {
        ...
        public void clear()
        { ShortKeyIntChainedHashMap.this.clear(); }
        ...
        public boolean remove(short v) {
            ...
            if (result)
                ShortKeyIntChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        ShortKeyIntMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
