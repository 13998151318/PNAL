 ...
 *
 *  @see        ByteKeyBooleanChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ByteKeyBooleanOpenHashMap extends AbstractByteKeyBooleanMap implements ByteKeyBooleanMap, Cloneable, Serializable {
    ...
    private ByteKeyBooleanOpenHashMap(ByteHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ByteKeyBooleanOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ByteKeyBooleanOpenHashMap() {
     ...
     */
    public ByteKeyBooleanOpenHashMap(ByteKeyBooleanMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ByteKeyBooleanOpenHashMap(int capacity) {
     ...
     */
    public ByteKeyBooleanOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public ByteKeyBooleanOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public ByteKeyBooleanOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ByteKeyBooleanOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ByteKeyBooleanOpenHashMap(ByteHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyBooleanOpenHashMap(ByteHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyBooleanOpenHashMap(ByteHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyBooleanOpenHashMap(ByteHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyBooleanOpenHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyBooleanOpenHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ByteKeyBooleanOpenHashMap c = (ByteKeyBooleanOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractByteSet {
        ...
        public void clear()
        { ByteKeyBooleanOpenHashMap.this.clear(); }
        ...
        public boolean remove(byte v) {
            ...
            if (result)
                ByteKeyBooleanOpenHashMap.this.remove(v);
            return result;
        }
