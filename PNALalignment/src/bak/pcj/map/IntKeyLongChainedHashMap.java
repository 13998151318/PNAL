 ...
 *  int values to long values.
 *
 *  @see        IntKeyLongOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class IntKeyLongChainedHashMap extends AbstractIntKeyLongMap implements IntKeyLongMap, Cloneable, Serializable {
    ...
    private IntKeyLongChainedHashMap(IntHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private IntKeyLongChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public IntKeyLongChainedHashMap() {
     ...
     */
    public IntKeyLongChainedHashMap(IntKeyLongMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public IntKeyLongChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public IntKeyLongChainedHashMap(double loadFactor) {
     ...
     */
    public IntKeyLongChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public IntKeyLongChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public IntKeyLongChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public IntKeyLongChainedHashMap(IntHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyLongChainedHashMap(IntHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyLongChainedHashMap(IntHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyLongChainedHashMap(IntHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyLongChainedHashMap(IntHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyLongChainedHashMap(IntHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            IntKeyLongChainedHashMap c = (IntKeyLongChainedHashMap)super.clone();
        ...
        return new IntKeyLongMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 IntKeyLongChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractIntSet {
        ...
        public void clear()
        { IntKeyLongChainedHashMap.this.clear(); }
        ...
        public boolean remove(int v) {
            ...
            if (result)
                IntKeyLongChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        IntKeyLongMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
            s.writeInt(i.getKey());
