 ...
 *
 *  @see        ShortKeyDoubleChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ShortKeyDoubleOpenHashMap extends AbstractShortKeyDoubleMap implements ShortKeyDoubleMap, Cloneable, Serializable {
    ...
    private ShortKeyDoubleOpenHashMap(ShortHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ShortKeyDoubleOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ShortKeyDoubleOpenHashMap() {
     ...
     */
    public ShortKeyDoubleOpenHashMap(ShortKeyDoubleMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ShortKeyDoubleOpenHashMap(int capacity) {
     ...
     */
    public ShortKeyDoubleOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public ShortKeyDoubleOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public ShortKeyDoubleOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ShortKeyDoubleOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ShortKeyDoubleOpenHashMap(ShortHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyDoubleOpenHashMap(ShortHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyDoubleOpenHashMap(ShortHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyDoubleOpenHashMap(ShortHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyDoubleOpenHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyDoubleOpenHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ShortKeyDoubleOpenHashMap c = (ShortKeyDoubleOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractShortSet {
        ...
        public void clear()
        { ShortKeyDoubleOpenHashMap.this.clear(); }
        ...
        public boolean remove(short v) {
            ...
            if (result)
                ShortKeyDoubleOpenHashMap.this.remove(v);
            return result;
        }
