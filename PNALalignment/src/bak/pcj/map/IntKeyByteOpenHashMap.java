 ...
 *  @since      1.0
 */
public class IntKeyByteOpenHashMap extends AbstractIntKeyByteMap implements IntKeyByteMap, Cloneable, Serializable {
    ...
    private IntKeyByteOpenHashMap(IntHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private IntKeyByteOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public IntKeyByteOpenHashMap(IntKeyByteMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public IntKeyByteOpenHashMap(int capacity) {
     ...
     */
    public IntKeyByteOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public IntKeyByteOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public IntKeyByteOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public IntKeyByteOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public IntKeyByteOpenHashMap(IntHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyByteOpenHashMap(IntHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyByteOpenHashMap(IntHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyByteOpenHashMap(IntHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyByteOpenHashMap(IntHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyByteOpenHashMap(IntHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            IntKeyByteOpenHashMap c = (IntKeyByteOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractIntSet {
        ...
        public void clear()
        { IntKeyByteOpenHashMap.this.clear(); }
        ...
        public boolean remove(int v) {
            ...
            if (result)
                IntKeyByteOpenHashMap.this.remove(v);
            return result;
        }
