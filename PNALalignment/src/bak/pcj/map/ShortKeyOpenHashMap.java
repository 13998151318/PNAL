 ...
 *  @since      1.0
 */
public class ShortKeyOpenHashMap extends AbstractShortKeyMap implements ShortKeyMap, Cloneable, Serializable {
    ...
    private ShortKeyOpenHashMap(ShortHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ShortKeyOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ShortKeyOpenHashMap(ShortKeyMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ShortKeyOpenHashMap(int capacity) {
     ...
     */
    public ShortKeyOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public ShortKeyOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public ShortKeyOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ShortKeyOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ShortKeyOpenHashMap(ShortHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyOpenHashMap(ShortHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyOpenHashMap(ShortHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyOpenHashMap(ShortHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyOpenHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyOpenHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ShortKeyOpenHashMap c = (ShortKeyOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractShortSet {
        ...
        public void clear()
        { ShortKeyOpenHashMap.this.clear(); }
        ...
        public boolean remove(short v) {
            ...
            if (result)
                ShortKeyOpenHashMap.this.remove(v);
            return result;
        }
