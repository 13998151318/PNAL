 ...
 *
 *  @see        ShortKeyCharChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ShortKeyCharOpenHashMap extends AbstractShortKeyCharMap implements ShortKeyCharMap, Cloneable, Serializable {
    ...
    private ShortKeyCharOpenHashMap(ShortHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ShortKeyCharOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ShortKeyCharOpenHashMap() {
     ...
     */
    public ShortKeyCharOpenHashMap(ShortKeyCharMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ShortKeyCharOpenHashMap(int capacity) {
     ...
     */
    public ShortKeyCharOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public ShortKeyCharOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public ShortKeyCharOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ShortKeyCharOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ShortKeyCharOpenHashMap(ShortHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyCharOpenHashMap(ShortHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyCharOpenHashMap(ShortHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyCharOpenHashMap(ShortHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyCharOpenHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyCharOpenHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ShortKeyCharOpenHashMap c = (ShortKeyCharOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractShortSet {
        ...
        public void clear()
        { ShortKeyCharOpenHashMap.this.clear(); }
        ...
        public boolean remove(short v) {
            ...
            if (result)
                ShortKeyCharOpenHashMap.this.remove(v);
            return result;
        }
