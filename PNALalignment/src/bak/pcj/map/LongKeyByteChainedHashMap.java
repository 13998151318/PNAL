 ...
 *  long values to byte values.
 *
 *  @see        LongKeyByteOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class LongKeyByteChainedHashMap extends AbstractLongKeyByteMap implements LongKeyByteMap, Cloneable, Serializable {
    ...
    private LongKeyByteChainedHashMap(LongHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private LongKeyByteChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public LongKeyByteChainedHashMap() {
     ...
     */
    public LongKeyByteChainedHashMap(LongKeyByteMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public LongKeyByteChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public LongKeyByteChainedHashMap(double loadFactor) {
     ...
     */
    public LongKeyByteChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public LongKeyByteChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public LongKeyByteChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public LongKeyByteChainedHashMap(LongHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyByteChainedHashMap(LongHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyByteChainedHashMap(LongHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyByteChainedHashMap(LongHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyByteChainedHashMap(LongHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyByteChainedHashMap(LongHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            LongKeyByteChainedHashMap c = (LongKeyByteChainedHashMap)super.clone();
        ...
        return new LongKeyByteMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 LongKeyByteChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractLongSet {
        ...
        public void clear()
        { LongKeyByteChainedHashMap.this.clear(); }
        ...
        public boolean remove(long v) {
            ...
            if (result)
                LongKeyByteChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        LongKeyByteMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
