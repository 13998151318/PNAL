 ...
 *  @since      1.0
 */
public class DoubleKeyFloatChainedHashMap extends AbstractDoubleKeyFloatMap implements DoubleKeyFloatMap, Cloneable, Serializable {
    ...
    private DoubleKeyFloatChainedHashMap(DoubleHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private DoubleKeyFloatChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public DoubleKeyFloatChainedHashMap() {
     ...
     */
    public DoubleKeyFloatChainedHashMap(DoubleKeyFloatMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public DoubleKeyFloatChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public DoubleKeyFloatChainedHashMap(double loadFactor) {
     ...
     */
    public DoubleKeyFloatChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public DoubleKeyFloatChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public DoubleKeyFloatChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public DoubleKeyFloatChainedHashMap(DoubleHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyFloatChainedHashMap(DoubleHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyFloatChainedHashMap(DoubleHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyFloatChainedHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyFloatChainedHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyFloatChainedHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            DoubleKeyFloatChainedHashMap c = (DoubleKeyFloatChainedHashMap)super.clone();
        ...
        return new DoubleKeyFloatMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 DoubleKeyFloatChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractDoubleSet {
        ...
        public void clear()
        { DoubleKeyFloatChainedHashMap.this.clear(); }
        ...
        public boolean remove(double v) {
            ...
            if (result)
                DoubleKeyFloatChainedHashMap.this.remove(v);
            return result;
        }
