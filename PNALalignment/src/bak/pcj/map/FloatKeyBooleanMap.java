 ...
 *
 *  @see        bak.pcj.map.FloatKeyBooleanMapIterator
 *  @see        java.util.Map
 *
...
public interface FloatKeyBooleanMap {
     ...
     *  from {@link #containsKey(float) containsKey(float)}. This is useful
     ...
     *              last invokation of 
     *              {@link #containsKey(float) containsKey(float)}.
     *
     *  @throws     IllegalStateException
     *              if {@link #containsKey(float) containsKey(float)} has
     *              not been called or the last call resulted in
     *              a return value of <tt>false</tt>.
     *
     *  @see        #get(float)
     *  @see        #tget(float)
     *  @see        #containsKey(float)
     */
    boolean lget();
     ...
     *  @see        MapDefaults
     */
    boolean put(float key, boolean value);
     ...
     *              if the operation is not supported by this map.
     */
    void putAll(FloatKeyBooleanMap map);
