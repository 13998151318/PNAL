 ...
 *
 *  @see        FloatKeyShortChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class FloatKeyShortOpenHashMap extends AbstractFloatKeyShortMap implements FloatKeyShortMap, Cloneable, Serializable {
    ...
    private FloatKeyShortOpenHashMap(FloatHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private FloatKeyShortOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public FloatKeyShortOpenHashMap() {
     ...
     */
    public FloatKeyShortOpenHashMap(FloatKeyShortMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public FloatKeyShortOpenHashMap(int capacity) {
     ...
     */
    public FloatKeyShortOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public FloatKeyShortOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public FloatKeyShortOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public FloatKeyShortOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public FloatKeyShortOpenHashMap(FloatHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyShortOpenHashMap(FloatHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyShortOpenHashMap(FloatHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyShortOpenHashMap(FloatHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyShortOpenHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyShortOpenHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            FloatKeyShortOpenHashMap c = (FloatKeyShortOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractFloatSet {
        ...
        public void clear()
        { FloatKeyShortOpenHashMap.this.clear(); }
        ...
        public boolean remove(float v) {
            ...
            if (result)
                FloatKeyShortOpenHashMap.this.remove(v);
            return result;
        }
