 ...
 *  @since      1.0
 */
public class ByteKeyByteChainedHashMap extends AbstractByteKeyByteMap implements ByteKeyByteMap, Cloneable, Serializable {
    ...
    private ByteKeyByteChainedHashMap(ByteHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ByteKeyByteChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ByteKeyByteChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public ByteKeyByteChainedHashMap(double loadFactor) {
     ...
     */
    public ByteKeyByteChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public ByteKeyByteChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ByteKeyByteChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ByteKeyByteChainedHashMap(ByteHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyByteChainedHashMap(ByteHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyByteChainedHashMap(ByteHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyByteChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyByteChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyByteChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ByteKeyByteChainedHashMap c = (ByteKeyByteChainedHashMap)super.clone();
        ...
        return new ByteKeyByteMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 ByteKeyByteChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractByteSet {
        ...
        public void clear()
        { ByteKeyByteChainedHashMap.this.clear(); }
        ...
        public boolean remove(byte v) {
            ...
            if (result)
                ByteKeyByteChainedHashMap.this.remove(v);
            return result;
        }
