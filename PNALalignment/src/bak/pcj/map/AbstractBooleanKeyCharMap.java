 ...
 *  maps from boolean values to char values. All operations that can be implemented
 *  using iterators
...
public abstract class AbstractBooleanKeyCharMap implements BooleanKeyCharMap {
    ...
    protected AbstractBooleanKeyCharMap() { }

    public void clear() {
        BooleanKeyCharMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
            i.remove();
        }
    ...
    public void putAll(BooleanKeyCharMap map) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BooleanKeyCharMap))
            return false;
        BooleanKeyCharMap map = (BooleanKeyCharMap)obj;
        if (size() != map.size())
            return false;
        BooleanKeyCharMapIterator i = entries();
        while (i.hasNext()) {
    ...
    public int hashCode() {
        ...
        while (i.hasNext()) {
            i.next();
            h += (DefaultBooleanHashFunction.INSTANCE.hash(i.getKey()) ^ DefaultCharHashFunction.INSTANCE.hash(i.getValue()));
        }
        return h;
    }
