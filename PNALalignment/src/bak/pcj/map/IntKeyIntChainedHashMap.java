 ...
 *  @since      1.0
 */
public class IntKeyIntChainedHashMap extends AbstractIntKeyIntMap implements IntKeyIntMap, Cloneable, Serializable {
    ...
    private IntKeyIntChainedHashMap(IntHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private IntKeyIntChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        ...
        return new IntKeyIntMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 IntKeyIntChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
