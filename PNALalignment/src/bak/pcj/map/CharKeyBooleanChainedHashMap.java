 ...
 *  char values to boolean values.
 *
 *  @see        CharKeyBooleanOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class CharKeyBooleanChainedHashMap extends AbstractCharKeyBooleanMap implements CharKeyBooleanMap, Cloneable, Serializable {
    ...
    private CharKeyBooleanChainedHashMap(CharHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private CharKeyBooleanChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public CharKeyBooleanChainedHashMap() {
     ...
     */
    public CharKeyBooleanChainedHashMap(CharKeyBooleanMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public CharKeyBooleanChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public CharKeyBooleanChainedHashMap(double loadFactor) {
     ...
     */
    public CharKeyBooleanChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public CharKeyBooleanChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public CharKeyBooleanChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public CharKeyBooleanChainedHashMap(CharHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyBooleanChainedHashMap(CharHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyBooleanChainedHashMap(CharHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyBooleanChainedHashMap(CharHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyBooleanChainedHashMap(CharHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyBooleanChainedHashMap(CharHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            CharKeyBooleanChainedHashMap c = (CharKeyBooleanChainedHashMap)super.clone();
        ...
        return new CharKeyBooleanMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 CharKeyBooleanChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractCharSet {
        ...
        public void clear()
        { CharKeyBooleanChainedHashMap.this.clear(); }
        ...
        public boolean remove(char v) {
            ...
            if (result)
                CharKeyBooleanChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        CharKeyBooleanMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
