 ...
 *  float values to boolean values.
 *
 *  @see        FloatKeyBooleanOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class FloatKeyBooleanChainedHashMap extends AbstractFloatKeyBooleanMap implements FloatKeyBooleanMap, Cloneable, Serializable {
    ...
    private FloatKeyBooleanChainedHashMap(FloatHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private FloatKeyBooleanChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public FloatKeyBooleanChainedHashMap() {
     ...
     */
    public FloatKeyBooleanChainedHashMap(FloatKeyBooleanMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public FloatKeyBooleanChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public FloatKeyBooleanChainedHashMap(double loadFactor) {
     ...
     */
    public FloatKeyBooleanChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public FloatKeyBooleanChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public FloatKeyBooleanChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public FloatKeyBooleanChainedHashMap(FloatHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyBooleanChainedHashMap(FloatHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyBooleanChainedHashMap(FloatHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyBooleanChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyBooleanChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyBooleanChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            FloatKeyBooleanChainedHashMap c = (FloatKeyBooleanChainedHashMap)super.clone();
        ...
        return new FloatKeyBooleanMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 FloatKeyBooleanChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractFloatSet {
        ...
        public void clear()
        { FloatKeyBooleanChainedHashMap.this.clear(); }
        ...
        public boolean remove(float v) {
            ...
            if (result)
                FloatKeyBooleanChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        FloatKeyBooleanMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
