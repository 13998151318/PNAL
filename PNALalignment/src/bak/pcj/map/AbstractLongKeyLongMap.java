 ...
 *  maps from long values to long values. All operations that can be implemented
 *  using iterators
...
public abstract class AbstractLongKeyLongMap implements LongKeyLongMap {
    ...
    protected AbstractLongKeyLongMap() { }
    ...
    public void putAll(LongKeyLongMap map) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof LongKeyLongMap))
            return false;
        LongKeyLongMap map = (LongKeyLongMap)obj;
        if (size() != map.size())
            return false;
        LongKeyLongMapIterator i = entries();
        while (i.hasNext()) {
    ...
    public int hashCode() {
        ...
        while (i.hasNext()) {
            i.next();
            h += (DefaultLongHashFunction.INSTANCE.hash(i.getKey()) ^ DefaultLongHashFunction.INSTANCE.hash(i.getValue()));
        }
        return h;
    }
