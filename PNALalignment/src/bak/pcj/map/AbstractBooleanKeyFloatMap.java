 ...
 *  maps from boolean values to float values. All operations that can be implemented
 *  using iterators
...
public abstract class AbstractBooleanKeyFloatMap implements BooleanKeyFloatMap {
    ...
    protected AbstractBooleanKeyFloatMap() { }

    public void clear() {
        BooleanKeyFloatMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
            i.remove();
        }
    ...
    public void putAll(BooleanKeyFloatMap map) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BooleanKeyFloatMap))
            return false;
        BooleanKeyFloatMap map = (BooleanKeyFloatMap)obj;
        if (size() != map.size())
            return false;
        BooleanKeyFloatMapIterator i = entries();
        while (i.hasNext()) {
    ...
    public int hashCode() {
        ...
        while (i.hasNext()) {
            i.next();
            h += (DefaultBooleanHashFunction.INSTANCE.hash(i.getKey()) ^ DefaultFloatHashFunction.INSTANCE.hash(i.getValue()));
        }
        return h;
    }
