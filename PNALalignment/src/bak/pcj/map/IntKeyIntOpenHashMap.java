 ...
 *  int values to int values.
 *
 *  @see        IntKeyIntChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class IntKeyIntOpenHashMap extends AbstractIntKeyIntMap implements IntKeyIntMap, Cloneable, Serializable {
    ...
    private IntKeyIntOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public IntKeyIntOpenHashMap(IntKeyIntMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public IntKeyIntOpenHashMap(int capacity) {
     ...
     */
    public IntKeyIntOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public IntKeyIntOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public IntKeyIntOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public IntKeyIntOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public IntKeyIntOpenHashMap(IntHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyIntOpenHashMap(IntHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyIntOpenHashMap(IntHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyIntOpenHashMap(IntHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyIntOpenHashMap(IntHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyIntOpenHashMap(IntHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            IntKeyIntOpenHashMap c = (IntKeyIntOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractIntSet {
        ...
        public void clear()
        { IntKeyIntOpenHashMap.this.clear(); }
        ...
        public boolean remove(int v) {
            ...
            if (result)
                IntKeyIntOpenHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        IntKeyIntMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
            s.writeInt(i.getKey());
