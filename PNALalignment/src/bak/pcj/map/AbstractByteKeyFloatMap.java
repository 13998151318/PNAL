...
public abstract class AbstractByteKeyFloatMap implements ByteKeyFloatMap {
    ...
    protected AbstractByteKeyFloatMap() { }
    ...
    public void putAll(ByteKeyFloatMap map) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ByteKeyFloatMap))
            return false;
        ByteKeyFloatMap map = (ByteKeyFloatMap)obj;
        if (size() != map.size())
            return false;
        ByteKeyFloatMapIterator i = entries();
        while (i.hasNext()) {
    ...
    public int hashCode() {
        ...
        while (i.hasNext()) {
            i.next();
            h += (DefaultByteHashFunction.INSTANCE.hash(i.getKey()) ^ DefaultFloatHashFunction.INSTANCE.hash(i.getValue()));
        }
        return h;
    }
