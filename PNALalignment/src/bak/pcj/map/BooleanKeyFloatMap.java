 ...
 *
 *  @see        bak.pcj.map.BooleanKeyFloatMapIterator
 *  @see        java.util.Map
 *
...
public interface BooleanKeyFloatMap {
     ...
     *  @see        MapDefaults
     */
    float put(boolean key, float value);
     ...
     *              if the operation is not supported by this map.
     */
    void putAll(BooleanKeyFloatMap map);
