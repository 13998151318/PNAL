 ...
 *  maps from boolean values to int values. All operations that can be implemented
 *  using iterators
 ...
 *  @since      1.0
 */
public abstract class AbstractBooleanKeyIntMap implements BooleanKeyIntMap {

    /** Default constructor to be invoked by sub-classes. */
    protected AbstractBooleanKeyIntMap() { }

    public void clear() {
        BooleanKeyIntMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
            i.remove();
        }
