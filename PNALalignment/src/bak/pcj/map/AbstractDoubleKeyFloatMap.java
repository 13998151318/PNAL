 ...
 *  maps from double values to float values. All operations that can be implemented
 *  using iterators
 ...
 *  @since      1.0
 */
public abstract class AbstractDoubleKeyFloatMap implements DoubleKeyFloatMap {
