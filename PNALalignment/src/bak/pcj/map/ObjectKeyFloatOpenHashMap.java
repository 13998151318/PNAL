 ...
 *
 *  @see        ObjectKeyFloatChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.1
 */
public class ObjectKeyFloatOpenHashMap extends AbstractObjectKeyFloatMap implements ObjectKeyFloatMap, Cloneable, Serializable {
    ...
    private ObjectKeyFloatOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (capacity < 0)
     ...
     */
    public ObjectKeyFloatOpenHashMap() {
     ...
     */
    public ObjectKeyFloatOpenHashMap(ObjectKeyFloatMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ObjectKeyFloatOpenHashMap(int capacity) {
     ...
     */
    public ObjectKeyFloatOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public ObjectKeyFloatOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public ObjectKeyFloatOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ObjectKeyFloatOpenHashMap(int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ObjectKeyFloatOpenHashMap c = (ObjectKeyFloatOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractSet {
        ...
        public void clear()
        { ObjectKeyFloatOpenHashMap.this.clear(); }
        ...
        public boolean remove(Object v) {
            ...
            if (result)
                ObjectKeyFloatOpenHashMap.this.remove(v);
            return result;
        }
