 ...
 *
 *  @see        bak.pcj.map.BooleanKeyByteMapIterator
 *  @see        java.util.Map
 *
...
public interface BooleanKeyByteMap {
     ...
     *  from {@link #containsKey(boolean) containsKey(boolean)}. This is useful
     ...
     *              last invokation of 
     *              {@link #containsKey(boolean) containsKey(boolean)}.
     *
     *  @throws     IllegalStateException
     *              if {@link #containsKey(boolean) containsKey(boolean)} has
     *              not been called or the last call resulted in
     *              a return value of <tt>false</tt>.
     *
     *  @see        #get(boolean)
     *  @see        #tget(boolean)
     *  @see        #containsKey(boolean)
     */
    byte lget();
     ...
     *  @see        MapDefaults
     */
    byte put(boolean key, byte value);
     ...
     *              if the operation is not supported by this map.
     */
    void putAll(BooleanKeyByteMap map);
