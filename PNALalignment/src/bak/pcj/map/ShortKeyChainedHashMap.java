 ...
 *  short values to objects.
 *
 *  @see        ShortKeyOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ShortKeyChainedHashMap extends AbstractShortKeyMap implements ShortKeyMap, Cloneable, Serializable {
    ...
    private ShortKeyChainedHashMap(ShortHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ShortKeyChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ShortKeyChainedHashMap(ShortKeyMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ShortKeyChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public ShortKeyChainedHashMap(double loadFactor) {
     ...
     */
    public ShortKeyChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public ShortKeyChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ShortKeyChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ShortKeyChainedHashMap(ShortHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyChainedHashMap(ShortHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyChainedHashMap(ShortHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyChainedHashMap(ShortHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyChainedHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyChainedHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ShortKeyChainedHashMap c = (ShortKeyChainedHashMap)super.clone();
        ...
        return new ShortKeyMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 ShortKeyChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractShortSet {
        ...
        public void clear()
        { ShortKeyChainedHashMap.this.clear(); }
        ...
        public boolean remove(short v) {
            ...
            if (result)
                ShortKeyChainedHashMap.this.remove(v);
            return result;
        }
