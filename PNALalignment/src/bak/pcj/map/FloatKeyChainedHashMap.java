 ...
 *  float values to objects.
 *
 *  @see        FloatKeyOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class FloatKeyChainedHashMap extends AbstractFloatKeyMap implements FloatKeyMap, Cloneable, Serializable {
    ...
    private FloatKeyChainedHashMap(FloatHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private FloatKeyChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public FloatKeyChainedHashMap(FloatKeyMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public FloatKeyChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public FloatKeyChainedHashMap(double loadFactor) {
     ...
     */
    public FloatKeyChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public FloatKeyChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public FloatKeyChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public FloatKeyChainedHashMap(FloatHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyChainedHashMap(FloatHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyChainedHashMap(FloatHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            FloatKeyChainedHashMap c = (FloatKeyChainedHashMap)super.clone();
        ...
        return new FloatKeyMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 FloatKeyChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractFloatSet {
        ...
        public void clear()
        { FloatKeyChainedHashMap.this.clear(); }
        ...
        public boolean remove(float v) {
            ...
            if (result)
                FloatKeyChainedHashMap.this.remove(v);
            return result;
        }
