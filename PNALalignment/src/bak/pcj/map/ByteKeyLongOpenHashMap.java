 ...
 *  @since      1.0
 */
public class ByteKeyLongOpenHashMap extends AbstractByteKeyLongMap implements ByteKeyLongMap, Cloneable, Serializable {
    ...
    private ByteKeyLongOpenHashMap(ByteHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ByteKeyLongOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ByteKeyLongOpenHashMap(ByteKeyLongMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ByteKeyLongOpenHashMap(int capacity) {
     ...
     */
    public ByteKeyLongOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public ByteKeyLongOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public ByteKeyLongOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ByteKeyLongOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ByteKeyLongOpenHashMap(ByteHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyLongOpenHashMap(ByteHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyLongOpenHashMap(ByteHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyLongOpenHashMap(ByteHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyLongOpenHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyLongOpenHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ByteKeyLongOpenHashMap c = (ByteKeyLongOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractByteSet {
        ...
        public void clear()
        { ByteKeyLongOpenHashMap.this.clear(); }
        ...
        public boolean remove(byte v) {
            ...
            if (result)
                ByteKeyLongOpenHashMap.this.remove(v);
            return result;
        }
