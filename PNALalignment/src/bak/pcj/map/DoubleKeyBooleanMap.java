 ...
 *
 *  @see        bak.pcj.map.DoubleKeyBooleanMapIterator
 *  @see        java.util.Map
 *
...
public interface DoubleKeyBooleanMap {
     ...
     *  from {@link #containsKey(double) containsKey(double)}. This is useful
     ...
     *              last invokation of 
     *              {@link #containsKey(double) containsKey(double)}.
     *
     *  @throws     IllegalStateException
     *              if {@link #containsKey(double) containsKey(double)} has
     ...
     *              if the operation is not supported by this map.
     */
    void putAll(DoubleKeyBooleanMap map);
