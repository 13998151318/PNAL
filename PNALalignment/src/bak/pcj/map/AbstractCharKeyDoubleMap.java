 ...
 *  maps from char values to double values. All operations that can be implemented
 *  using iterators
...
public abstract class AbstractCharKeyDoubleMap implements CharKeyDoubleMap {
    ...
    protected AbstractCharKeyDoubleMap() { }
    ...
    public void putAll(CharKeyDoubleMap map) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof CharKeyDoubleMap))
            return false;
        CharKeyDoubleMap map = (CharKeyDoubleMap)obj;
        if (size() != map.size())
            return false;
        CharKeyDoubleMapIterator i = entries();
        while (i.hasNext()) {
    ...
    public int hashCode() {
        ...
        while (i.hasNext()) {
            i.next();
            h += (DefaultCharHashFunction.INSTANCE.hash(i.getKey()) ^ DefaultDoubleHashFunction.INSTANCE.hash(i.getValue()));
        }
        return h;
    }
