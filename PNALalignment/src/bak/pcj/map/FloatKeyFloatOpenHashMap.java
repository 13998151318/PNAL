 ...
 *
 *  @see        FloatKeyFloatChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class FloatKeyFloatOpenHashMap extends AbstractFloatKeyFloatMap implements FloatKeyFloatMap, Cloneable, Serializable {
    ...
    private FloatKeyFloatOpenHashMap(FloatHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private FloatKeyFloatOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public FloatKeyFloatOpenHashMap() {
     ...
     */
    public FloatKeyFloatOpenHashMap(FloatKeyFloatMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public FloatKeyFloatOpenHashMap(int capacity) {
     ...
     */
    public FloatKeyFloatOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public FloatKeyFloatOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public FloatKeyFloatOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public FloatKeyFloatOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public FloatKeyFloatOpenHashMap(FloatHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyFloatOpenHashMap(FloatHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyFloatOpenHashMap(FloatHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyFloatOpenHashMap(FloatHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyFloatOpenHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyFloatOpenHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            FloatKeyFloatOpenHashMap c = (FloatKeyFloatOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractFloatSet {
        ...
        public void clear()
        { FloatKeyFloatOpenHashMap.this.clear(); }
        ...
        public boolean remove(float v) {
            ...
            if (result)
                FloatKeyFloatOpenHashMap.this.remove(v);
            return result;
        }
