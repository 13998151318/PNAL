 ...
 *
 *  @see        DoubleKeyBooleanOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class DoubleKeyBooleanChainedHashMap extends AbstractDoubleKeyBooleanMap implements DoubleKeyBooleanMap, Cloneable, Serializable {
        ...
        return new DoubleKeyBooleanMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 DoubleKeyBooleanChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
