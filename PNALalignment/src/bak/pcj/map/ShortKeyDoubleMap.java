 ...
 *
 *  @see        bak.pcj.map.ShortKeyDoubleMapIterator
 *  @see        java.util.Map
 *
...
public interface ShortKeyDoubleMap {
     ...
     *  from {@link #containsKey(short) containsKey(short)}. This is useful
     ...
     *              last invokation of 
     *              {@link #containsKey(short) containsKey(short)}.
     *
     *  @throws     IllegalStateException
     *              if {@link #containsKey(short) containsKey(short)} has
     ...
     *              if the operation is not supported by this map.
     */
    void putAll(ShortKeyDoubleMap map);
