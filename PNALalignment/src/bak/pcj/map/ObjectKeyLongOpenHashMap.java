 ...
 *  object values to long values.
 *
 *  @see        ObjectKeyLongChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.1
 */
public class ObjectKeyLongOpenHashMap extends AbstractObjectKeyLongMap implements ObjectKeyLongMap, Cloneable, Serializable {
    ...
    private ObjectKeyLongOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (capacity < 0)
     ...
     */
    public ObjectKeyLongOpenHashMap() {
     ...
     */
    public ObjectKeyLongOpenHashMap(ObjectKeyLongMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ObjectKeyLongOpenHashMap(int capacity) {
     ...
     */
    public ObjectKeyLongOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public ObjectKeyLongOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public ObjectKeyLongOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ObjectKeyLongOpenHashMap(int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ObjectKeyLongOpenHashMap c = (ObjectKeyLongOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractSet {
        ...
        public void clear()
        { ObjectKeyLongOpenHashMap.this.clear(); }
        ...
        public boolean remove(Object v) {
            ...
            if (result)
                ObjectKeyLongOpenHashMap.this.remove(v);
            return result;
        }
