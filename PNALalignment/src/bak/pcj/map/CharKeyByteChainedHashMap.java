 ...
 *  char values to byte values.
 *
 *  @see        CharKeyByteOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class CharKeyByteChainedHashMap extends AbstractCharKeyByteMap implements CharKeyByteMap, Cloneable, Serializable {
    ...
    private CharKeyByteChainedHashMap(CharHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private CharKeyByteChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public CharKeyByteChainedHashMap() {
     ...
     */
    public CharKeyByteChainedHashMap(CharKeyByteMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public CharKeyByteChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public CharKeyByteChainedHashMap(double loadFactor) {
     ...
     */
    public CharKeyByteChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public CharKeyByteChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public CharKeyByteChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public CharKeyByteChainedHashMap(CharHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyByteChainedHashMap(CharHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyByteChainedHashMap(CharHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyByteChainedHashMap(CharHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyByteChainedHashMap(CharHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyByteChainedHashMap(CharHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            CharKeyByteChainedHashMap c = (CharKeyByteChainedHashMap)super.clone();
        ...
        return new CharKeyByteMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 CharKeyByteChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractCharSet {
        ...
        public void clear()
        { CharKeyByteChainedHashMap.this.clear(); }
        ...
        public boolean remove(char v) {
            ...
            if (result)
                CharKeyByteChainedHashMap.this.remove(v);
            return result;
        }
