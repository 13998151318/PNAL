 ...
 *  byte values to char values.
 *
 *  @see        ByteKeyCharOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ByteKeyCharChainedHashMap extends AbstractByteKeyCharMap implements ByteKeyCharMap, Cloneable, Serializable {
    ...
    private ByteKeyCharChainedHashMap(ByteHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ByteKeyCharChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ByteKeyCharChainedHashMap() {
     ...
     */
    public ByteKeyCharChainedHashMap(ByteKeyCharMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ByteKeyCharChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public ByteKeyCharChainedHashMap(double loadFactor) {
     ...
     */
    public ByteKeyCharChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public ByteKeyCharChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ByteKeyCharChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ByteKeyCharChainedHashMap(ByteHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyCharChainedHashMap(ByteHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyCharChainedHashMap(ByteHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyCharChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyCharChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyCharChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ByteKeyCharChainedHashMap c = (ByteKeyCharChainedHashMap)super.clone();
        ...
        return new ByteKeyCharMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 ByteKeyCharChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractByteSet {
        ...
        public void clear()
        { ByteKeyCharChainedHashMap.this.clear(); }
        ...
        public boolean remove(byte v) {
            ...
            if (result)
                ByteKeyCharChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        ByteKeyCharMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
