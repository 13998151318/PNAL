 ...
 *  maps from char values to char values. All operations that can be implemented
 *  using iterators
...
public abstract class AbstractCharKeyCharMap implements CharKeyCharMap {
    ...
    protected AbstractCharKeyCharMap() { }
    ...
    public void putAll(CharKeyCharMap map) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof CharKeyCharMap))
            return false;
        CharKeyCharMap map = (CharKeyCharMap)obj;
        if (size() != map.size())
            return false;
        CharKeyCharMapIterator i = entries();
        while (i.hasNext()) {
    ...
    public int hashCode() {
        ...
        while (i.hasNext()) {
            i.next();
            h += (DefaultCharHashFunction.INSTANCE.hash(i.getKey()) ^ DefaultCharHashFunction.INSTANCE.hash(i.getValue()));
        }
        return h;
    }
