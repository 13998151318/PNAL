 ...
 *  short values to long values.
 *
 *  @see        ShortKeyLongOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ShortKeyLongChainedHashMap extends AbstractShortKeyLongMap implements ShortKeyLongMap, Cloneable, Serializable {
    ...
    private ShortKeyLongChainedHashMap(ShortHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ShortKeyLongChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ShortKeyLongChainedHashMap() {
     ...
     */
    public ShortKeyLongChainedHashMap(ShortKeyLongMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ShortKeyLongChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public ShortKeyLongChainedHashMap(double loadFactor) {
     ...
     */
    public ShortKeyLongChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public ShortKeyLongChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ShortKeyLongChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ShortKeyLongChainedHashMap(ShortHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyLongChainedHashMap(ShortHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyLongChainedHashMap(ShortHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyLongChainedHashMap(ShortHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyLongChainedHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyLongChainedHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ShortKeyLongChainedHashMap c = (ShortKeyLongChainedHashMap)super.clone();
        ...
        return new ShortKeyLongMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 ShortKeyLongChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractShortSet {
        ...
        public void clear()
        { ShortKeyLongChainedHashMap.this.clear(); }
        ...
        public boolean remove(short v) {
            ...
            if (result)
                ShortKeyLongChainedHashMap.this.remove(v);
            return result;
        }
