 ...
 *  @since      1.0
 */
public class IntKeyLongOpenHashMap extends AbstractIntKeyLongMap implements IntKeyLongMap, Cloneable, Serializable {
    ...
    private IntKeyLongOpenHashMap(IntHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private IntKeyLongOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public IntKeyLongOpenHashMap(IntKeyLongMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public IntKeyLongOpenHashMap(int capacity) {
     ...
     */
    public IntKeyLongOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public IntKeyLongOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public IntKeyLongOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public IntKeyLongOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public IntKeyLongOpenHashMap(IntHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyLongOpenHashMap(IntHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyLongOpenHashMap(IntHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyLongOpenHashMap(IntHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyLongOpenHashMap(IntHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyLongOpenHashMap(IntHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            IntKeyLongOpenHashMap c = (IntKeyLongOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractIntSet {
        ...
        public void clear()
        { IntKeyLongOpenHashMap.this.clear(); }
        ...
        public boolean remove(int v) {
            ...
            if (result)
                IntKeyLongOpenHashMap.this.remove(v);
            return result;
        }
