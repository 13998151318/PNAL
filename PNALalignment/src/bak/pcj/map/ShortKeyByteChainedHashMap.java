 ...
 *  short values to byte values.
 *
 *  @see        ShortKeyByteOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ShortKeyByteChainedHashMap extends AbstractShortKeyByteMap implements ShortKeyByteMap, Cloneable, Serializable {
    ...
    private ShortKeyByteChainedHashMap(ShortHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ShortKeyByteChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ShortKeyByteChainedHashMap() {
     ...
     */
    public ShortKeyByteChainedHashMap(ShortKeyByteMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ShortKeyByteChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public ShortKeyByteChainedHashMap(double loadFactor) {
     ...
     */
    public ShortKeyByteChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public ShortKeyByteChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ShortKeyByteChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ShortKeyByteChainedHashMap(ShortHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyByteChainedHashMap(ShortHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyByteChainedHashMap(ShortHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyByteChainedHashMap(ShortHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyByteChainedHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyByteChainedHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ShortKeyByteChainedHashMap c = (ShortKeyByteChainedHashMap)super.clone();
        ...
        return new ShortKeyByteMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 ShortKeyByteChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractShortSet {
        ...
        public void clear()
        { ShortKeyByteChainedHashMap.this.clear(); }
        ...
        public boolean remove(short v) {
            ...
            if (result)
                ShortKeyByteChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        ShortKeyByteMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
