 ...
 *
 *  @see        bak.pcj.map.BooleanKeyLongMapIterator
 *  @see        java.util.Map
 *
...
public interface BooleanKeyLongMap {
     ...
     *  @see        MapDefaults
     */
    long put(boolean key, long value);
     ...
     *              if the operation is not supported by this map.
     */
    void putAll(BooleanKeyLongMap map);
