 ...
 *
 *  @see        DoubleKeyShortChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class DoubleKeyShortOpenHashMap extends AbstractDoubleKeyShortMap implements DoubleKeyShortMap, Cloneable, Serializable {
    ...
    private DoubleKeyShortOpenHashMap(DoubleHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private DoubleKeyShortOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public DoubleKeyShortOpenHashMap() {
     ...
     */
    public DoubleKeyShortOpenHashMap(DoubleKeyShortMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public DoubleKeyShortOpenHashMap(int capacity) {
     ...
     */
    public DoubleKeyShortOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public DoubleKeyShortOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public DoubleKeyShortOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public DoubleKeyShortOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public DoubleKeyShortOpenHashMap(DoubleHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyShortOpenHashMap(DoubleHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyShortOpenHashMap(DoubleHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyShortOpenHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyShortOpenHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyShortOpenHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            DoubleKeyShortOpenHashMap c = (DoubleKeyShortOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractDoubleSet {
        ...
        public void clear()
        { DoubleKeyShortOpenHashMap.this.clear(); }
        ...
        public boolean remove(double v) {
            ...
            if (result)
                DoubleKeyShortOpenHashMap.this.remove(v);
            return result;
        }
