 ...
 *  objects values to float values.
 *
 *  @see        bak.pcj.map.ObjectKeyFloatMap
 *  @see        bak.pcj.FloatIterator
 *
 *  @author     S&oslash;ren Bak
 *  @version    1.0     2003/3/3
 *  @since      1.1
 */
public interface ObjectKeyFloatMapIterator {

    /**
     *  Indicates whether more entries can be returned by this
     *  iterator.
     *
     *  @return     <tt>true</tt> if more float entries can be returned
