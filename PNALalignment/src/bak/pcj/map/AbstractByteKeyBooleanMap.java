 ...
 *  maps from byte values to boolean values. All operations that can be implemented
 *  using iterators
...
public abstract class AbstractByteKeyBooleanMap implements ByteKeyBooleanMap {
    ...
    protected AbstractByteKeyBooleanMap() { }
    ...
    public void putAll(ByteKeyBooleanMap map) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ByteKeyBooleanMap))
            return false;
        ByteKeyBooleanMap map = (ByteKeyBooleanMap)obj;
        if (size() != map.size())
            return false;
        ByteKeyBooleanMapIterator i = entries();
        while (i.hasNext()) {
    ...
    public int hashCode() {
        ...
        while (i.hasNext()) {
            i.next();
            h += (DefaultByteHashFunction.INSTANCE.hash(i.getKey()) ^ DefaultBooleanHashFunction.INSTANCE.hash(i.getValue()));
        }
        return h;
    }
