 ...
 *  @since      1.0
 */
public class CharKeyLongOpenHashMap extends AbstractCharKeyLongMap implements CharKeyLongMap, Cloneable, Serializable {
    ...
    private CharKeyLongOpenHashMap(CharHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private CharKeyLongOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public CharKeyLongOpenHashMap(CharKeyLongMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public CharKeyLongOpenHashMap(int capacity) {
     ...
     */
    public CharKeyLongOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public CharKeyLongOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public CharKeyLongOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public CharKeyLongOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public CharKeyLongOpenHashMap(CharHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyLongOpenHashMap(CharHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyLongOpenHashMap(CharHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyLongOpenHashMap(CharHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyLongOpenHashMap(CharHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyLongOpenHashMap(CharHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            CharKeyLongOpenHashMap c = (CharKeyLongOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractCharSet {
        ...
        public void clear()
        { CharKeyLongOpenHashMap.this.clear(); }
        ...
        public boolean remove(char v) {
            ...
            if (result)
                CharKeyLongOpenHashMap.this.remove(v);
            return result;
        }
