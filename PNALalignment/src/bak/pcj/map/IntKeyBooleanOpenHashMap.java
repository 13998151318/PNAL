 ...
 *
 *  @see        IntKeyBooleanChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class IntKeyBooleanOpenHashMap extends AbstractIntKeyBooleanMap implements IntKeyBooleanMap, Cloneable, Serializable {
