 ...
 *  byte values to short values.
 *
 *  @see        ByteKeyShortOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ByteKeyShortChainedHashMap extends AbstractByteKeyShortMap implements ByteKeyShortMap, Cloneable, Serializable {
    ...
    private ByteKeyShortChainedHashMap(ByteHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ByteKeyShortChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ByteKeyShortChainedHashMap() {
     ...
     */
    public ByteKeyShortChainedHashMap(ByteKeyShortMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ByteKeyShortChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public ByteKeyShortChainedHashMap(double loadFactor) {
     ...
     */
    public ByteKeyShortChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public ByteKeyShortChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ByteKeyShortChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ByteKeyShortChainedHashMap(ByteHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyShortChainedHashMap(ByteHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyShortChainedHashMap(ByteHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyShortChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyShortChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyShortChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ByteKeyShortChainedHashMap c = (ByteKeyShortChainedHashMap)super.clone();
        ...
        return new ByteKeyShortMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 ByteKeyShortChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractByteSet {
        ...
        public void clear()
        { ByteKeyShortChainedHashMap.this.clear(); }
        ...
        public boolean remove(byte v) {
            ...
            if (result)
                ByteKeyShortChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        ByteKeyShortMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
