 ...
 *
 *  @see        CharKeyShortChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class CharKeyShortOpenHashMap extends AbstractCharKeyShortMap implements CharKeyShortMap, Cloneable, Serializable {
    ...
    private CharKeyShortOpenHashMap(CharHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private CharKeyShortOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public CharKeyShortOpenHashMap() {
     ...
     */
    public CharKeyShortOpenHashMap(CharKeyShortMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public CharKeyShortOpenHashMap(int capacity) {
     ...
     */
    public CharKeyShortOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public CharKeyShortOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public CharKeyShortOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public CharKeyShortOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public CharKeyShortOpenHashMap(CharHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyShortOpenHashMap(CharHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyShortOpenHashMap(CharHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyShortOpenHashMap(CharHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyShortOpenHashMap(CharHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyShortOpenHashMap(CharHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            CharKeyShortOpenHashMap c = (CharKeyShortOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractCharSet {
        ...
        public void clear()
        { CharKeyShortOpenHashMap.this.clear(); }
        ...
        public boolean remove(char v) {
            ...
            if (result)
                CharKeyShortOpenHashMap.this.remove(v);
            return result;
        }
