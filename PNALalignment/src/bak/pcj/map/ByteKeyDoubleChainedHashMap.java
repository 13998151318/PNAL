 ...
 *  byte values to double values.
 *
 *  @see        ByteKeyDoubleOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ByteKeyDoubleChainedHashMap extends AbstractByteKeyDoubleMap implements ByteKeyDoubleMap, Cloneable, Serializable {
    ...
    private ByteKeyDoubleChainedHashMap(ByteHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ByteKeyDoubleChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ByteKeyDoubleChainedHashMap() {
     ...
     */
    public ByteKeyDoubleChainedHashMap(ByteKeyDoubleMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ByteKeyDoubleChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public ByteKeyDoubleChainedHashMap(double loadFactor) {
     ...
     */
    public ByteKeyDoubleChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public ByteKeyDoubleChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ByteKeyDoubleChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ByteKeyDoubleChainedHashMap(ByteHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyDoubleChainedHashMap(ByteHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyDoubleChainedHashMap(ByteHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyDoubleChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyDoubleChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyDoubleChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ByteKeyDoubleChainedHashMap c = (ByteKeyDoubleChainedHashMap)super.clone();
        ...
        return new ByteKeyDoubleMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 ByteKeyDoubleChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractByteSet {
        ...
        public void clear()
        { ByteKeyDoubleChainedHashMap.this.clear(); }
        ...
        public boolean remove(byte v) {
            ...
            if (result)
                ByteKeyDoubleChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        ByteKeyDoubleMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
