 ...
 *
 *  @see        bak.pcj.map.CharKeyByteMapIterator
 *  @see        java.util.Map
 *
...
public interface CharKeyByteMap {
     ...
     *  from {@link #containsKey(char) containsKey(char)}. This is useful
     ...
     *              last invokation of 
     *              {@link #containsKey(char) containsKey(char)}.
     *
     *  @throws     IllegalStateException
     *              if {@link #containsKey(char) containsKey(char)} has
     ...
     *              if the operation is not supported by this map.
     */
    void putAll(CharKeyByteMap map);
