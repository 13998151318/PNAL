 ...
 *
 *  @see        ObjectKeyBooleanChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.1
 */
public class ObjectKeyBooleanOpenHashMap extends AbstractObjectKeyBooleanMap implements ObjectKeyBooleanMap, Cloneable, Serializable {
    ...
    private ObjectKeyBooleanOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (capacity < 0)
     ...
     */
    public ObjectKeyBooleanOpenHashMap() {
     ...
     */
    public ObjectKeyBooleanOpenHashMap(ObjectKeyBooleanMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ObjectKeyBooleanOpenHashMap(int capacity) {
     ...
     */
    public ObjectKeyBooleanOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public ObjectKeyBooleanOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public ObjectKeyBooleanOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ObjectKeyBooleanOpenHashMap(int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ObjectKeyBooleanOpenHashMap c = (ObjectKeyBooleanOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractSet {
        ...
        public void clear()
        { ObjectKeyBooleanOpenHashMap.this.clear(); }
        ...
        public boolean remove(Object v) {
            ...
            if (result)
                ObjectKeyBooleanOpenHashMap.this.remove(v);
            return result;
        }
