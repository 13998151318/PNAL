 ...
 *
 *  @see        bak.pcj.map.BooleanKeyCharMapIterator
 *  @see        java.util.Map
 *
...
public interface BooleanKeyCharMap {
     ...
     *  @see        MapDefaults
     */
    char put(boolean key, char value);
     ...
     *              if the operation is not supported by this map.
     */
    void putAll(BooleanKeyCharMap map);
