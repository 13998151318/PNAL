 ...
 *  object values to double values.
 *
 *  @see        ObjectKeyDoubleOpenHashMap
 *  @see        java.util.Map
 *
 *  @author     S&oslash;ren Bak
 *  @version    1.1     2003/8/3
 *  @since      1.1
 */
public class ObjectKeyDoubleChainedHashMap extends AbstractObjectKeyDoubleMap implements ObjectKeyDoubleMap, Cloneable, Serializable {
    ...
    private ObjectKeyDoubleChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (capacity < 0)
     ...
     */
    public ObjectKeyDoubleChainedHashMap() {
     ...
     */
    public ObjectKeyDoubleChainedHashMap(ObjectKeyDoubleMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ObjectKeyDoubleChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public ObjectKeyDoubleChainedHashMap(double loadFactor) {
     ...
     */
    public ObjectKeyDoubleChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public ObjectKeyDoubleChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ObjectKeyDoubleChainedHashMap(int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ObjectKeyDoubleChainedHashMap c = (ObjectKeyDoubleChainedHashMap)super.clone();
    ...
    private static class Entry {
        ...
        public boolean equals(Object obj) {
            if (!(obj instanceof Entry))
                return false;
            Entry e = (Entry)obj;
            return keyeq(e.getKey(), key) && e.getValue() == value;
        }
    }
        ...
        return new ObjectKeyDoubleMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 ObjectKeyDoubleChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractSet {
        ...
        public void clear()
        { ObjectKeyDoubleChainedHashMap.this.clear(); }
        ...
        public boolean remove(Object v) {
            ...
            if (result)
                ObjectKeyDoubleChainedHashMap.this.remove(v);
            return result;
        }
