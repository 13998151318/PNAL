 ...
 *  long values to long values.
 *
 *  @see        LongKeyLongOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class LongKeyLongChainedHashMap extends AbstractLongKeyLongMap implements LongKeyLongMap, Cloneable, Serializable {
    ...
    private LongKeyLongChainedHashMap(LongHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private LongKeyLongChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public LongKeyLongChainedHashMap() {
     ...
     */
    public LongKeyLongChainedHashMap(LongKeyLongMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public LongKeyLongChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public LongKeyLongChainedHashMap(double loadFactor) {
     ...
     */
    public LongKeyLongChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public LongKeyLongChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public LongKeyLongChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public LongKeyLongChainedHashMap(LongHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyLongChainedHashMap(LongHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyLongChainedHashMap(LongHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyLongChainedHashMap(LongHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyLongChainedHashMap(LongHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyLongChainedHashMap(LongHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            LongKeyLongChainedHashMap c = (LongKeyLongChainedHashMap)super.clone();
        ...
        return new LongKeyLongMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 LongKeyLongChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractLongSet {
        ...
        public void clear()
        { LongKeyLongChainedHashMap.this.clear(); }
        ...
        public boolean remove(long v) {
            ...
            if (result)
                LongKeyLongChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        LongKeyLongMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
