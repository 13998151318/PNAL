 ...
 *  double values to char values.
 *
 *  @see        DoubleKeyCharOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class DoubleKeyCharChainedHashMap extends AbstractDoubleKeyCharMap implements DoubleKeyCharMap, Cloneable, Serializable {
    ...
    private DoubleKeyCharChainedHashMap(DoubleHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private DoubleKeyCharChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public DoubleKeyCharChainedHashMap() {
     ...
     */
    public DoubleKeyCharChainedHashMap(DoubleKeyCharMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public DoubleKeyCharChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public DoubleKeyCharChainedHashMap(double loadFactor) {
     ...
     */
    public DoubleKeyCharChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public DoubleKeyCharChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public DoubleKeyCharChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public DoubleKeyCharChainedHashMap(DoubleHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyCharChainedHashMap(DoubleHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyCharChainedHashMap(DoubleHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyCharChainedHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyCharChainedHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyCharChainedHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            DoubleKeyCharChainedHashMap c = (DoubleKeyCharChainedHashMap)super.clone();
        ...
        return new DoubleKeyCharMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 DoubleKeyCharChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractDoubleSet {
        ...
        public void clear()
        { DoubleKeyCharChainedHashMap.this.clear(); }
        ...
        public boolean remove(double v) {
            ...
            if (result)
                DoubleKeyCharChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        DoubleKeyCharMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
