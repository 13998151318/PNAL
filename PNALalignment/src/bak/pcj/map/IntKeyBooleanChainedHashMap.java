 ...
 *  int values to boolean values.
 *
 *  @see        IntKeyBooleanOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class IntKeyBooleanChainedHashMap extends AbstractIntKeyBooleanMap implements IntKeyBooleanMap, Cloneable, Serializable {
    ...
    private IntKeyBooleanChainedHashMap(IntHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private IntKeyBooleanChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public IntKeyBooleanChainedHashMap() {
     ...
     */
    public IntKeyBooleanChainedHashMap(IntKeyBooleanMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public IntKeyBooleanChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public IntKeyBooleanChainedHashMap(double loadFactor) {
     ...
     */
    public IntKeyBooleanChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public IntKeyBooleanChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public IntKeyBooleanChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public IntKeyBooleanChainedHashMap(IntHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyBooleanChainedHashMap(IntHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyBooleanChainedHashMap(IntHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyBooleanChainedHashMap(IntHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyBooleanChainedHashMap(IntHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyBooleanChainedHashMap(IntHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            IntKeyBooleanChainedHashMap c = (IntKeyBooleanChainedHashMap)super.clone();
        ...
        return new IntKeyBooleanMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 IntKeyBooleanChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractIntSet {
        ...
        public void clear()
        { IntKeyBooleanChainedHashMap.this.clear(); }
        ...
        public boolean remove(int v) {
            ...
            if (result)
                IntKeyBooleanChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        IntKeyBooleanMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
            s.writeInt(i.getKey());
