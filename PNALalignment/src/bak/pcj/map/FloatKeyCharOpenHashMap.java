 ...
 *
 *  @see        FloatKeyCharChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class FloatKeyCharOpenHashMap extends AbstractFloatKeyCharMap implements FloatKeyCharMap, Cloneable, Serializable {
    ...
    private FloatKeyCharOpenHashMap(FloatHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private FloatKeyCharOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public FloatKeyCharOpenHashMap() {
     ...
     */
    public FloatKeyCharOpenHashMap(FloatKeyCharMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public FloatKeyCharOpenHashMap(int capacity) {
     ...
     */
    public FloatKeyCharOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public FloatKeyCharOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public FloatKeyCharOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public FloatKeyCharOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public FloatKeyCharOpenHashMap(FloatHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyCharOpenHashMap(FloatHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyCharOpenHashMap(FloatHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyCharOpenHashMap(FloatHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyCharOpenHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyCharOpenHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            FloatKeyCharOpenHashMap c = (FloatKeyCharOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractFloatSet {
        ...
        public void clear()
        { FloatKeyCharOpenHashMap.this.clear(); }
        ...
        public boolean remove(float v) {
            ...
            if (result)
                FloatKeyCharOpenHashMap.this.remove(v);
            return result;
        }
