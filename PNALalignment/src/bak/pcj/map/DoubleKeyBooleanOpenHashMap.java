 ...
 *  double values to boolean values.
 *
 *  @see        DoubleKeyBooleanChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class DoubleKeyBooleanOpenHashMap extends AbstractDoubleKeyBooleanMap implements DoubleKeyBooleanMap, Cloneable, Serializable {
    ...
    private DoubleKeyBooleanOpenHashMap(DoubleHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private DoubleKeyBooleanOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public DoubleKeyBooleanOpenHashMap() {
     ...
     */
    public DoubleKeyBooleanOpenHashMap(DoubleKeyBooleanMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public DoubleKeyBooleanOpenHashMap(int capacity) {
     ...
     */
    public DoubleKeyBooleanOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public DoubleKeyBooleanOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public DoubleKeyBooleanOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public DoubleKeyBooleanOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public DoubleKeyBooleanOpenHashMap(DoubleHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyBooleanOpenHashMap(DoubleHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyBooleanOpenHashMap(DoubleHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyBooleanOpenHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyBooleanOpenHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyBooleanOpenHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            DoubleKeyBooleanOpenHashMap c = (DoubleKeyBooleanOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractDoubleSet {
        ...
        public void clear()
        { DoubleKeyBooleanOpenHashMap.this.clear(); }
        ...
        public boolean remove(double v) {
            ...
            if (result)
                DoubleKeyBooleanOpenHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        DoubleKeyBooleanMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
