 ...
 *  long values to short values.
 *
 *  @see        LongKeyShortOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class LongKeyShortChainedHashMap extends AbstractLongKeyShortMap implements LongKeyShortMap, Cloneable, Serializable {
    ...
    private LongKeyShortChainedHashMap(LongHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private LongKeyShortChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public LongKeyShortChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public LongKeyShortChainedHashMap(double loadFactor) {
     ...
     */
    public LongKeyShortChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public LongKeyShortChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public LongKeyShortChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public LongKeyShortChainedHashMap(LongHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyShortChainedHashMap(LongHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyShortChainedHashMap(LongHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyShortChainedHashMap(LongHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyShortChainedHashMap(LongHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyShortChainedHashMap(LongHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            LongKeyShortChainedHashMap c = (LongKeyShortChainedHashMap)super.clone();
        ...
        return new LongKeyShortMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 LongKeyShortChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractLongSet {
        ...
        public void clear()
        { LongKeyShortChainedHashMap.this.clear(); }
        ...
        public boolean remove(long v) {
            ...
            if (result)
                LongKeyShortChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        LongKeyShortMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
