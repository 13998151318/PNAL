 ...
 *
 *  @see        IntKeyDoubleChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class IntKeyDoubleOpenHashMap extends AbstractIntKeyDoubleMap implements IntKeyDoubleMap, Cloneable, Serializable {
    ...
    private IntKeyDoubleOpenHashMap(IntHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private IntKeyDoubleOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public IntKeyDoubleOpenHashMap() {
     ...
     */
    public IntKeyDoubleOpenHashMap(IntKeyDoubleMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public IntKeyDoubleOpenHashMap(int capacity) {
     ...
     */
    public IntKeyDoubleOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public IntKeyDoubleOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public IntKeyDoubleOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public IntKeyDoubleOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public IntKeyDoubleOpenHashMap(IntHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyDoubleOpenHashMap(IntHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyDoubleOpenHashMap(IntHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyDoubleOpenHashMap(IntHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyDoubleOpenHashMap(IntHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyDoubleOpenHashMap(IntHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            IntKeyDoubleOpenHashMap c = (IntKeyDoubleOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractIntSet {
        ...
        public void clear()
        { IntKeyDoubleOpenHashMap.this.clear(); }
        ...
        public boolean remove(int v) {
            ...
            if (result)
                IntKeyDoubleOpenHashMap.this.remove(v);
            return result;
        }
