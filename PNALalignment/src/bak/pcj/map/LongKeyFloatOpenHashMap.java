 ...
 *  long values to float values.
 *
 *  @see        LongKeyFloatChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class LongKeyFloatOpenHashMap extends AbstractLongKeyFloatMap implements LongKeyFloatMap, Cloneable, Serializable {
    ...
    private LongKeyFloatOpenHashMap(LongHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private LongKeyFloatOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public LongKeyFloatOpenHashMap() {
     ...
     */
    public LongKeyFloatOpenHashMap(LongKeyFloatMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public LongKeyFloatOpenHashMap(int capacity) {
     ...
     */
    public LongKeyFloatOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public LongKeyFloatOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public LongKeyFloatOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public LongKeyFloatOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public LongKeyFloatOpenHashMap(LongHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyFloatOpenHashMap(LongHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyFloatOpenHashMap(LongHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyFloatOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyFloatOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyFloatOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            LongKeyFloatOpenHashMap c = (LongKeyFloatOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractLongSet {
        ...
        public void clear()
        { LongKeyFloatOpenHashMap.this.clear(); }
        ...
        public boolean remove(long v) {
            ...
            if (result)
                LongKeyFloatOpenHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        LongKeyFloatMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
