 ...
 *  @since      1.0
 */
public class BooleanKeyChainedHashMap extends AbstractBooleanKeyMap implements BooleanKeyMap, Cloneable, Serializable {
    ...
    private transient BooleanSet keys;

    /** A collection view of the values of this map. */
    private transient Collection values;

    private BooleanKeyChainedHashMap(BooleanHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private BooleanKeyChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public BooleanKeyChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public BooleanKeyChainedHashMap(double loadFactor) {
     ...
     */
    public BooleanKeyChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public BooleanKeyChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public BooleanKeyChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public BooleanKeyChainedHashMap(BooleanHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public BooleanKeyChainedHashMap(BooleanHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public BooleanKeyChainedHashMap(BooleanHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public BooleanKeyChainedHashMap(BooleanHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public BooleanKeyChainedHashMap(BooleanHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public BooleanKeyChainedHashMap(BooleanHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    private Entry searchList(Entry list, boolean key) {
        while (list != null) {
            if (list.key == key)
                return list;
            list = list.next;
    ...
    private Entry getEntry(boolean key) {
    ...
    public Object clone() {
        try {
            BooleanKeyChainedHashMap c = (BooleanKeyChainedHashMap)super.clone();
    ...
    private static class Entry {
        ...
        Entry(boolean key, Object value) {
            this.key = key;
            this.value = value;
        }
        ...
        return new BooleanKeyMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 BooleanKeyChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractBooleanSet {
        ...
        public void clear()
        { BooleanKeyChainedHashMap.this.clear(); }
        ...
        public boolean remove(boolean v) {
            ...
            if (result)
                BooleanKeyChainedHashMap.this.remove(v);
            return result;
        }
