 ...
 *  objects values to short values.
 *
 *  @see        bak.pcj.map.ObjectKeyShortMap
 *  @see        bak.pcj.ShortIterator
 *
 *  @author     S&oslash;ren Bak
 *  @version    1.0     2003/3/3
 *  @since      1.1
 */
public interface ObjectKeyShortMapIterator {

    /**
     *  Indicates whether more entries can be returned by this
     *  iterator.
     *
     *  @return     <tt>true</tt> if more short entries can be returned
