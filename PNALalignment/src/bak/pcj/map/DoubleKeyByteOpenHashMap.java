 ...
 *
 *  @see        DoubleKeyByteChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class DoubleKeyByteOpenHashMap extends AbstractDoubleKeyByteMap implements DoubleKeyByteMap, Cloneable, Serializable {
    ...
    private DoubleKeyByteOpenHashMap(DoubleHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private DoubleKeyByteOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public DoubleKeyByteOpenHashMap() {
     ...
     */
    public DoubleKeyByteOpenHashMap(DoubleKeyByteMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public DoubleKeyByteOpenHashMap(int capacity) {
     ...
     */
    public DoubleKeyByteOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public DoubleKeyByteOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public DoubleKeyByteOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public DoubleKeyByteOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public DoubleKeyByteOpenHashMap(DoubleHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyByteOpenHashMap(DoubleHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyByteOpenHashMap(DoubleHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyByteOpenHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyByteOpenHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyByteOpenHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            DoubleKeyByteOpenHashMap c = (DoubleKeyByteOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractDoubleSet {
        ...
        public void clear()
        { DoubleKeyByteOpenHashMap.this.clear(); }
        ...
        public boolean remove(double v) {
            ...
            if (result)
                DoubleKeyByteOpenHashMap.this.remove(v);
            return result;
        }
