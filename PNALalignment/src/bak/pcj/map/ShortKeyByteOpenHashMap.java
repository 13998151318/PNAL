 ...
 *
 *  @see        ShortKeyByteChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ShortKeyByteOpenHashMap extends AbstractShortKeyByteMap implements ShortKeyByteMap, Cloneable, Serializable {
    ...
    private transient ByteCollection cvalues;
    ...
    private ShortKeyByteOpenHashMap(ShortHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ShortKeyByteOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ShortKeyByteOpenHashMap() {
     ...
     */
    public ShortKeyByteOpenHashMap(ShortKeyByteMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ShortKeyByteOpenHashMap(int capacity) {
     ...
     */
    public ShortKeyByteOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public ShortKeyByteOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public ShortKeyByteOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ShortKeyByteOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ShortKeyByteOpenHashMap(ShortHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyByteOpenHashMap(ShortHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyByteOpenHashMap(ShortHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyByteOpenHashMap(ShortHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyByteOpenHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyByteOpenHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ShortKeyByteOpenHashMap c = (ShortKeyByteOpenHashMap)super.clone();
            c.keys = new short[keys.length];
            System.arraycopy(keys, 0, c.keys, 0, keys.length);
            c.values = new byte[values.length];
    ...
    private class KeySet extends AbstractShortSet {
        ...
        public void clear()
        { ShortKeyByteOpenHashMap.this.clear(); }
        ...
        public boolean remove(short v) {
            ...
            if (result)
                ShortKeyByteOpenHashMap.this.remove(v);
            return result;
        }
