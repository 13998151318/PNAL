 ...
 *
 *  @see        DoubleKeyCharChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class DoubleKeyCharOpenHashMap extends AbstractDoubleKeyCharMap implements DoubleKeyCharMap, Cloneable, Serializable {
    ...
    private transient CharCollection cvalues;
    ...
    private DoubleKeyCharOpenHashMap(DoubleHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private DoubleKeyCharOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public DoubleKeyCharOpenHashMap() {
     ...
     */
    public DoubleKeyCharOpenHashMap(DoubleKeyCharMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public DoubleKeyCharOpenHashMap(int capacity) {
     ...
     */
    public DoubleKeyCharOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public DoubleKeyCharOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public DoubleKeyCharOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public DoubleKeyCharOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public DoubleKeyCharOpenHashMap(DoubleHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyCharOpenHashMap(DoubleHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyCharOpenHashMap(DoubleHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyCharOpenHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyCharOpenHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public DoubleKeyCharOpenHashMap(DoubleHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            DoubleKeyCharOpenHashMap c = (DoubleKeyCharOpenHashMap)super.clone();
            c.keys = new double[keys.length];
            System.arraycopy(keys, 0, c.keys, 0, keys.length);
            c.values = new char[values.length];
    ...
    private class KeySet extends AbstractDoubleSet {
        ...
        public void clear()
        { DoubleKeyCharOpenHashMap.this.clear(); }
        ...
        public boolean remove(double v) {
            ...
            if (result)
                DoubleKeyCharOpenHashMap.this.remove(v);
            return result;
        }
