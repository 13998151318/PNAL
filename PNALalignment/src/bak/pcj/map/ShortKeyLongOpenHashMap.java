 ...
 *
 *  @see        ShortKeyLongChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ShortKeyLongOpenHashMap extends AbstractShortKeyLongMap implements ShortKeyLongMap, Cloneable, Serializable {
    ...
    private ShortKeyLongOpenHashMap(ShortHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ShortKeyLongOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ShortKeyLongOpenHashMap(int capacity) {
     ...
     */
    public ShortKeyLongOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public ShortKeyLongOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public ShortKeyLongOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ShortKeyLongOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ShortKeyLongOpenHashMap(ShortHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyLongOpenHashMap(ShortHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyLongOpenHashMap(ShortHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyLongOpenHashMap(ShortHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyLongOpenHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyLongOpenHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ShortKeyLongOpenHashMap c = (ShortKeyLongOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractShortSet {
        ...
        public void clear()
        { ShortKeyLongOpenHashMap.this.clear(); }
        ...
        public boolean remove(short v) {
            ...
            if (result)
                ShortKeyLongOpenHashMap.this.remove(v);
            return result;
        }
