 ...
 *  char values to short values.
 *
 *  @see        CharKeyShortOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class CharKeyShortChainedHashMap extends AbstractCharKeyShortMap implements CharKeyShortMap, Cloneable, Serializable {
    ...
    private CharKeyShortChainedHashMap(CharHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private CharKeyShortChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public CharKeyShortChainedHashMap() {
     ...
     */
    public CharKeyShortChainedHashMap(CharKeyShortMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public CharKeyShortChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public CharKeyShortChainedHashMap(double loadFactor) {
     ...
     */
    public CharKeyShortChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public CharKeyShortChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public CharKeyShortChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public CharKeyShortChainedHashMap(CharHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyShortChainedHashMap(CharHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyShortChainedHashMap(CharHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyShortChainedHashMap(CharHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyShortChainedHashMap(CharHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyShortChainedHashMap(CharHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            CharKeyShortChainedHashMap c = (CharKeyShortChainedHashMap)super.clone();
    ...
    public CharKeyShortMapIterator entries() {
        return new CharKeyShortMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 CharKeyShortChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractCharSet {
        ...
        public void clear()
        { CharKeyShortChainedHashMap.this.clear(); }
        ...
        public boolean remove(char v) {
            ...
            if (result)
                CharKeyShortChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        CharKeyShortMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
