 ...
 *
 *  @see        ShortKeyFloatChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ShortKeyFloatOpenHashMap extends AbstractShortKeyFloatMap implements ShortKeyFloatMap, Cloneable, Serializable {
    ...
    private ShortKeyFloatOpenHashMap(ShortHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ShortKeyFloatOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ShortKeyFloatOpenHashMap() {
     ...
     */
    public ShortKeyFloatOpenHashMap(ShortKeyFloatMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ShortKeyFloatOpenHashMap(int capacity) {
     ...
     */
    public ShortKeyFloatOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public ShortKeyFloatOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public ShortKeyFloatOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ShortKeyFloatOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ShortKeyFloatOpenHashMap(ShortHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyFloatOpenHashMap(ShortHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyFloatOpenHashMap(ShortHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyFloatOpenHashMap(ShortHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyFloatOpenHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyFloatOpenHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ShortKeyFloatOpenHashMap c = (ShortKeyFloatOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractShortSet {
        ...
        public void clear()
        { ShortKeyFloatOpenHashMap.this.clear(); }
        ...
        public boolean remove(short v) {
            ...
            if (result)
                ShortKeyFloatOpenHashMap.this.remove(v);
            return result;
        }
