 ...
 *  float values to byte values.
 *
 *  @see        FloatKeyByteOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class FloatKeyByteChainedHashMap extends AbstractFloatKeyByteMap implements FloatKeyByteMap, Cloneable, Serializable {
    ...
    private FloatKeyByteChainedHashMap(FloatHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private FloatKeyByteChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public FloatKeyByteChainedHashMap() {
     ...
     */
    public FloatKeyByteChainedHashMap(FloatKeyByteMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public FloatKeyByteChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public FloatKeyByteChainedHashMap(double loadFactor) {
     ...
     */
    public FloatKeyByteChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public FloatKeyByteChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public FloatKeyByteChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public FloatKeyByteChainedHashMap(FloatHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyByteChainedHashMap(FloatHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyByteChainedHashMap(FloatHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyByteChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyByteChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyByteChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            FloatKeyByteChainedHashMap c = (FloatKeyByteChainedHashMap)super.clone();
        ...
        return new FloatKeyByteMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 FloatKeyByteChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractFloatSet {
        ...
        public void clear()
        { FloatKeyByteChainedHashMap.this.clear(); }
        ...
        public boolean remove(float v) {
            ...
            if (result)
                FloatKeyByteChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        FloatKeyByteMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
