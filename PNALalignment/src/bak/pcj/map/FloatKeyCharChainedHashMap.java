 ...
 *  float values to char values.
 *
 *  @see        FloatKeyCharOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class FloatKeyCharChainedHashMap extends AbstractFloatKeyCharMap implements FloatKeyCharMap, Cloneable, Serializable {
    ...
    private FloatKeyCharChainedHashMap(FloatHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private FloatKeyCharChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public FloatKeyCharChainedHashMap() {
     ...
     */
    public FloatKeyCharChainedHashMap(FloatKeyCharMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public FloatKeyCharChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public FloatKeyCharChainedHashMap(double loadFactor) {
     ...
     */
    public FloatKeyCharChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public FloatKeyCharChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public FloatKeyCharChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public FloatKeyCharChainedHashMap(FloatHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyCharChainedHashMap(FloatHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyCharChainedHashMap(FloatHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyCharChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyCharChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyCharChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            FloatKeyCharChainedHashMap c = (FloatKeyCharChainedHashMap)super.clone();
        ...
        return new FloatKeyCharMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 FloatKeyCharChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractFloatSet {
        ...
        public void clear()
        { FloatKeyCharChainedHashMap.this.clear(); }
        ...
        public boolean remove(float v) {
            ...
            if (result)
                FloatKeyCharChainedHashMap.this.remove(v);
            return result;
        }
