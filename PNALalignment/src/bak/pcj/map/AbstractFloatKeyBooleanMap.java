 ...
 *  maps from float values to boolean values. All operations that can be implemented
 *  using iterators
 ...
 *  @since      1.0
 */
public abstract class AbstractFloatKeyBooleanMap implements FloatKeyBooleanMap {
