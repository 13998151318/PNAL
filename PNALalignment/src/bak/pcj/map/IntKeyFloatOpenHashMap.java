 ...
 *  @since      1.0
 */
public class IntKeyFloatOpenHashMap extends AbstractIntKeyFloatMap implements IntKeyFloatMap, Cloneable, Serializable {
    ...
    private IntKeyFloatOpenHashMap(IntHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private IntKeyFloatOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public IntKeyFloatOpenHashMap(IntKeyFloatMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public IntKeyFloatOpenHashMap(int capacity) {
     ...
     */
    public IntKeyFloatOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public IntKeyFloatOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public IntKeyFloatOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public IntKeyFloatOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public IntKeyFloatOpenHashMap(IntHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyFloatOpenHashMap(IntHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyFloatOpenHashMap(IntHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyFloatOpenHashMap(IntHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyFloatOpenHashMap(IntHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyFloatOpenHashMap(IntHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            IntKeyFloatOpenHashMap c = (IntKeyFloatOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractIntSet {
        ...
        public void clear()
        { IntKeyFloatOpenHashMap.this.clear(); }
        ...
        public boolean remove(int v) {
            ...
            if (result)
                IntKeyFloatOpenHashMap.this.remove(v);
            return result;
        }
