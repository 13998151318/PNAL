 ...
 *
 *  @see        ObjectKeyCharChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.1
 */
public class ObjectKeyCharOpenHashMap extends AbstractObjectKeyCharMap implements ObjectKeyCharMap, Cloneable, Serializable {
    ...
    private ObjectKeyCharOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (capacity < 0)
     ...
     */
    public ObjectKeyCharOpenHashMap() {
     ...
     */
    public ObjectKeyCharOpenHashMap(ObjectKeyCharMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ObjectKeyCharOpenHashMap(int capacity) {
     ...
     */
    public ObjectKeyCharOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public ObjectKeyCharOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public ObjectKeyCharOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ObjectKeyCharOpenHashMap(int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ObjectKeyCharOpenHashMap c = (ObjectKeyCharOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractSet {
        ...
        public void clear()
        { ObjectKeyCharOpenHashMap.this.clear(); }
        ...
        public boolean remove(Object v) {
            ...
            if (result)
                ObjectKeyCharOpenHashMap.this.remove(v);
            return result;
        }
