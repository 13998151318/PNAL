 ...
 *  @since      1.0
 */
public class IntKeyCharChainedHashMap extends AbstractIntKeyCharMap implements IntKeyCharMap, Cloneable, Serializable {
    ...
    private IntKeyCharChainedHashMap(IntHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private IntKeyCharChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public IntKeyCharChainedHashMap() {
     ...
     */
    public IntKeyCharChainedHashMap(IntKeyCharMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public IntKeyCharChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public IntKeyCharChainedHashMap(double loadFactor) {
     ...
     */
    public IntKeyCharChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public IntKeyCharChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public IntKeyCharChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public IntKeyCharChainedHashMap(IntHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyCharChainedHashMap(IntHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyCharChainedHashMap(IntHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyCharChainedHashMap(IntHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyCharChainedHashMap(IntHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyCharChainedHashMap(IntHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            IntKeyCharChainedHashMap c = (IntKeyCharChainedHashMap)super.clone();
    ...
    public IntKeyCharMapIterator entries() {
        return new IntKeyCharMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 IntKeyCharChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractIntSet {
        ...
        public void clear()
        { IntKeyCharChainedHashMap.this.clear(); }
        ...
        public boolean remove(int v) {
            ...
            if (result)
                IntKeyCharChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        IntKeyCharMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
            s.writeInt(i.getKey());
