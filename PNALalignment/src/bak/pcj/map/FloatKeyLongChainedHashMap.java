 ...
 *  float values to long values.
 *
 *  @see        FloatKeyLongOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class FloatKeyLongChainedHashMap extends AbstractFloatKeyLongMap implements FloatKeyLongMap, Cloneable, Serializable {
    ...
    private FloatKeyLongChainedHashMap(FloatHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private FloatKeyLongChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public FloatKeyLongChainedHashMap() {
     ...
     */
    public FloatKeyLongChainedHashMap(FloatKeyLongMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public FloatKeyLongChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public FloatKeyLongChainedHashMap(double loadFactor) {
     ...
     */
    public FloatKeyLongChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public FloatKeyLongChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public FloatKeyLongChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public FloatKeyLongChainedHashMap(FloatHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyLongChainedHashMap(FloatHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyLongChainedHashMap(FloatHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyLongChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyLongChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyLongChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    private Entry searchList(Entry list, float key) {
        while (list != null) {
            if (list.key == key)
                return list;
            list = list.next;
    ...
    private Entry getEntry(float key) {
    ...
    public Object clone() {
        try {
            FloatKeyLongChainedHashMap c = (FloatKeyLongChainedHashMap)super.clone();
    ...
    public FloatKeyLongMapIterator entries() {
        return new FloatKeyLongMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 FloatKeyLongChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractFloatSet {
        ...
        public void clear()
        { FloatKeyLongChainedHashMap.this.clear(); }
        ...
        public boolean remove(float v) {
            ...
            if (result)
                FloatKeyLongChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private class ValueCollection extends AbstractLongCollection {
