 ...
 *
 *  @see        ByteKeyFloatChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ByteKeyFloatOpenHashMap extends AbstractByteKeyFloatMap implements ByteKeyFloatMap, Cloneable, Serializable {
    ...
    private ByteKeyFloatOpenHashMap(ByteHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ByteKeyFloatOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ByteKeyFloatOpenHashMap() {
     ...
     */
    public ByteKeyFloatOpenHashMap(ByteKeyFloatMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ByteKeyFloatOpenHashMap(int capacity) {
     ...
     */
    public ByteKeyFloatOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public ByteKeyFloatOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public ByteKeyFloatOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ByteKeyFloatOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ByteKeyFloatOpenHashMap(ByteHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyFloatOpenHashMap(ByteHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyFloatOpenHashMap(ByteHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyFloatOpenHashMap(ByteHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyFloatOpenHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyFloatOpenHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ByteKeyFloatOpenHashMap c = (ByteKeyFloatOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractByteSet {
        ...
        public void clear()
        { ByteKeyFloatOpenHashMap.this.clear(); }
        ...
        public boolean remove(byte v) {
            ...
            if (result)
                ByteKeyFloatOpenHashMap.this.remove(v);
            return result;
        }
