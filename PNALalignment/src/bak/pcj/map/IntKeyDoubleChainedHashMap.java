 ...
 *  int values to double values.
 *
 *  @see        IntKeyDoubleOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class IntKeyDoubleChainedHashMap extends AbstractIntKeyDoubleMap implements IntKeyDoubleMap, Cloneable, Serializable {
    ...
    private IntKeyDoubleChainedHashMap(IntHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private IntKeyDoubleChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public IntKeyDoubleChainedHashMap() {
     ...
     */
    public IntKeyDoubleChainedHashMap(IntKeyDoubleMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public IntKeyDoubleChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public IntKeyDoubleChainedHashMap(double loadFactor) {
     ...
     */
    public IntKeyDoubleChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public IntKeyDoubleChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public IntKeyDoubleChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public IntKeyDoubleChainedHashMap(IntHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyDoubleChainedHashMap(IntHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyDoubleChainedHashMap(IntHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyDoubleChainedHashMap(IntHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyDoubleChainedHashMap(IntHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyDoubleChainedHashMap(IntHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            IntKeyDoubleChainedHashMap c = (IntKeyDoubleChainedHashMap)super.clone();
        ...
        return new IntKeyDoubleMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 IntKeyDoubleChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractIntSet {
        ...
        public void clear()
        { IntKeyDoubleChainedHashMap.this.clear(); }
        ...
        public boolean remove(int v) {
            ...
            if (result)
                IntKeyDoubleChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        IntKeyDoubleMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
            s.writeInt(i.getKey());
