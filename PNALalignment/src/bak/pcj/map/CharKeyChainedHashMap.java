 ...
 *  @since      1.0
 */
public class CharKeyChainedHashMap extends AbstractCharKeyMap implements CharKeyMap, Cloneable, Serializable {
        ...
        return new CharKeyMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 CharKeyChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
