 ...
 *  float values to int values.
 *
 *  @see        FloatKeyIntOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class FloatKeyIntChainedHashMap extends AbstractFloatKeyIntMap implements FloatKeyIntMap, Cloneable, Serializable {
    ...
    private FloatKeyIntChainedHashMap(FloatHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private FloatKeyIntChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public FloatKeyIntChainedHashMap() {
     ...
     */
    public FloatKeyIntChainedHashMap(FloatKeyIntMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public FloatKeyIntChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public FloatKeyIntChainedHashMap(double loadFactor) {
     ...
     */
    public FloatKeyIntChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public FloatKeyIntChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public FloatKeyIntChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public FloatKeyIntChainedHashMap(FloatHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyIntChainedHashMap(FloatHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyIntChainedHashMap(FloatHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyIntChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyIntChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyIntChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            FloatKeyIntChainedHashMap c = (FloatKeyIntChainedHashMap)super.clone();
    ...
    public FloatKeyIntMapIterator entries() {
        return new FloatKeyIntMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 FloatKeyIntChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractFloatSet {
        ...
        public void clear()
        { FloatKeyIntChainedHashMap.this.clear(); }
        ...
        public boolean remove(float v) {
            ...
            if (result)
                FloatKeyIntChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        FloatKeyIntMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
