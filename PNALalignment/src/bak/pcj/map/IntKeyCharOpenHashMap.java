 ...
 *  @since      1.0
 */
public class IntKeyCharOpenHashMap extends AbstractIntKeyCharMap implements IntKeyCharMap, Cloneable, Serializable {
    ...
    private IntKeyCharOpenHashMap(IntHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private IntKeyCharOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public IntKeyCharOpenHashMap(IntKeyCharMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public IntKeyCharOpenHashMap(int capacity) {
     ...
     */
    public IntKeyCharOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public IntKeyCharOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public IntKeyCharOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public IntKeyCharOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public IntKeyCharOpenHashMap(IntHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyCharOpenHashMap(IntHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyCharOpenHashMap(IntHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyCharOpenHashMap(IntHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyCharOpenHashMap(IntHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyCharOpenHashMap(IntHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            IntKeyCharOpenHashMap c = (IntKeyCharOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractIntSet {
        ...
        public void clear()
        { IntKeyCharOpenHashMap.this.clear(); }
        ...
        public boolean remove(int v) {
            ...
            if (result)
                IntKeyCharOpenHashMap.this.remove(v);
            return result;
        }
