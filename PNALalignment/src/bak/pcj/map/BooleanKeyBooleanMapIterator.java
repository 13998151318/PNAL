 ...
 *  boolean values to boolean values.
 *
 *  @see        bak.pcj.map.BooleanKeyBooleanMap
 *  @see        bak.pcj.BooleanIterator
 *
 *  @author     S&oslash;ren Bak
 *  @version    1.0     2002/29/12
 *  @since      1.0
 */
public interface BooleanKeyBooleanMapIterator {

    /**
     *  Indicates whether more entries can be returned by this
     *  iterator.
     *
     *  @return     <tt>true</tt> if more boolean entries can be returned
