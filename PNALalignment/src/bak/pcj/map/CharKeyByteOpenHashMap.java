 ...
 *  @since      1.0
 */
public class CharKeyByteOpenHashMap extends AbstractCharKeyByteMap implements CharKeyByteMap, Cloneable, Serializable {
    ...
    private CharKeyByteOpenHashMap(CharHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private CharKeyByteOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public CharKeyByteOpenHashMap(CharKeyByteMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public CharKeyByteOpenHashMap(int capacity) {
     ...
     */
    public CharKeyByteOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public CharKeyByteOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public CharKeyByteOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public CharKeyByteOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public CharKeyByteOpenHashMap(CharHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyByteOpenHashMap(CharHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyByteOpenHashMap(CharHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyByteOpenHashMap(CharHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyByteOpenHashMap(CharHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyByteOpenHashMap(CharHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            CharKeyByteOpenHashMap c = (CharKeyByteOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractCharSet {
        ...
        public void clear()
        { CharKeyByteOpenHashMap.this.clear(); }
        ...
        public boolean remove(char v) {
            ...
            if (result)
                CharKeyByteOpenHashMap.this.remove(v);
            return result;
        }
