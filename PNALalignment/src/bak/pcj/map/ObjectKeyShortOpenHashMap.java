 ...
 *
 *  @see        ObjectKeyShortChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.1
 */
public class ObjectKeyShortOpenHashMap extends AbstractObjectKeyShortMap implements ObjectKeyShortMap, Cloneable, Serializable {
    ...
    private ObjectKeyShortOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (capacity < 0)
     ...
     */
    public ObjectKeyShortOpenHashMap() {
     ...
     */
    public ObjectKeyShortOpenHashMap(ObjectKeyShortMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ObjectKeyShortOpenHashMap(int capacity) {
     ...
     */
    public ObjectKeyShortOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public ObjectKeyShortOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public ObjectKeyShortOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ObjectKeyShortOpenHashMap(int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ObjectKeyShortOpenHashMap c = (ObjectKeyShortOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractSet {
        ...
        public void clear()
        { ObjectKeyShortOpenHashMap.this.clear(); }
        ...
        public boolean remove(Object v) {
            ...
            if (result)
                ObjectKeyShortOpenHashMap.this.remove(v);
            return result;
        }
