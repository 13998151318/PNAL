 ...
 *
 *  @see        ObjectKeyByteChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.1
 */
public class ObjectKeyByteOpenHashMap extends AbstractObjectKeyByteMap implements ObjectKeyByteMap, Cloneable, Serializable {
    ...
    private ObjectKeyByteOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (capacity < 0)
     ...
     */
    public ObjectKeyByteOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public ObjectKeyByteOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public ObjectKeyByteOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ObjectKeyByteOpenHashMap(int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ObjectKeyByteOpenHashMap c = (ObjectKeyByteOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractSet {
        ...
        public void clear()
        { ObjectKeyByteOpenHashMap.this.clear(); }
        ...
        public boolean remove(Object v) {
            ...
            if (result)
                ObjectKeyByteOpenHashMap.this.remove(v);
            return result;
        }
