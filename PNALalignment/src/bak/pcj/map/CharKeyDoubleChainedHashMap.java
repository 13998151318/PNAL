 ...
 *  char values to double values.
 *
 *  @see        CharKeyDoubleOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class CharKeyDoubleChainedHashMap extends AbstractCharKeyDoubleMap implements CharKeyDoubleMap, Cloneable, Serializable {
    ...
    private CharKeyDoubleChainedHashMap(CharHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private CharKeyDoubleChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public CharKeyDoubleChainedHashMap() {
     ...
     */
    public CharKeyDoubleChainedHashMap(CharKeyDoubleMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public CharKeyDoubleChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public CharKeyDoubleChainedHashMap(double loadFactor) {
     ...
     */
    public CharKeyDoubleChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public CharKeyDoubleChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public CharKeyDoubleChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public CharKeyDoubleChainedHashMap(CharHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyDoubleChainedHashMap(CharHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyDoubleChainedHashMap(CharHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyDoubleChainedHashMap(CharHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyDoubleChainedHashMap(CharHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyDoubleChainedHashMap(CharHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            CharKeyDoubleChainedHashMap c = (CharKeyDoubleChainedHashMap)super.clone();
        ...
        return new CharKeyDoubleMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 CharKeyDoubleChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractCharSet {
        ...
        public void clear()
        { CharKeyDoubleChainedHashMap.this.clear(); }
        ...
        public boolean remove(char v) {
            ...
            if (result)
                CharKeyDoubleChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        CharKeyDoubleMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
