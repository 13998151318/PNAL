 ...
 *  @since      1.0
 */
public class CharKeyFloatChainedHashMap extends AbstractCharKeyFloatMap implements CharKeyFloatMap, Cloneable, Serializable {
    ...
    private CharKeyFloatChainedHashMap(CharHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private CharKeyFloatChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public CharKeyFloatChainedHashMap() {
     ...
     */
    public CharKeyFloatChainedHashMap(CharKeyFloatMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public CharKeyFloatChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public CharKeyFloatChainedHashMap(double loadFactor) {
     ...
     */
    public CharKeyFloatChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public CharKeyFloatChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public CharKeyFloatChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public CharKeyFloatChainedHashMap(CharHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyFloatChainedHashMap(CharHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyFloatChainedHashMap(CharHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyFloatChainedHashMap(CharHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyFloatChainedHashMap(CharHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyFloatChainedHashMap(CharHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            CharKeyFloatChainedHashMap c = (CharKeyFloatChainedHashMap)super.clone();
        ...
        return new CharKeyFloatMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 CharKeyFloatChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractCharSet {
        ...
        public void clear()
        { CharKeyFloatChainedHashMap.this.clear(); }
        ...
        public boolean remove(char v) {
            ...
            if (result)
                CharKeyFloatChainedHashMap.this.remove(v);
            return result;
        }
