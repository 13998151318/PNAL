 ...
 *  maps from double values to char values. All operations that can be implemented
 *  using iterators
 ...
 *  @since      1.0
 */
public abstract class AbstractDoubleKeyCharMap implements DoubleKeyCharMap {
