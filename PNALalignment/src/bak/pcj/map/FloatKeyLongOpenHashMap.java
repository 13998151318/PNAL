 ...
 *
 *  @see        FloatKeyLongChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class FloatKeyLongOpenHashMap extends AbstractFloatKeyLongMap implements FloatKeyLongMap, Cloneable, Serializable {
    ...
    private FloatKeyLongOpenHashMap(FloatHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private FloatKeyLongOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public FloatKeyLongOpenHashMap() {
     ...
     */
    public FloatKeyLongOpenHashMap(FloatKeyLongMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public FloatKeyLongOpenHashMap(int capacity) {
     ...
     */
    public FloatKeyLongOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public FloatKeyLongOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public FloatKeyLongOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public FloatKeyLongOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public FloatKeyLongOpenHashMap(FloatHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyLongOpenHashMap(FloatHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyLongOpenHashMap(FloatHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyLongOpenHashMap(FloatHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyLongOpenHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyLongOpenHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            FloatKeyLongOpenHashMap c = (FloatKeyLongOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractFloatSet {
        ...
        public void clear()
        { FloatKeyLongOpenHashMap.this.clear(); }
        ...
        public boolean remove(float v) {
            ...
            if (result)
                FloatKeyLongOpenHashMap.this.remove(v);
            return result;
        }
