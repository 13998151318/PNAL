 ...
 *
 *  @see        LongKeyBooleanChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class LongKeyBooleanOpenHashMap extends AbstractLongKeyBooleanMap implements LongKeyBooleanMap, Cloneable, Serializable {
    ...
    private LongKeyBooleanOpenHashMap(LongHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private LongKeyBooleanOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public LongKeyBooleanOpenHashMap() {
     ...
     */
    public LongKeyBooleanOpenHashMap(LongKeyBooleanMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public LongKeyBooleanOpenHashMap(int capacity) {
     ...
     */
    public LongKeyBooleanOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public LongKeyBooleanOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public LongKeyBooleanOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public LongKeyBooleanOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public LongKeyBooleanOpenHashMap(LongHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyBooleanOpenHashMap(LongHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyBooleanOpenHashMap(LongHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyBooleanOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyBooleanOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyBooleanOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            LongKeyBooleanOpenHashMap c = (LongKeyBooleanOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractLongSet {
        ...
        public void clear()
        { LongKeyBooleanOpenHashMap.this.clear(); }
        ...
        public boolean remove(long v) {
            ...
            if (result)
                LongKeyBooleanOpenHashMap.this.remove(v);
            return result;
        }
