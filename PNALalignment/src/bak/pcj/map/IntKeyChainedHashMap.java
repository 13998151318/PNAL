 ...
 *  @since      1.0
 */
public class IntKeyChainedHashMap extends AbstractIntKeyMap implements IntKeyMap, Cloneable, Serializable {
    ...
    private IntKeyChainedHashMap(IntHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private IntKeyChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public IntKeyChainedHashMap(IntKeyMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public IntKeyChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public IntKeyChainedHashMap(double loadFactor) {
     ...
     */
    public IntKeyChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public IntKeyChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public IntKeyChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public IntKeyChainedHashMap(IntHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyChainedHashMap(IntHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyChainedHashMap(IntHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyChainedHashMap(IntHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyChainedHashMap(IntHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public IntKeyChainedHashMap(IntHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            IntKeyChainedHashMap c = (IntKeyChainedHashMap)super.clone();
        ...
        return new IntKeyMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 IntKeyChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractIntSet {
        ...
        public void clear()
        { IntKeyChainedHashMap.this.clear(); }
        ...
        public boolean remove(int v) {
            ...
            if (result)
                IntKeyChainedHashMap.this.remove(v);
            return result;
        }
