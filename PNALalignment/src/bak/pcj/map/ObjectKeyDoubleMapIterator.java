 ...
 *  objects values to double values.
 *
 *  @see        bak.pcj.map.ObjectKeyDoubleMap
 *  @see        bak.pcj.DoubleIterator
 *
 *  @author     S&oslash;ren Bak
 *  @version    1.0     2003/3/3
 *  @since      1.1
 */
public interface ObjectKeyDoubleMapIterator {

    /**
     *  Indicates whether more entries can be returned by this
     *  iterator.
     *
     *  @return     <tt>true</tt> if more double entries can be returned
