 ...
 *  float values to float values.
 *
 *  @see        FloatKeyFloatOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class FloatKeyFloatChainedHashMap extends AbstractFloatKeyFloatMap implements FloatKeyFloatMap, Cloneable, Serializable {
    ...
    private FloatKeyFloatChainedHashMap(FloatHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private FloatKeyFloatChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public FloatKeyFloatChainedHashMap() {
     ...
     */
    public FloatKeyFloatChainedHashMap(FloatKeyFloatMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public FloatKeyFloatChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public FloatKeyFloatChainedHashMap(double loadFactor) {
     ...
     */
    public FloatKeyFloatChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public FloatKeyFloatChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public FloatKeyFloatChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public FloatKeyFloatChainedHashMap(FloatHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyFloatChainedHashMap(FloatHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyFloatChainedHashMap(FloatHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyFloatChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyFloatChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyFloatChainedHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            FloatKeyFloatChainedHashMap c = (FloatKeyFloatChainedHashMap)super.clone();
        ...
        return new FloatKeyFloatMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 FloatKeyFloatChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractFloatSet {
        ...
        public void clear()
        { FloatKeyFloatChainedHashMap.this.clear(); }
        ...
        public boolean remove(float v) {
            ...
            if (result)
                FloatKeyFloatChainedHashMap.this.remove(v);
            return result;
        }
