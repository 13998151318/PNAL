 ...
 *  object values to char values.
 *
 *  @see        ObjectKeyCharOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.1
 */
public class ObjectKeyCharChainedHashMap extends AbstractObjectKeyCharMap implements ObjectKeyCharMap, Cloneable, Serializable {
    ...
    private ObjectKeyCharChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (capacity < 0)
     ...
     */
    public ObjectKeyCharChainedHashMap() {
     ...
     */
    public ObjectKeyCharChainedHashMap(ObjectKeyCharMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ObjectKeyCharChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public ObjectKeyCharChainedHashMap(double loadFactor) {
     ...
     */
    public ObjectKeyCharChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public ObjectKeyCharChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ObjectKeyCharChainedHashMap(int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ObjectKeyCharChainedHashMap c = (ObjectKeyCharChainedHashMap)super.clone();
        ...
        return new ObjectKeyCharMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 ObjectKeyCharChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractSet {
        ...
        public void clear()
        { ObjectKeyCharChainedHashMap.this.clear(); }
        ...
        public boolean remove(Object v) {
            ...
            if (result)
                ObjectKeyCharChainedHashMap.this.remove(v);
            return result;
        }
