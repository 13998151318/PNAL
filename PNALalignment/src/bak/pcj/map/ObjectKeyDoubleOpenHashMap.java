 ...
 *
 *  @see        ObjectKeyDoubleChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.1
 */
public class ObjectKeyDoubleOpenHashMap extends AbstractObjectKeyDoubleMap implements ObjectKeyDoubleMap, Cloneable, Serializable {
