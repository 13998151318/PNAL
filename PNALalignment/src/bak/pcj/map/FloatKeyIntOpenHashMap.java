 ...
 *  @since      1.0
 */
public class FloatKeyIntOpenHashMap extends AbstractFloatKeyIntMap implements FloatKeyIntMap, Cloneable, Serializable {
    ...
    private FloatKeyIntOpenHashMap(FloatHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private FloatKeyIntOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public FloatKeyIntOpenHashMap(FloatKeyIntMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public FloatKeyIntOpenHashMap(int capacity) {
     ...
     */
    public FloatKeyIntOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public FloatKeyIntOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public FloatKeyIntOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public FloatKeyIntOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public FloatKeyIntOpenHashMap(FloatHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyIntOpenHashMap(FloatHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyIntOpenHashMap(FloatHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyIntOpenHashMap(FloatHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyIntOpenHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyIntOpenHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            FloatKeyIntOpenHashMap c = (FloatKeyIntOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractFloatSet {
        ...
        public void clear()
        { FloatKeyIntOpenHashMap.this.clear(); }
        ...
        public boolean remove(float v) {
            ...
            if (result)
                FloatKeyIntOpenHashMap.this.remove(v);
            return result;
        }
