 ...
 *  maps from long values to float values. All operations that can be implemented
 *  using iterators
...
public abstract class AbstractLongKeyFloatMap implements LongKeyFloatMap {
    ...
    protected AbstractLongKeyFloatMap() { }
    ...
    public void putAll(LongKeyFloatMap map) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof LongKeyFloatMap))
            return false;
        LongKeyFloatMap map = (LongKeyFloatMap)obj;
        if (size() != map.size())
            return false;
        LongKeyFloatMapIterator i = entries();
        while (i.hasNext()) {
    ...
    public int hashCode() {
        ...
        while (i.hasNext()) {
            i.next();
            h += (DefaultLongHashFunction.INSTANCE.hash(i.getKey()) ^ DefaultFloatHashFunction.INSTANCE.hash(i.getValue()));
        }
        return h;
    }
