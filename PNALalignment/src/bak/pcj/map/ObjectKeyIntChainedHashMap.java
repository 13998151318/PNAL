 ...
 *  @since      1.1
 */
public class ObjectKeyIntChainedHashMap extends AbstractObjectKeyIntMap implements ObjectKeyIntMap, Cloneable, Serializable {
    ...
    private ObjectKeyIntChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (capacity < 0)
     ...
     */
    public ObjectKeyIntChainedHashMap() {
     ...
     */
    public ObjectKeyIntChainedHashMap(ObjectKeyIntMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ObjectKeyIntChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public ObjectKeyIntChainedHashMap(double loadFactor) {
     ...
     */
    public ObjectKeyIntChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public ObjectKeyIntChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ObjectKeyIntChainedHashMap(int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ObjectKeyIntChainedHashMap c = (ObjectKeyIntChainedHashMap)super.clone();
        ...
        return new ObjectKeyIntMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 ObjectKeyIntChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractSet {
        ...
        public void clear()
        { ObjectKeyIntChainedHashMap.this.clear(); }
        ...
        public boolean remove(Object v) {
            ...
            if (result)
                ObjectKeyIntChainedHashMap.this.remove(v);
            return result;
        }
