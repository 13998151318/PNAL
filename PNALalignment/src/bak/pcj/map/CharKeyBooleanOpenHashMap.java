 ...
 *
 *  @see        CharKeyBooleanChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class CharKeyBooleanOpenHashMap extends AbstractCharKeyBooleanMap implements CharKeyBooleanMap, Cloneable, Serializable {
    ...
    private CharKeyBooleanOpenHashMap(CharHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private CharKeyBooleanOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public CharKeyBooleanOpenHashMap() {
     ...
     */
    public CharKeyBooleanOpenHashMap(CharKeyBooleanMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public CharKeyBooleanOpenHashMap(int capacity) {
     ...
     */
    public CharKeyBooleanOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public CharKeyBooleanOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public CharKeyBooleanOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public CharKeyBooleanOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public CharKeyBooleanOpenHashMap(CharHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyBooleanOpenHashMap(CharHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyBooleanOpenHashMap(CharHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyBooleanOpenHashMap(CharHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyBooleanOpenHashMap(CharHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyBooleanOpenHashMap(CharHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            CharKeyBooleanOpenHashMap c = (CharKeyBooleanOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractCharSet {
        ...
        public void clear()
        { CharKeyBooleanOpenHashMap.this.clear(); }
        ...
        public boolean remove(char v) {
            ...
            if (result)
                CharKeyBooleanOpenHashMap.this.remove(v);
            return result;
        }
