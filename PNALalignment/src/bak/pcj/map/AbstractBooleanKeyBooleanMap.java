 ...
 *  maps from boolean values to boolean values. All operations that can be implemented
 *  using iterators
...
public abstract class AbstractBooleanKeyBooleanMap implements BooleanKeyBooleanMap {
    ...
    protected AbstractBooleanKeyBooleanMap() { }

    public void clear() {
        BooleanKeyBooleanMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
            i.remove();
        }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BooleanKeyBooleanMap))
            return false;
        BooleanKeyBooleanMap map = (BooleanKeyBooleanMap)obj;
        if (size() != map.size())
            return false;
        BooleanKeyBooleanMapIterator i = entries();
        while (i.hasNext()) {
    ...
    public int hashCode() {
        ...
        while (i.hasNext()) {
            i.next();
            h += (DefaultBooleanHashFunction.INSTANCE.hash(i.getKey()) ^ DefaultBooleanHashFunction.INSTANCE.hash(i.getValue()));
        }
        return h;
    }
