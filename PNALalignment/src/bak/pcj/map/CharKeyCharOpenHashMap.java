 ...
 *  @since      1.0
 */
public class CharKeyCharOpenHashMap extends AbstractCharKeyCharMap implements CharKeyCharMap, Cloneable, Serializable {
    ...
    private CharKeyCharOpenHashMap(CharHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private CharKeyCharOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public CharKeyCharOpenHashMap(CharKeyCharMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public CharKeyCharOpenHashMap(int capacity) {
     ...
     */
    public CharKeyCharOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public CharKeyCharOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public CharKeyCharOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public CharKeyCharOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public CharKeyCharOpenHashMap(CharHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyCharOpenHashMap(CharHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyCharOpenHashMap(CharHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyCharOpenHashMap(CharHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyCharOpenHashMap(CharHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public CharKeyCharOpenHashMap(CharHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            CharKeyCharOpenHashMap c = (CharKeyCharOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractCharSet {
        ...
        public void clear()
        { CharKeyCharOpenHashMap.this.clear(); }
        ...
        public boolean remove(char v) {
            ...
            if (result)
                CharKeyCharOpenHashMap.this.remove(v);
            return result;
        }
