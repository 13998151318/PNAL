 ...
 *  maps from byte values to double values. All operations that can be implemented
 *  using iterators
...
public abstract class AbstractByteKeyDoubleMap implements ByteKeyDoubleMap {
    ...
    protected AbstractByteKeyDoubleMap() { }
    ...
    public void putAll(ByteKeyDoubleMap map) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ByteKeyDoubleMap))
            return false;
        ByteKeyDoubleMap map = (ByteKeyDoubleMap)obj;
        if (size() != map.size())
            return false;
        ByteKeyDoubleMapIterator i = entries();
        while (i.hasNext()) {
    ...
    public int hashCode() {
        ...
        while (i.hasNext()) {
            i.next();
            h += (DefaultByteHashFunction.INSTANCE.hash(i.getKey()) ^ DefaultDoubleHashFunction.INSTANCE.hash(i.getValue()));
        }
        return h;
    }
