 ...
 *  @since      1.0
 */
public class LongKeyIntOpenHashMap extends AbstractLongKeyIntMap implements LongKeyIntMap, Cloneable, Serializable {
    ...
    private LongKeyIntOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public LongKeyIntOpenHashMap(LongKeyIntMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public LongKeyIntOpenHashMap(int capacity) {
     ...
     */
    public LongKeyIntOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public LongKeyIntOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public LongKeyIntOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public LongKeyIntOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public LongKeyIntOpenHashMap(LongHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyIntOpenHashMap(LongHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyIntOpenHashMap(LongHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyIntOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyIntOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyIntOpenHashMap(LongHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            LongKeyIntOpenHashMap c = (LongKeyIntOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractLongSet {
        ...
        public void clear()
        { LongKeyIntOpenHashMap.this.clear(); }
        ...
        public boolean remove(long v) {
            ...
            if (result)
                LongKeyIntOpenHashMap.this.remove(v);
            return result;
        }
