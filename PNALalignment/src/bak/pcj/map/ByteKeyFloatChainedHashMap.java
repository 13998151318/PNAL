 ...
 *  byte values to float values.
 *
 *  @see        ByteKeyFloatOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ByteKeyFloatChainedHashMap extends AbstractByteKeyFloatMap implements ByteKeyFloatMap, Cloneable, Serializable {
    ...
    private ByteKeyFloatChainedHashMap(ByteHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ByteKeyFloatChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ByteKeyFloatChainedHashMap() {
     ...
     */
    public ByteKeyFloatChainedHashMap(ByteKeyFloatMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ByteKeyFloatChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public ByteKeyFloatChainedHashMap(double loadFactor) {
     ...
     */
    public ByteKeyFloatChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public ByteKeyFloatChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ByteKeyFloatChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ByteKeyFloatChainedHashMap(ByteHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyFloatChainedHashMap(ByteHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyFloatChainedHashMap(ByteHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyFloatChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyFloatChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyFloatChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ByteKeyFloatChainedHashMap c = (ByteKeyFloatChainedHashMap)super.clone();
    ...
    public ByteKeyFloatMapIterator entries() {
        return new ByteKeyFloatMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 ByteKeyFloatChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractByteSet {
        ...
        public void clear()
        { ByteKeyFloatChainedHashMap.this.clear(); }
        ...
        public boolean remove(byte v) {
            ...
            if (result)
                ByteKeyFloatChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        ByteKeyFloatMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
