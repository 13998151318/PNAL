 ...
 *
 *  @see        bak.pcj.map.ByteKeyShortMapIterator
 *  @see        java.util.Map
 *
...
public interface ByteKeyShortMap {
     ...
     *  from {@link #containsKey(byte) containsKey(byte)}. This is useful
     ...
     *              last invokation of 
     *              {@link #containsKey(byte) containsKey(byte)}.
     *
     *  @throws     IllegalStateException
     *              if {@link #containsKey(byte) containsKey(byte)} has
     ...
     *  @see        MapDefaults
     */
    short put(byte key, short value);
     ...
     *              if the operation is not supported by this map.
     */
    void putAll(ByteKeyShortMap map);
