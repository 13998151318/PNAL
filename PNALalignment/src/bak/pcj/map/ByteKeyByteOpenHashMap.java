 ...
 *  byte values to byte values.
 *
 *  @see        ByteKeyByteChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ByteKeyByteOpenHashMap extends AbstractByteKeyByteMap implements ByteKeyByteMap, Cloneable, Serializable {
    ...
    private ByteKeyByteOpenHashMap(ByteHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ByteKeyByteOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ByteKeyByteOpenHashMap(ByteKeyByteMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ByteKeyByteOpenHashMap(int capacity) {
     ...
     */
    public ByteKeyByteOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public ByteKeyByteOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public ByteKeyByteOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ByteKeyByteOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ByteKeyByteOpenHashMap(ByteHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyByteOpenHashMap(ByteHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyByteOpenHashMap(ByteHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyByteOpenHashMap(ByteHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyByteOpenHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyByteOpenHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ByteKeyByteOpenHashMap c = (ByteKeyByteOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractByteSet {
        ...
        public void clear()
        { ByteKeyByteOpenHashMap.this.clear(); }
        ...
        public boolean remove(byte v) {
            ...
            if (result)
                ByteKeyByteOpenHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        ByteKeyByteMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
