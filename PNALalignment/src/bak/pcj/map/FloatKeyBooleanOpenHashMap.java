 ...
 *
 *  @see        FloatKeyBooleanChainedHashMap
 *  @see        java.util.Map
 *
...
public class FloatKeyBooleanOpenHashMap extends AbstractFloatKeyBooleanMap implements FloatKeyBooleanMap, Cloneable, Serializable {
    ...
    private FloatKeyBooleanOpenHashMap(FloatHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private FloatKeyBooleanOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public FloatKeyBooleanOpenHashMap(FloatKeyBooleanMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public FloatKeyBooleanOpenHashMap(int capacity) {
     ...
     */
    public FloatKeyBooleanOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public FloatKeyBooleanOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public FloatKeyBooleanOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public FloatKeyBooleanOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public FloatKeyBooleanOpenHashMap(FloatHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyBooleanOpenHashMap(FloatHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyBooleanOpenHashMap(FloatHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyBooleanOpenHashMap(FloatHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyBooleanOpenHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public FloatKeyBooleanOpenHashMap(FloatHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            FloatKeyBooleanOpenHashMap c = (FloatKeyBooleanOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractFloatSet {
        ...
        public void clear()
        { FloatKeyBooleanOpenHashMap.this.clear(); }
        ...
        public boolean remove(float v) {
            ...
            if (result)
                FloatKeyBooleanOpenHashMap.this.remove(v);
            return result;
        }
