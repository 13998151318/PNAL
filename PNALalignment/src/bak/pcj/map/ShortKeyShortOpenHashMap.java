 ...
 *
 *  @see        ShortKeyShortChainedHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ShortKeyShortOpenHashMap extends AbstractShortKeyShortMap implements ShortKeyShortMap, Cloneable, Serializable {
    ...
    private ShortKeyShortOpenHashMap(ShortHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ShortKeyShortOpenHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ShortKeyShortOpenHashMap() {
     ...
     */
    public ShortKeyShortOpenHashMap(ShortKeyShortMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ShortKeyShortOpenHashMap(int capacity) {
     ...
     */
    public ShortKeyShortOpenHashMap(double loadFactor) {
     ...
     *              if <tt>loadFactor</tt> is not positive.
     */
    public ShortKeyShortOpenHashMap(int capacity, double loadFactor) {
     ...
     */
    public ShortKeyShortOpenHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ShortKeyShortOpenHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ShortKeyShortOpenHashMap(ShortHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyShortOpenHashMap(ShortHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyShortOpenHashMap(ShortHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyShortOpenHashMap(ShortHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyShortOpenHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyShortOpenHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ShortKeyShortOpenHashMap c = (ShortKeyShortOpenHashMap)super.clone();
    ...
    private class KeySet extends AbstractShortSet {
        ...
        public void clear()
        { ShortKeyShortOpenHashMap.this.clear(); }
        ...
        public boolean remove(short v) {
            ...
            if (result)
                ShortKeyShortOpenHashMap.this.remove(v);
            return result;
        }
