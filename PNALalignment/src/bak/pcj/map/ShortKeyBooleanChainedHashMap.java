 ...
 *
 *  @see        ShortKeyBooleanOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ShortKeyBooleanChainedHashMap extends AbstractShortKeyBooleanMap implements ShortKeyBooleanMap, Cloneable, Serializable {
    ...
    private ShortKeyBooleanChainedHashMap(ShortHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ShortKeyBooleanChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ShortKeyBooleanChainedHashMap() {
     ...
     */
    public ShortKeyBooleanChainedHashMap(ShortKeyBooleanMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ShortKeyBooleanChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public ShortKeyBooleanChainedHashMap(double loadFactor) {
     ...
     */
    public ShortKeyBooleanChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public ShortKeyBooleanChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ShortKeyBooleanChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ShortKeyBooleanChainedHashMap(ShortHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyBooleanChainedHashMap(ShortHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyBooleanChainedHashMap(ShortHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyBooleanChainedHashMap(ShortHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyBooleanChainedHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyBooleanChainedHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ShortKeyBooleanChainedHashMap c = (ShortKeyBooleanChainedHashMap)super.clone();
        ...
        return new ShortKeyBooleanMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 ShortKeyBooleanChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractShortSet {
        ...
        public void clear()
        { ShortKeyBooleanChainedHashMap.this.clear(); }
        ...
        public boolean remove(short v) {
            ...
            if (result)
                ShortKeyBooleanChainedHashMap.this.remove(v);
            return result;
        }
