 ...
 *
 *  @see        bak.pcj.map.LongKeyBooleanMap
 *  @see        bak.pcj.LongIterator
 *
 *  @author     S&oslash;ren Bak
 *  @version    1.0     2002/29/12
 *  @since      1.0
 */
public interface LongKeyBooleanMapIterator {

    /**
     *  Indicates whether more entries can be returned by this
     *  iterator.
     *
     *  @return     <tt>true</tt> if more long entries can be returned
