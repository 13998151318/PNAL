 ...
 *  @since      1.0
 */
public class ByteKeyIntChainedHashMap extends AbstractByteKeyIntMap implements ByteKeyIntMap, Cloneable, Serializable {
    ...
    private ByteKeyIntChainedHashMap(ByteHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ByteKeyIntChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ByteKeyIntChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public ByteKeyIntChainedHashMap(double loadFactor) {
     ...
     */
    public ByteKeyIntChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public ByteKeyIntChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ByteKeyIntChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ByteKeyIntChainedHashMap(ByteHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyIntChainedHashMap(ByteHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyIntChainedHashMap(ByteHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyIntChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyIntChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteKeyIntChainedHashMap(ByteHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ByteKeyIntChainedHashMap c = (ByteKeyIntChainedHashMap)super.clone();
        ...
        return new ByteKeyIntMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 ByteKeyIntChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractByteSet {
        ...
        public void clear()
        { ByteKeyIntChainedHashMap.this.clear(); }
        ...
        public boolean remove(byte v) {
            ...
            if (result)
                ByteKeyIntChainedHashMap.this.remove(v);
            return result;
        }
