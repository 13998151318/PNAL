 ...
 *  short values to float values.
 *
 *  @see        ShortKeyFloatOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class ShortKeyFloatChainedHashMap extends AbstractShortKeyFloatMap implements ShortKeyFloatMap, Cloneable, Serializable {
    ...
    private ShortKeyFloatChainedHashMap(ShortHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ShortKeyFloatChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ShortKeyFloatChainedHashMap() {
     ...
     */
    public ShortKeyFloatChainedHashMap(ShortKeyFloatMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ShortKeyFloatChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public ShortKeyFloatChainedHashMap(double loadFactor) {
     ...
     */
    public ShortKeyFloatChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public ShortKeyFloatChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ShortKeyFloatChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public ShortKeyFloatChainedHashMap(ShortHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyFloatChainedHashMap(ShortHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyFloatChainedHashMap(ShortHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyFloatChainedHashMap(ShortHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyFloatChainedHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortKeyFloatChainedHashMap(ShortHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ShortKeyFloatChainedHashMap c = (ShortKeyFloatChainedHashMap)super.clone();
        ...
        return new ShortKeyFloatMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 ShortKeyFloatChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractShortSet {
        ...
        public void clear()
        { ShortKeyFloatChainedHashMap.this.clear(); }
        ...
        public boolean remove(short v) {
            ...
            if (result)
                ShortKeyFloatChainedHashMap.this.remove(v);
            return result;
        }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        ShortKeyFloatMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
