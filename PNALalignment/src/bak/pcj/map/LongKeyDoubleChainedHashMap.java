 ...
 *  long values to double values.
 *
 *  @see        LongKeyDoubleOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.0
 */
public class LongKeyDoubleChainedHashMap extends AbstractLongKeyDoubleMap implements LongKeyDoubleMap, Cloneable, Serializable {
    ...
    private LongKeyDoubleChainedHashMap(LongHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private LongKeyDoubleChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public LongKeyDoubleChainedHashMap() {
     ...
     */
    public LongKeyDoubleChainedHashMap(LongKeyDoubleMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public LongKeyDoubleChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public LongKeyDoubleChainedHashMap(double loadFactor) {
     ...
     */
    public LongKeyDoubleChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public LongKeyDoubleChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public LongKeyDoubleChainedHashMap(int capacity, double loadFactor, int growthChunk) {
     ...
     */
    public LongKeyDoubleChainedHashMap(LongHashFunction keyhash) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyDoubleChainedHashMap(LongHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyDoubleChainedHashMap(LongHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyDoubleChainedHashMap(LongHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyDoubleChainedHashMap(LongHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public LongKeyDoubleChainedHashMap(LongHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            LongKeyDoubleChainedHashMap c = (LongKeyDoubleChainedHashMap)super.clone();
    ...
    public LongKeyDoubleMapIterator entries() {
        return new LongKeyDoubleMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 LongKeyDoubleChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractLongSet {
        ...
        public void clear()
        { LongKeyDoubleChainedHashMap.this.clear(); }
        ...
        public boolean remove(long v) {
            ...
            if (result)
                LongKeyDoubleChainedHashMap.this.remove(v);
            return result;
        }
