 ...
 *  object values to short values.
 *
 *  @see        ObjectKeyShortOpenHashMap
 *  @see        java.util.Map
 *
 ...
 *  @since      1.1
 */
public class ObjectKeyShortChainedHashMap extends AbstractObjectKeyShortMap implements ObjectKeyShortMap, Cloneable, Serializable {
    ...
    private ObjectKeyShortChainedHashMap(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (capacity < 0)
     ...
     */
    public ObjectKeyShortChainedHashMap() {
     ...
     */
    public ObjectKeyShortChainedHashMap(ObjectKeyShortMap map) {
        this();
        putAll(map);
    }
     ...
     */
    public ObjectKeyShortChainedHashMap(int capacity) {
     ...
     *              if <tt>capacity</tt> is negative.
     */
    public ObjectKeyShortChainedHashMap(double loadFactor) {
     ...
     */
    public ObjectKeyShortChainedHashMap(int capacity, double loadFactor) {
     ...
     */
    public ObjectKeyShortChainedHashMap(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ObjectKeyShortChainedHashMap(int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ObjectKeyShortChainedHashMap c = (ObjectKeyShortChainedHashMap)super.clone();
        ...
        return new ObjectKeyShortMapIterator() {
            ...
            public void remove() {
                if (currEntry == null)
                 ...
                 ObjectKeyShortChainedHashMap.this.remove(currEntry.getKey());
                 currEntry = null;
            }
    ...
    private class KeySet extends AbstractSet {
        ...
        public void clear()
        { ObjectKeyShortChainedHashMap.this.clear(); }
        ...
        public boolean remove(Object v) {
            ...
            if (result)
                ObjectKeyShortChainedHashMap.this.remove(v);
            return result;
        }
