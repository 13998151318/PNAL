 ...
 *  maps from boolean values to short values. All operations that can be implemented
 *  using iterators
...
public abstract class AbstractBooleanKeyShortMap implements BooleanKeyShortMap {
    ...
    public void clear() {
        BooleanKeyShortMapIterator i = entries();
        while (i.hasNext()) {
            i.next();
            i.remove();
        }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BooleanKeyShortMap))
            return false;
        BooleanKeyShortMap map = (BooleanKeyShortMap)obj;
        if (size() != map.size())
            return false;
        BooleanKeyShortMapIterator i = entries();
        while (i.hasNext()) {
    ...
    public int hashCode() {
        ...
        while (i.hasNext()) {
            i.next();
            h += (DefaultBooleanHashFunction.INSTANCE.hash(i.getKey()) ^ DefaultShortHashFunction.INSTANCE.hash(i.getValue()));
        }
        return h;
    }
