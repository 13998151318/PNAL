...
public interface ByteIterator {
    ...
    /**
     *  Indicates whether more byte values can be returned by this
     *  iterator.
     *
     *  @return     <tt>true</tt> if more byte values can be returned
     ...
     *
     *  @return     the next byte value of this iterator.
     *
    ...
    /**
     *  Removes the last byte value returned from the underlying
     *  collection.
     *
