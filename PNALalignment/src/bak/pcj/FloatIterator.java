...
public interface FloatIterator {
    ...
    /**
     *  Indicates whether more float values can be returned by this
     *  iterator.
     *
     *  @return     <tt>true</tt> if more float values can be returned
     ...
     *
     *  @return     the next float value of this iterator.
     *
    ...
    /**
     *  Removes the last float value returned from the underlying
     *  collection.
     *
