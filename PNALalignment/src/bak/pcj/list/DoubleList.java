...
public interface DoubleList extends DoubleCollection {
     ...
     *  @see        #addAll(int,DoubleCollection)
     */
    void add(int index, double v);
     ...
     *  @since      1.2
     */
    int indexOf(int index, double c);
     ...
     *  @since      1.2
     */
    int lastIndexOf(int index, double c);
