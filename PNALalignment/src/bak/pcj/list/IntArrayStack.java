...
public class IntArrayStack extends IntArrayList implements IntStack {
     ...
     */
    public IntArrayStack(IntCollection c) {
        super(c);
    }
     ...
     */
    public IntArrayStack(int capacity, double growthFactor) {
     ...
     */
    public IntArrayStack(int capacity, int growthChunk) {
