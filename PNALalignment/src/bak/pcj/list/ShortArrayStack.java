...
public class ShortArrayStack extends ShortArrayList implements ShortStack {
     ...
     *
     *  @see        #ShortArrayStack(int,double)
     */
     ...
     */
    public ShortArrayStack(ShortCollection c) {
        super(c);
    }
     ...
     *  @since      1.1
     */
    public ShortArrayStack(short[] a) {
        super(a);
    }
     ...
     */
    public ShortArrayStack(int capacity) {
        super(capacity);
    }
     ...
     */
    public ShortArrayStack(int capacity, double growthFactor) {
     ...
     */
    public ShortArrayStack(int capacity, int growthChunk) {
