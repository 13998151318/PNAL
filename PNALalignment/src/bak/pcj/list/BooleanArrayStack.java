...
public class BooleanArrayStack extends BooleanArrayList implements BooleanStack {
     ...
     *
     *  @see        #BooleanArrayStack(int,double)
     */
     ...
     */
    public BooleanArrayStack(BooleanCollection c) {
        super(c);
    }
     ...
     *  @since      1.1
     */
    public BooleanArrayStack(boolean[] a) {
        super(a);
    }
     ...
     */
    public BooleanArrayStack(int capacity) {
        super(capacity);
    }
     ...
     */
    public BooleanArrayStack(int capacity, double growthFactor) {
     ...
     */
    public BooleanArrayStack(int capacity, int growthChunk) {
