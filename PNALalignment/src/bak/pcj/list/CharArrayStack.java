...
public class CharArrayStack extends CharArrayList implements CharStack {
     ...
     */
    public CharArrayStack(CharCollection c) {
        super(c);
    }
     ...
     */
    public CharArrayStack(int capacity, double growthFactor) {
     ...
     */
    public CharArrayStack(int capacity, int growthChunk) {
