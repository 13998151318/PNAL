 ...
 *  @since      1.0
 */
public class ShortOpenHashSet extends AbstractShortSet implements ShortSet, Cloneable, Serializable {
    ...
    private ShortOpenHashSet(ShortHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ShortOpenHashSet(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ShortOpenHashSet(int capacity, double loadFactor) {
     ...
     */
    public ShortOpenHashSet(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ShortOpenHashSet(int capacity, double loadFactor, int growthChunk) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortOpenHashSet(ShortHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortOpenHashSet(ShortHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortOpenHashSet(ShortHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortOpenHashSet(ShortHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ShortOpenHashSet(ShortHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
    ...
    public Object clone() {
        try {
            ShortOpenHashSet c = (ShortOpenHashSet)super.clone();
