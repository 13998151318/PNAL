...
/**
 *  This class represents bit array based sets of short values. When a
 ...
 *  @since      1.0
 */
public class ShortBitSet extends AbstractShortSet implements ShortSortedSet, Cloneable, Serializable {
    ...
    public ShortIterator iterator() {
        ...
        return new ShortIterator() {
            ...
            public short next() {
                ...
                lastValue = (short)(nextLongIndex*BITS_PER_LONG + nextBitIndex);
            ...
            public void remove() {
                if (lastValue < 0)
                    Exceptions.noElementToRemove();
                ShortBitSet.this.remove((short)lastValue);
                lastValue = -1;
            }
        ...
        try {
            for (;;) {
                if (v != 0L) {
                    ...
                    return (short)(BITS_PER_LONG*longIndex + bitIndex);
                }
                v = data[++longIndex];
            }
    ...
    private class SubSet extends AbstractShortSet implements ShortSortedSet, java.io.Serializable {
        ...
        public boolean contains(short v) {
            return inSubRange(v) && ShortBitSet.this.contains(v);
        }

        class SubSetIterator implements ShortIterator {
            int longIndexLow;
            int longIndexHigh;
            long vLow;
            long vHigh;
        ...
        public short last() {
            short last = lastFrom(hasUpperBound ? (short)(upperBound-1) : ShortBitSet.this.last());
