 ...
 *  @since      1.0
 */
public class ByteOpenHashSet extends AbstractByteSet implements ByteSet, Cloneable, Serializable {
    ...
    private ByteOpenHashSet(ByteHashFunction keyhash, int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
        if (keyhash == null)
    ...
    private ByteOpenHashSet(int capacity, int growthPolicy, double growthFactor, int growthChunk, double loadFactor) {
     ...
     */
    public ByteOpenHashSet(int capacity, double loadFactor) {
     ...
     */
    public ByteOpenHashSet(int capacity, double loadFactor, double growthFactor) {
     ...
     */
    public ByteOpenHashSet(int capacity, double loadFactor, int growthChunk) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteOpenHashSet(ByteHashFunction keyhash, int capacity) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteOpenHashSet(ByteHashFunction keyhash, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteOpenHashSet(ByteHashFunction keyhash, int capacity, double loadFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteOpenHashSet(ByteHashFunction keyhash, int capacity, double loadFactor, double growthFactor) {
     ...
     *              if <tt>keyhash</tt> is <tt>null</tt>.
     */
    public ByteOpenHashSet(ByteHashFunction keyhash, int capacity, double loadFactor, int growthChunk) {
