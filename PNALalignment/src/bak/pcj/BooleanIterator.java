...
public interface BooleanIterator {
    ...
    /**
     *  Indicates whether more boolean values can be returned by this
     *  iterator.
     *
     *  @return     <tt>true</tt> if more boolean values can be returned
     ...
     *
     *  @return     the next boolean value of this iterator.
     *
    ...
    /**
     *  Removes the last boolean value returned from the underlying
     *  collection.
     *
