...
public interface ShortIterator {
    ...
    /**
     *  Indicates whether more short values can be returned by this
     *  iterator.
     *
     *  @return     <tt>true</tt> if more short values can be returned
     ...
     *
     *  @return     the next short value of this iterator.
     *
    ...
    /**
     *  Removes the last short value returned from the underlying
     *  collection.
     *
